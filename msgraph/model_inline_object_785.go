...
func (o *InlineObject785) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject785) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject785) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject785) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject785) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject785) SetSiteCollectionIdNil() {
...
func (o *InlineObject785) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject785 struct {
	value *InlineObject785
	isSet bool
}

func (v NullableInlineObject785) Get() *InlineObject785 {
	return v.value
}

func (v *NullableInlineObject785) Set(val *InlineObject785) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject785) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject785) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject785(val *InlineObject785) *NullableInlineObject785 {
	return &NullableInlineObject785{value: val, isSet: true}
}

func (v NullableInlineObject785) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject785) UnmarshalJSON(src []byte) error {
	v.isSet = true
