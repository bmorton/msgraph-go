...
func (o *InlineObject242) HasGroupId() bool {
...
func (o *InlineObject242) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject242) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject242) GetNotebookFolderOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject242) SetNotebookFolderNil() {
...
func (o *InlineObject242) SetSiteCollectionIdNil() {
...
func (o *InlineObject242) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
