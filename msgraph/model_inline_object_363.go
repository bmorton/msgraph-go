...
// InlineObject363 struct for InlineObject363
type InlineObject363 struct {
...
func (o *InlineObject363) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject363) SetSendResponseNil() {
...
func (o InlineObject363) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject363 struct {
	value *InlineObject363
	isSet bool
}

func (v NullableInlineObject363) Get() *InlineObject363 {
	return v.value
}

func (v *NullableInlineObject363) Set(val *InlineObject363) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject363) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject363) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject363(val *InlineObject363) *NullableInlineObject363 {
	return &NullableInlineObject363{value: val, isSet: true}
}

func (v NullableInlineObject363) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject363) UnmarshalJSON(src []byte) error {
	v.isSet = true
