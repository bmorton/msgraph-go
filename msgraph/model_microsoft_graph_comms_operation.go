...
// MicrosoftGraphCommsOperation struct for MicrosoftGraphCommsOperation
type MicrosoftGraphCommsOperation struct {
	// Read-only.
...
func NewMicrosoftGraphCommsOperation() *MicrosoftGraphCommsOperation {
	this := MicrosoftGraphCommsOperation{}
	return &this
}
...
func (o *MicrosoftGraphCommsOperation) SetClientContextNil() {
...
func (o MicrosoftGraphCommsOperation) MarshalJSON() ([]byte, error) {
...
type NullableMicrosoftGraphCommsOperation struct {
	value *MicrosoftGraphCommsOperation
	isSet bool
}

func (v NullableMicrosoftGraphCommsOperation) Get() *MicrosoftGraphCommsOperation {
	return v.value
}

func (v *NullableMicrosoftGraphCommsOperation) Set(val *MicrosoftGraphCommsOperation) {
	v.value = val
	v.isSet = true
}

func (v NullableMicrosoftGraphCommsOperation) IsSet() bool {
	return v.isSet
}

func (v *NullableMicrosoftGraphCommsOperation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMicrosoftGraphCommsOperation(val *MicrosoftGraphCommsOperation) *NullableMicrosoftGraphCommsOperation {
	return &NullableMicrosoftGraphCommsOperation{value: val, isSet: true}
}

func (v NullableMicrosoftGraphCommsOperation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMicrosoftGraphCommsOperation) UnmarshalJSON(src []byte) error {
	v.isSet = true
