...
// InlineObject557 struct for InlineObject557
type InlineObject557 struct {
...
func (o InlineObject557) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject557 struct {
	value *InlineObject557
	isSet bool
}

func (v NullableInlineObject557) Get() *InlineObject557 {
	return v.value
}

func (v *NullableInlineObject557) Set(val *InlineObject557) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject557) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject557) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject557(val *InlineObject557) *NullableInlineObject557 {
	return &NullableInlineObject557{value: val, isSet: true}
}

func (v NullableInlineObject557) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject557) UnmarshalJSON(src []byte) error {
	v.isSet = true
