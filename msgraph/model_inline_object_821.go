...
// InlineObject821 struct for InlineObject821
type InlineObject821 struct {
...
func (o *InlineObject821) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject821) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject821) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject821) SetSiteCollectionIdNil() {
...
func (o *InlineObject821) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject821) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject821 struct {
	value *InlineObject821
	isSet bool
}

func (v NullableInlineObject821) Get() *InlineObject821 {
	return v.value
}

func (v *NullableInlineObject821) Set(val *InlineObject821) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject821) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject821) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject821(val *InlineObject821) *NullableInlineObject821 {
	return &NullableInlineObject821{value: val, isSet: true}
}

func (v NullableInlineObject821) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject821) UnmarshalJSON(src []byte) error {
	v.isSet = true
