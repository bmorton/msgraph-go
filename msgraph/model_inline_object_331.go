...
// InlineObject331 struct for InlineObject331
type InlineObject331 struct {
...
func (o *InlineObject331) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject331) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject331) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject331) SetSiteCollectionIdNil() {
...
func (o *InlineObject331) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject331) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject331 struct {
	value *InlineObject331
	isSet bool
}

func (v NullableInlineObject331) Get() *InlineObject331 {
	return v.value
}

func (v *NullableInlineObject331) Set(val *InlineObject331) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject331) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject331) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject331(val *InlineObject331) *NullableInlineObject331 {
	return &NullableInlineObject331{value: val, isSet: true}
}

func (v NullableInlineObject331) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject331) UnmarshalJSON(src []byte) error {
	v.isSet = true
