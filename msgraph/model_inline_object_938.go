...
func (o *InlineObject938) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject938) SetSendResponseNil() {
...
func (o InlineObject938) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject938 struct {
	value *InlineObject938
	isSet bool
}

func (v NullableInlineObject938) Get() *InlineObject938 {
	return v.value
}

func (v *NullableInlineObject938) Set(val *InlineObject938) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject938) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject938) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject938(val *InlineObject938) *NullableInlineObject938 {
	return &NullableInlineObject938{value: val, isSet: true}
}

func (v NullableInlineObject938) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject938) UnmarshalJSON(src []byte) error {
	v.isSet = true
