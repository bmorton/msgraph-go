...
func (o *InlineObject269) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject269) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject269) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject269) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject269) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject269) SetSiteCollectionIdNil() {
...
func (o *InlineObject269) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
