...
func (o *InlineObject1118) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject1118) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1118) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject1118) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject1118) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1118) SetSiteCollectionIdNil() {
...
func (o *InlineObject1118) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject1118 struct {
	value *InlineObject1118
	isSet bool
}

func (v NullableInlineObject1118) Get() *InlineObject1118 {
	return v.value
}

func (v *NullableInlineObject1118) Set(val *InlineObject1118) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1118) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1118) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1118(val *InlineObject1118) *NullableInlineObject1118 {
	return &NullableInlineObject1118{value: val, isSet: true}
}

func (v NullableInlineObject1118) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1118) UnmarshalJSON(src []byte) error {
	v.isSet = true
