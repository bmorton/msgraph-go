...
func (o InlineObject1313) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1313 struct {
	value *InlineObject1313
	isSet bool
}

func (v NullableInlineObject1313) Get() *InlineObject1313 {
	return v.value
}

func (v *NullableInlineObject1313) Set(val *InlineObject1313) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1313) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1313) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1313(val *InlineObject1313) *NullableInlineObject1313 {
	return &NullableInlineObject1313{value: val, isSet: true}
}

func (v NullableInlineObject1313) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1313) UnmarshalJSON(src []byte) error {
	v.isSet = true
