...
func (o *InlineObject901) SetCommentNil() {
	o.Comment.Set(nil)
}
...
type NullableInlineObject901 struct {
	value *InlineObject901
	isSet bool
}

func (v NullableInlineObject901) Get() *InlineObject901 {
	return v.value
}

func (v *NullableInlineObject901) Set(val *InlineObject901) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject901) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject901) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject901(val *InlineObject901) *NullableInlineObject901 {
	return &NullableInlineObject901{value: val, isSet: true}
}

func (v NullableInlineObject901) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject901) UnmarshalJSON(src []byte) error {
	v.isSet = true
