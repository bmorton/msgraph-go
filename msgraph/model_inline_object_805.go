...
// InlineObject805 struct for InlineObject805
type InlineObject805 struct {
...
func (o *InlineObject805) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject805) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject805) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject805) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject805) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject805) SetSiteCollectionIdNil() {
...
func (o *InlineObject805) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject805) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject805 struct {
	value *InlineObject805
	isSet bool
}

func (v NullableInlineObject805) Get() *InlineObject805 {
	return v.value
}

func (v *NullableInlineObject805) Set(val *InlineObject805) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject805) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject805) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject805(val *InlineObject805) *NullableInlineObject805 {
	return &NullableInlineObject805{value: val, isSet: true}
}

func (v NullableInlineObject805) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject805) UnmarshalJSON(src []byte) error {
	v.isSet = true
