...
func (o *InlineObject627) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject627) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject627) SetNotebookFolderNil() {
...
func (o *InlineObject627) SetSiteCollectionIdNil() {
...
func (o *InlineObject627) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject627) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject627 struct {
	value *InlineObject627
	isSet bool
}

func (v NullableInlineObject627) Get() *InlineObject627 {
	return v.value
}

func (v *NullableInlineObject627) Set(val *InlineObject627) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject627) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject627) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject627(val *InlineObject627) *NullableInlineObject627 {
	return &NullableInlineObject627{value: val, isSet: true}
}

func (v NullableInlineObject627) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject627) UnmarshalJSON(src []byte) error {
	v.isSet = true
