...
func (o *InlineObject1179) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1179) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1179) SetNotebookFolderNil() {
...
func (o *InlineObject1179) SetSiteCollectionIdNil() {
...
func (o *InlineObject1179) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject1179 struct {
	value *InlineObject1179
	isSet bool
}

func (v NullableInlineObject1179) Get() *InlineObject1179 {
	return v.value
}

func (v *NullableInlineObject1179) Set(val *InlineObject1179) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1179) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1179) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1179(val *InlineObject1179) *NullableInlineObject1179 {
	return &NullableInlineObject1179{value: val, isSet: true}
}

func (v NullableInlineObject1179) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1179) UnmarshalJSON(src []byte) error {
	v.isSet = true
