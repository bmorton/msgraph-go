...
// InlineObject840 struct for InlineObject840
type InlineObject840 struct {
...
func (o *InlineObject840) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject840) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject840) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject840) SetSiteCollectionIdNil() {
...
func (o *InlineObject840) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject840) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject840 struct {
	value *InlineObject840
	isSet bool
}

func (v NullableInlineObject840) Get() *InlineObject840 {
	return v.value
}

func (v *NullableInlineObject840) Set(val *InlineObject840) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject840) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject840) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject840(val *InlineObject840) *NullableInlineObject840 {
	return &NullableInlineObject840{value: val, isSet: true}
}

func (v NullableInlineObject840) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject840) UnmarshalJSON(src []byte) error {
	v.isSet = true
