...
func (o *ActivityHistoryItem) SetActiveDurationSecondsNil() {
...
func (o *ActivityHistoryItem) SetCreatedDateTimeNil() {
...
func (o *ActivityHistoryItem) SetExpirationDateTimeNil() {
...
func (o *ActivityHistoryItem) SetLastActiveDateTimeNil() {
...
func (o *ActivityHistoryItem) SetLastModifiedDateTimeNil() {
...
func (o *ActivityHistoryItem) SetUserTimezoneNil() {
...
type NullableActivityHistoryItem struct {
	value *ActivityHistoryItem
	isSet bool
}

func (v NullableActivityHistoryItem) Get() *ActivityHistoryItem {
	return v.value
}

func (v *NullableActivityHistoryItem) Set(val *ActivityHistoryItem) {
	v.value = val
	v.isSet = true
}

func (v NullableActivityHistoryItem) IsSet() bool {
	return v.isSet
}

func (v *NullableActivityHistoryItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActivityHistoryItem(val *ActivityHistoryItem) *NullableActivityHistoryItem {
	return &NullableActivityHistoryItem{value: val, isSet: true}
}

func (v NullableActivityHistoryItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActivityHistoryItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
