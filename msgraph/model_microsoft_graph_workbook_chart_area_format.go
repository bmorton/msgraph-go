...
func NewMicrosoftGraphWorkbookChartAreaFormat() *MicrosoftGraphWorkbookChartAreaFormat {
	this := MicrosoftGraphWorkbookChartAreaFormat{}
	return &this
}
...
type NullableMicrosoftGraphWorkbookChartAreaFormat struct {
	value *MicrosoftGraphWorkbookChartAreaFormat
	isSet bool
}

func (v NullableMicrosoftGraphWorkbookChartAreaFormat) Get() *MicrosoftGraphWorkbookChartAreaFormat {
	return v.value
}

func (v *NullableMicrosoftGraphWorkbookChartAreaFormat) Set(val *MicrosoftGraphWorkbookChartAreaFormat) {
	v.value = val
	v.isSet = true
}

func (v NullableMicrosoftGraphWorkbookChartAreaFormat) IsSet() bool {
	return v.isSet
}

func (v *NullableMicrosoftGraphWorkbookChartAreaFormat) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMicrosoftGraphWorkbookChartAreaFormat(val *MicrosoftGraphWorkbookChartAreaFormat) *NullableMicrosoftGraphWorkbookChartAreaFormat {
	return &NullableMicrosoftGraphWorkbookChartAreaFormat{value: val, isSet: true}
}

func (v NullableMicrosoftGraphWorkbookChartAreaFormat) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMicrosoftGraphWorkbookChartAreaFormat) UnmarshalJSON(src []byte) error {
	v.isSet = true
