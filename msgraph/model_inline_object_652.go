...
// InlineObject652 struct for InlineObject652
type InlineObject652 struct {
...
func (o *InlineObject652) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject652) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject652) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject652) SetSiteCollectionIdNil() {
...
func (o *InlineObject652) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject652) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject652 struct {
	value *InlineObject652
	isSet bool
}

func (v NullableInlineObject652) Get() *InlineObject652 {
	return v.value
}

func (v *NullableInlineObject652) Set(val *InlineObject652) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject652) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject652) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject652(val *InlineObject652) *NullableInlineObject652 {
	return &NullableInlineObject652{value: val, isSet: true}
}

func (v NullableInlineObject652) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject652) UnmarshalJSON(src []byte) error {
	v.isSet = true
