...
func (o *InlineObject1172) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1172) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1172) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1172) SetSiteCollectionIdNil() {
...
func (o *InlineObject1172) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject1172 struct {
	value *InlineObject1172
	isSet bool
}

func (v NullableInlineObject1172) Get() *InlineObject1172 {
	return v.value
}

func (v *NullableInlineObject1172) Set(val *InlineObject1172) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1172) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1172) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1172(val *InlineObject1172) *NullableInlineObject1172 {
	return &NullableInlineObject1172{value: val, isSet: true}
}

func (v NullableInlineObject1172) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1172) UnmarshalJSON(src []byte) error {
	v.isSet = true
