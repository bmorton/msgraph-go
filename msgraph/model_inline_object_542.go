...
// InlineObject542 struct for InlineObject542
type InlineObject542 struct {
...
func (o InlineObject542) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject542 struct {
	value *InlineObject542
	isSet bool
}

func (v NullableInlineObject542) Get() *InlineObject542 {
	return v.value
}

func (v *NullableInlineObject542) Set(val *InlineObject542) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject542) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject542) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject542(val *InlineObject542) *NullableInlineObject542 {
	return &NullableInlineObject542{value: val, isSet: true}
}

func (v NullableInlineObject542) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject542) UnmarshalJSON(src []byte) error {
	v.isSet = true
