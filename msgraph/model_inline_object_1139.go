...
func (o *InlineObject1139) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1139) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1139) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1139) SetSiteCollectionIdNil() {
...
func (o *InlineObject1139) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject1139 struct {
	value *InlineObject1139
	isSet bool
}

func (v NullableInlineObject1139) Get() *InlineObject1139 {
	return v.value
}

func (v *NullableInlineObject1139) Set(val *InlineObject1139) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1139) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1139) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1139(val *InlineObject1139) *NullableInlineObject1139 {
	return &NullableInlineObject1139{value: val, isSet: true}
}

func (v NullableInlineObject1139) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1139) UnmarshalJSON(src []byte) error {
	v.isSet = true
