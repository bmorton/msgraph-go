...
// InlineObject1448 struct for InlineObject1448
type InlineObject1448 struct {
...
func (o InlineObject1448) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1448 struct {
	value *InlineObject1448
	isSet bool
}

func (v NullableInlineObject1448) Get() *InlineObject1448 {
	return v.value
}

func (v *NullableInlineObject1448) Set(val *InlineObject1448) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1448) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1448) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1448(val *InlineObject1448) *NullableInlineObject1448 {
	return &NullableInlineObject1448{value: val, isSet: true}
}

func (v NullableInlineObject1448) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1448) UnmarshalJSON(src []byte) error {
	v.isSet = true
