...
func (o *InlineObject979) SetAvailabilityViewIntervalNil() {
...
type NullableInlineObject979 struct {
	value *InlineObject979
	isSet bool
}

func (v NullableInlineObject979) Get() *InlineObject979 {
	return v.value
}

func (v *NullableInlineObject979) Set(val *InlineObject979) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject979) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject979) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject979(val *InlineObject979) *NullableInlineObject979 {
	return &NullableInlineObject979{value: val, isSet: true}
}

func (v NullableInlineObject979) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject979) UnmarshalJSON(src []byte) error {
	v.isSet = true
