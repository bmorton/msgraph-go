...
func (o *InlineObject1156) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1156) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1156) SetSiteCollectionIdNil() {
...
func (o *InlineObject1156) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject1156 struct {
	value *InlineObject1156
	isSet bool
}

func (v NullableInlineObject1156) Get() *InlineObject1156 {
	return v.value
}

func (v *NullableInlineObject1156) Set(val *InlineObject1156) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1156) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1156) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1156(val *InlineObject1156) *NullableInlineObject1156 {
	return &NullableInlineObject1156{value: val, isSet: true}
}

func (v NullableInlineObject1156) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1156) UnmarshalJSON(src []byte) error {
	v.isSet = true
