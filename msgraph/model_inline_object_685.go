...
// InlineObject685 struct for InlineObject685
type InlineObject685 struct {
...
func (o *InlineObject685) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject685) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject685) SetNotebookFolderNil() {
...
func (o *InlineObject685) SetSiteCollectionIdNil() {
...
func (o *InlineObject685) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject685) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject685 struct {
	value *InlineObject685
	isSet bool
}

func (v NullableInlineObject685) Get() *InlineObject685 {
	return v.value
}

func (v *NullableInlineObject685) Set(val *InlineObject685) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject685) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject685) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject685(val *InlineObject685) *NullableInlineObject685 {
	return &NullableInlineObject685{value: val, isSet: true}
}

func (v NullableInlineObject685) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject685) UnmarshalJSON(src []byte) error {
	v.isSet = true
