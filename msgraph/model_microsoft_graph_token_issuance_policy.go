...
// MicrosoftGraphTokenIssuancePolicy struct for MicrosoftGraphTokenIssuancePolicy
type MicrosoftGraphTokenIssuancePolicy struct {
	// Read-only.
...
func NewMicrosoftGraphTokenIssuancePolicy() *MicrosoftGraphTokenIssuancePolicy {
	this := MicrosoftGraphTokenIssuancePolicy{}
	return &this
}
...
func (o *MicrosoftGraphTokenIssuancePolicy) SetDeletedDateTimeNil() {
...
func (o *MicrosoftGraphTokenIssuancePolicy) SetDescriptionNil() {
...
func (o *MicrosoftGraphTokenIssuancePolicy) SetDisplayNameNil() {
...
func (o *MicrosoftGraphTokenIssuancePolicy) SetIsOrganizationDefaultNil() {
...
func (o MicrosoftGraphTokenIssuancePolicy) MarshalJSON() ([]byte, error) {
...
type NullableMicrosoftGraphTokenIssuancePolicy struct {
	value *MicrosoftGraphTokenIssuancePolicy
	isSet bool
}

func (v NullableMicrosoftGraphTokenIssuancePolicy) Get() *MicrosoftGraphTokenIssuancePolicy {
	return v.value
}

func (v *NullableMicrosoftGraphTokenIssuancePolicy) Set(val *MicrosoftGraphTokenIssuancePolicy) {
	v.value = val
	v.isSet = true
}

func (v NullableMicrosoftGraphTokenIssuancePolicy) IsSet() bool {
	return v.isSet
}

func (v *NullableMicrosoftGraphTokenIssuancePolicy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMicrosoftGraphTokenIssuancePolicy(val *MicrosoftGraphTokenIssuancePolicy) *NullableMicrosoftGraphTokenIssuancePolicy {
	return &NullableMicrosoftGraphTokenIssuancePolicy{value: val, isSet: true}
}

func (v NullableMicrosoftGraphTokenIssuancePolicy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMicrosoftGraphTokenIssuancePolicy) UnmarshalJSON(src []byte) error {
	v.isSet = true
