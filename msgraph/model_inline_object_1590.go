...
// InlineObject1590 struct for InlineObject1590
type InlineObject1590 struct {
...
func (o *InlineObject1590) SetIndexNil() {
	o.Index.Set(nil)
}
...
func (o InlineObject1590) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1590 struct {
	value *InlineObject1590
	isSet bool
}

func (v NullableInlineObject1590) Get() *InlineObject1590 {
	return v.value
}

func (v *NullableInlineObject1590) Set(val *InlineObject1590) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1590) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1590) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1590(val *InlineObject1590) *NullableInlineObject1590 {
	return &NullableInlineObject1590{value: val, isSet: true}
}

func (v NullableInlineObject1590) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1590) UnmarshalJSON(src []byte) error {
	v.isSet = true
