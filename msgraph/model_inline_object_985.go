...
func (o *InlineObject985) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject985) SetSendResponseNil() {
...
type NullableInlineObject985 struct {
	value *InlineObject985
	isSet bool
}

func (v NullableInlineObject985) Get() *InlineObject985 {
	return v.value
}

func (v *NullableInlineObject985) Set(val *InlineObject985) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject985) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject985) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject985(val *InlineObject985) *NullableInlineObject985 {
	return &NullableInlineObject985{value: val, isSet: true}
}

func (v NullableInlineObject985) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject985) UnmarshalJSON(src []byte) error {
	v.isSet = true
