...
func NewMicrosoftGraphWorkbookRangeFill() *MicrosoftGraphWorkbookRangeFill {
	this := MicrosoftGraphWorkbookRangeFill{}
	return &this
}
...
func (o *MicrosoftGraphWorkbookRangeFill) SetColorNil() {
	o.Color.Set(nil)
}
...
type NullableMicrosoftGraphWorkbookRangeFill struct {
	value *MicrosoftGraphWorkbookRangeFill
	isSet bool
}

func (v NullableMicrosoftGraphWorkbookRangeFill) Get() *MicrosoftGraphWorkbookRangeFill {
	return v.value
}

func (v *NullableMicrosoftGraphWorkbookRangeFill) Set(val *MicrosoftGraphWorkbookRangeFill) {
	v.value = val
	v.isSet = true
}

func (v NullableMicrosoftGraphWorkbookRangeFill) IsSet() bool {
	return v.isSet
}

func (v *NullableMicrosoftGraphWorkbookRangeFill) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMicrosoftGraphWorkbookRangeFill(val *MicrosoftGraphWorkbookRangeFill) *NullableMicrosoftGraphWorkbookRangeFill {
	return &NullableMicrosoftGraphWorkbookRangeFill{value: val, isSet: true}
}

func (v NullableMicrosoftGraphWorkbookRangeFill) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMicrosoftGraphWorkbookRangeFill) UnmarshalJSON(src []byte) error {
	v.isSet = true
