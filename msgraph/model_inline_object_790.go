...
func (o *InlineObject790) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject790) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject790) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject790) SetSiteCollectionIdNil() {
...
func (o *InlineObject790) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject790 struct {
	value *InlineObject790
	isSet bool
}

func (v NullableInlineObject790) Get() *InlineObject790 {
	return v.value
}

func (v *NullableInlineObject790) Set(val *InlineObject790) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject790) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject790) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject790(val *InlineObject790) *NullableInlineObject790 {
	return &NullableInlineObject790{value: val, isSet: true}
}

func (v NullableInlineObject790) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject790) UnmarshalJSON(src []byte) error {
	v.isSet = true
