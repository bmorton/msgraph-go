...
func (o InlineObject1015) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1015 struct {
	value *InlineObject1015
	isSet bool
}

func (v NullableInlineObject1015) Get() *InlineObject1015 {
	return v.value
}

func (v *NullableInlineObject1015) Set(val *InlineObject1015) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1015) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1015) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1015(val *InlineObject1015) *NullableInlineObject1015 {
	return &NullableInlineObject1015{value: val, isSet: true}
}

func (v NullableInlineObject1015) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1015) UnmarshalJSON(src []byte) error {
	v.isSet = true
