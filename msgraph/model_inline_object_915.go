...
func (o *InlineObject915) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject915) SetSendResponseNil() {
...
func (o InlineObject915) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject915 struct {
	value *InlineObject915
	isSet bool
}

func (v NullableInlineObject915) Get() *InlineObject915 {
	return v.value
}

func (v *NullableInlineObject915) Set(val *InlineObject915) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject915) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject915) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject915(val *InlineObject915) *NullableInlineObject915 {
	return &NullableInlineObject915{value: val, isSet: true}
}

func (v NullableInlineObject915) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject915) UnmarshalJSON(src []byte) error {
	v.isSet = true
