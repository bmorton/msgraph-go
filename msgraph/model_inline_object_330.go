...
// InlineObject330 struct for InlineObject330
type InlineObject330 struct {
...
func (o *InlineObject330) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject330) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject330) SetNotebookFolderNil() {
...
func (o *InlineObject330) SetSiteCollectionIdNil() {
...
func (o *InlineObject330) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject330) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject330 struct {
	value *InlineObject330
	isSet bool
}

func (v NullableInlineObject330) Get() *InlineObject330 {
	return v.value
}

func (v *NullableInlineObject330) Set(val *InlineObject330) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject330) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject330) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject330(val *InlineObject330) *NullableInlineObject330 {
	return &NullableInlineObject330{value: val, isSet: true}
}

func (v NullableInlineObject330) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject330) UnmarshalJSON(src []byte) error {
	v.isSet = true
