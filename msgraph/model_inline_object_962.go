...
func (o *InlineObject962) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject962) SetSendResponseNil() {
...
func (o InlineObject962) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject962 struct {
	value *InlineObject962
	isSet bool
}

func (v NullableInlineObject962) Get() *InlineObject962 {
	return v.value
}

func (v *NullableInlineObject962) Set(val *InlineObject962) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject962) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject962) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject962(val *InlineObject962) *NullableInlineObject962 {
	return &NullableInlineObject962{value: val, isSet: true}
}

func (v NullableInlineObject962) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject962) UnmarshalJSON(src []byte) error {
	v.isSet = true
