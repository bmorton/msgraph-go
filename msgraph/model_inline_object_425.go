...
func (o *InlineObject425) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject425) SetSendResponseNil() {
...
func (o InlineObject425) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject425 struct {
	value *InlineObject425
	isSet bool
}

func (v NullableInlineObject425) Get() *InlineObject425 {
	return v.value
}

func (v *NullableInlineObject425) Set(val *InlineObject425) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject425) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject425) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject425(val *InlineObject425) *NullableInlineObject425 {
	return &NullableInlineObject425{value: val, isSet: true}
}

func (v NullableInlineObject425) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject425) UnmarshalJSON(src []byte) error {
	v.isSet = true
