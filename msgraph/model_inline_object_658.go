...
// InlineObject658 struct for InlineObject658
type InlineObject658 struct {
...
func (o *InlineObject658) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject658) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject658) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject658) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject658) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject658) SetSiteCollectionIdNil() {
...
func (o *InlineObject658) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject658) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject658 struct {
	value *InlineObject658
	isSet bool
}

func (v NullableInlineObject658) Get() *InlineObject658 {
	return v.value
}

func (v *NullableInlineObject658) Set(val *InlineObject658) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject658) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject658) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject658(val *InlineObject658) *NullableInlineObject658 {
	return &NullableInlineObject658{value: val, isSet: true}
}

func (v NullableInlineObject658) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject658) UnmarshalJSON(src []byte) error {
	v.isSet = true
