...
// InlineObject348 struct for InlineObject348
type InlineObject348 struct {
...
func (o *InlineObject348) SetEntityTypeNil() {
...
func (o *InlineObject348) SetDisplayNameNil() {
...
func (o *InlineObject348) SetMailNicknameNil() {
...
func (o *InlineObject348) SetOnBehalfOfUserIdNil() {
...
func (o InlineObject348) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject348 struct {
	value *InlineObject348
	isSet bool
}

func (v NullableInlineObject348) Get() *InlineObject348 {
	return v.value
}

func (v *NullableInlineObject348) Set(val *InlineObject348) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject348) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject348) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject348(val *InlineObject348) *NullableInlineObject348 {
	return &NullableInlineObject348{value: val, isSet: true}
}

func (v NullableInlineObject348) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject348) UnmarshalJSON(src []byte) error {
	v.isSet = true
