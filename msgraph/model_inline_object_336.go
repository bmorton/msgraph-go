...
// InlineObject336 struct for InlineObject336
type InlineObject336 struct {
...
func (o *InlineObject336) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject336) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject336) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject336) SetSiteCollectionIdNil() {
...
func (o *InlineObject336) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject336) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject336 struct {
	value *InlineObject336
	isSet bool
}

func (v NullableInlineObject336) Get() *InlineObject336 {
	return v.value
}

func (v *NullableInlineObject336) Set(val *InlineObject336) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject336) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject336) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject336(val *InlineObject336) *NullableInlineObject336 {
	return &NullableInlineObject336{value: val, isSet: true}
}

func (v NullableInlineObject336) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject336) UnmarshalJSON(src []byte) error {
	v.isSet = true
