...
func (o *InlineObject410) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject410) SetSendResponseNil() {
...
func (o InlineObject410) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject410 struct {
	value *InlineObject410
	isSet bool
}

func (v NullableInlineObject410) Get() *InlineObject410 {
	return v.value
}

func (v *NullableInlineObject410) Set(val *InlineObject410) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject410) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject410) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject410(val *InlineObject410) *NullableInlineObject410 {
	return &NullableInlineObject410{value: val, isSet: true}
}

func (v NullableInlineObject410) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject410) UnmarshalJSON(src []byte) error {
	v.isSet = true
