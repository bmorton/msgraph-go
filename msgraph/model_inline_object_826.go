...
// InlineObject826 struct for InlineObject826
type InlineObject826 struct {
...
func (o *InlineObject826) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject826) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject826) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject826) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject826) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject826) SetSiteCollectionIdNil() {
...
func (o *InlineObject826) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject826) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject826 struct {
	value *InlineObject826
	isSet bool
}

func (v NullableInlineObject826) Get() *InlineObject826 {
	return v.value
}

func (v *NullableInlineObject826) Set(val *InlineObject826) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject826) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject826) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject826(val *InlineObject826) *NullableInlineObject826 {
	return &NullableInlineObject826{value: val, isSet: true}
}

func (v NullableInlineObject826) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject826) UnmarshalJSON(src []byte) error {
	v.isSet = true
