...
func (o InlineObject490) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject490 struct {
	value *InlineObject490
	isSet bool
}

func (v NullableInlineObject490) Get() *InlineObject490 {
	return v.value
}

func (v *NullableInlineObject490) Set(val *InlineObject490) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject490) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject490) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject490(val *InlineObject490) *NullableInlineObject490 {
	return &NullableInlineObject490{value: val, isSet: true}
}

func (v NullableInlineObject490) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject490) UnmarshalJSON(src []byte) error {
	v.isSet = true
