...
func (o *InlineObject1126) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1126) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1126) SetNotebookFolderNil() {
...
func (o *InlineObject1126) SetSiteCollectionIdNil() {
...
func (o *InlineObject1126) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1126) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1126 struct {
	value *InlineObject1126
	isSet bool
}

func (v NullableInlineObject1126) Get() *InlineObject1126 {
	return v.value
}

func (v *NullableInlineObject1126) Set(val *InlineObject1126) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1126) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1126) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1126(val *InlineObject1126) *NullableInlineObject1126 {
	return &NullableInlineObject1126{value: val, isSet: true}
}

func (v NullableInlineObject1126) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1126) UnmarshalJSON(src []byte) error {
	v.isSet = true
