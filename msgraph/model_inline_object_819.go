...
func (o *InlineObject819) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject819) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject819) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject819) SetSiteCollectionIdNil() {
...
func (o *InlineObject819) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject819) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject819 struct {
	value *InlineObject819
	isSet bool
}

func (v NullableInlineObject819) Get() *InlineObject819 {
	return v.value
}

func (v *NullableInlineObject819) Set(val *InlineObject819) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject819) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject819) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject819(val *InlineObject819) *NullableInlineObject819 {
	return &NullableInlineObject819{value: val, isSet: true}
}

func (v NullableInlineObject819) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject819) UnmarshalJSON(src []byte) error {
	v.isSet = true
