...
// InlineObject529 struct for InlineObject529
type InlineObject529 struct {
...
func (o InlineObject529) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject529 struct {
	value *InlineObject529
	isSet bool
}

func (v NullableInlineObject529) Get() *InlineObject529 {
	return v.value
}

func (v *NullableInlineObject529) Set(val *InlineObject529) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject529) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject529) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject529(val *InlineObject529) *NullableInlineObject529 {
	return &NullableInlineObject529{value: val, isSet: true}
}

func (v NullableInlineObject529) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject529) UnmarshalJSON(src []byte) error {
	v.isSet = true
