...
func (o *InlineObject395) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject395) SetSendResponseNil() {
...
func (o InlineObject395) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject395 struct {
	value *InlineObject395
	isSet bool
}

func (v NullableInlineObject395) Get() *InlineObject395 {
	return v.value
}

func (v *NullableInlineObject395) Set(val *InlineObject395) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject395) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject395) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject395(val *InlineObject395) *NullableInlineObject395 {
	return &NullableInlineObject395{value: val, isSet: true}
}

func (v NullableInlineObject395) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject395) UnmarshalJSON(src []byte) error {
	v.isSet = true
