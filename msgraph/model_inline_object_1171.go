...
func (o *InlineObject1171) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1171) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1171) SetNotebookFolderNil() {
...
func (o *InlineObject1171) SetSiteCollectionIdNil() {
...
func (o *InlineObject1171) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1171) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1171 struct {
	value *InlineObject1171
	isSet bool
}

func (v NullableInlineObject1171) Get() *InlineObject1171 {
	return v.value
}

func (v *NullableInlineObject1171) Set(val *InlineObject1171) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1171) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1171) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1171(val *InlineObject1171) *NullableInlineObject1171 {
	return &NullableInlineObject1171{value: val, isSet: true}
}

func (v NullableInlineObject1171) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1171) UnmarshalJSON(src []byte) error {
	v.isSet = true
