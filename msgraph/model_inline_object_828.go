...
func (o *InlineObject828) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject828) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject828) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject828) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject828) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject828) SetSiteCollectionIdNil() {
...
func (o *InlineObject828) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject828 struct {
	value *InlineObject828
	isSet bool
}

func (v NullableInlineObject828) Get() *InlineObject828 {
	return v.value
}

func (v *NullableInlineObject828) Set(val *InlineObject828) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject828) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject828) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject828(val *InlineObject828) *NullableInlineObject828 {
	return &NullableInlineObject828{value: val, isSet: true}
}

func (v NullableInlineObject828) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject828) UnmarshalJSON(src []byte) error {
	v.isSet = true
