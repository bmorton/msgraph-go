...
// InlineObject489 struct for InlineObject489
type InlineObject489 struct {
...
func (o *InlineObject489) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o InlineObject489) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject489 struct {
	value *InlineObject489
	isSet bool
}

func (v NullableInlineObject489) Get() *InlineObject489 {
	return v.value
}

func (v *NullableInlineObject489) Set(val *InlineObject489) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject489) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject489) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject489(val *InlineObject489) *NullableInlineObject489 {
	return &NullableInlineObject489{value: val, isSet: true}
}

func (v NullableInlineObject489) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject489) UnmarshalJSON(src []byte) error {
	v.isSet = true
