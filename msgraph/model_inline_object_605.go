...
func (o *InlineObject605) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject605) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject605) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject605) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject605) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject605) SetSiteCollectionIdNil() {
...
func (o *InlineObject605) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject605) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject605 struct {
	value *InlineObject605
	isSet bool
}

func (v NullableInlineObject605) Get() *InlineObject605 {
	return v.value
}

func (v *NullableInlineObject605) Set(val *InlineObject605) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject605) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject605) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject605(val *InlineObject605) *NullableInlineObject605 {
	return &NullableInlineObject605{value: val, isSet: true}
}

func (v NullableInlineObject605) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject605) UnmarshalJSON(src []byte) error {
	v.isSet = true
