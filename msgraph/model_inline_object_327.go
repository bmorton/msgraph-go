...
// InlineObject327 struct for InlineObject327
type InlineObject327 struct {
...
func (o *InlineObject327) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject327) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject327) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject327) SetSiteCollectionIdNil() {
...
func (o *InlineObject327) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject327) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject327 struct {
	value *InlineObject327
	isSet bool
}

func (v NullableInlineObject327) Get() *InlineObject327 {
	return v.value
}

func (v *NullableInlineObject327) Set(val *InlineObject327) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject327) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject327) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject327(val *InlineObject327) *NullableInlineObject327 {
	return &NullableInlineObject327{value: val, isSet: true}
}

func (v NullableInlineObject327) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject327) UnmarshalJSON(src []byte) error {
	v.isSet = true
