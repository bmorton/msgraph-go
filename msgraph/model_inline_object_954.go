...
func (o *InlineObject954) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject954) SetSendResponseNil() {
...
func (o InlineObject954) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject954 struct {
	value *InlineObject954
	isSet bool
}

func (v NullableInlineObject954) Get() *InlineObject954 {
	return v.value
}

func (v *NullableInlineObject954) Set(val *InlineObject954) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject954) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject954) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject954(val *InlineObject954) *NullableInlineObject954 {
	return &NullableInlineObject954{value: val, isSet: true}
}

func (v NullableInlineObject954) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject954) UnmarshalJSON(src []byte) error {
	v.isSet = true
