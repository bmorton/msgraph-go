...
func (o *InlineObject1175) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1175) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1175) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1175) SetSiteCollectionIdNil() {
...
func (o *InlineObject1175) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1175) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1175 struct {
	value *InlineObject1175
	isSet bool
}

func (v NullableInlineObject1175) Get() *InlineObject1175 {
	return v.value
}

func (v *NullableInlineObject1175) Set(val *InlineObject1175) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1175) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1175) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1175(val *InlineObject1175) *NullableInlineObject1175 {
	return &NullableInlineObject1175{value: val, isSet: true}
}

func (v NullableInlineObject1175) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1175) UnmarshalJSON(src []byte) error {
	v.isSet = true
