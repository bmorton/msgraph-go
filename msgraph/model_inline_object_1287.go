...
func (o InlineObject1287) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1287 struct {
	value *InlineObject1287
	isSet bool
}

func (v NullableInlineObject1287) Get() *InlineObject1287 {
	return v.value
}

func (v *NullableInlineObject1287) Set(val *InlineObject1287) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1287) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1287) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1287(val *InlineObject1287) *NullableInlineObject1287 {
	return &NullableInlineObject1287{value: val, isSet: true}
}

func (v NullableInlineObject1287) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1287) UnmarshalJSON(src []byte) error {
	v.isSet = true
