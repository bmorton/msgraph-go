...
// InlineObject465 struct for InlineObject465
type InlineObject465 struct {
...
func (o *InlineObject465) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject465) SetSendResponseNil() {
...
func (o InlineObject465) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject465 struct {
	value *InlineObject465
	isSet bool
}

func (v NullableInlineObject465) Get() *InlineObject465 {
	return v.value
}

func (v *NullableInlineObject465) Set(val *InlineObject465) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject465) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject465) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject465(val *InlineObject465) *NullableInlineObject465 {
	return &NullableInlineObject465{value: val, isSet: true}
}

func (v NullableInlineObject465) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject465) UnmarshalJSON(src []byte) error {
	v.isSet = true
