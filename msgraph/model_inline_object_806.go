...
func (o *InlineObject806) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject806) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject806) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject806) SetSiteCollectionIdNil() {
...
func (o *InlineObject806) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject806) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject806 struct {
	value *InlineObject806
	isSet bool
}

func (v NullableInlineObject806) Get() *InlineObject806 {
	return v.value
}

func (v *NullableInlineObject806) Set(val *InlineObject806) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject806) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject806) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject806(val *InlineObject806) *NullableInlineObject806 {
	return &NullableInlineObject806{value: val, isSet: true}
}

func (v NullableInlineObject806) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject806) UnmarshalJSON(src []byte) error {
	v.isSet = true
