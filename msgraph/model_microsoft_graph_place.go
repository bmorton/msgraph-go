...
func (o *MicrosoftGraphPlace) SetPhoneNil() {
	o.Phone.Set(nil)
}
...
func (o MicrosoftGraphPlace) MarshalJSON() ([]byte, error) {
...
type NullableMicrosoftGraphPlace struct {
	value *MicrosoftGraphPlace
	isSet bool
}

func (v NullableMicrosoftGraphPlace) Get() *MicrosoftGraphPlace {
	return v.value
}

func (v *NullableMicrosoftGraphPlace) Set(val *MicrosoftGraphPlace) {
	v.value = val
	v.isSet = true
}

func (v NullableMicrosoftGraphPlace) IsSet() bool {
	return v.isSet
}

func (v *NullableMicrosoftGraphPlace) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMicrosoftGraphPlace(val *MicrosoftGraphPlace) *NullableMicrosoftGraphPlace {
	return &NullableMicrosoftGraphPlace{value: val, isSet: true}
}

func (v NullableMicrosoftGraphPlace) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMicrosoftGraphPlace) UnmarshalJSON(src []byte) error {
	v.isSet = true
