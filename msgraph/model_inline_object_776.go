...
// InlineObject776 struct for InlineObject776
type InlineObject776 struct {
...
func (o *InlineObject776) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject776) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject776) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject776) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject776) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject776) SetSiteCollectionIdNil() {
...
func (o *InlineObject776) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject776) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject776 struct {
	value *InlineObject776
	isSet bool
}

func (v NullableInlineObject776) Get() *InlineObject776 {
	return v.value
}

func (v *NullableInlineObject776) Set(val *InlineObject776) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject776) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject776) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject776(val *InlineObject776) *NullableInlineObject776 {
	return &NullableInlineObject776{value: val, isSet: true}
}

func (v NullableInlineObject776) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject776) UnmarshalJSON(src []byte) error {
	v.isSet = true
