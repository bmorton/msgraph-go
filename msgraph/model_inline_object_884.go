...
// InlineObject884 struct for InlineObject884
type InlineObject884 struct {
...
func (o *InlineObject884) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject884) SetSendResponseNil() {
...
func (o InlineObject884) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject884 struct {
	value *InlineObject884
	isSet bool
}

func (v NullableInlineObject884) Get() *InlineObject884 {
	return v.value
}

func (v *NullableInlineObject884) Set(val *InlineObject884) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject884) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject884) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject884(val *InlineObject884) *NullableInlineObject884 {
	return &NullableInlineObject884{value: val, isSet: true}
}

func (v NullableInlineObject884) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject884) UnmarshalJSON(src []byte) error {
	v.isSet = true
