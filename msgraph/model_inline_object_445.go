...
// InlineObject445 struct for InlineObject445
type InlineObject445 struct {
...
func (o *InlineObject445) SetAvailabilityViewIntervalNil() {
...
func (o InlineObject445) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject445 struct {
	value *InlineObject445
	isSet bool
}

func (v NullableInlineObject445) Get() *InlineObject445 {
	return v.value
}

func (v *NullableInlineObject445) Set(val *InlineObject445) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject445) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject445) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject445(val *InlineObject445) *NullableInlineObject445 {
	return &NullableInlineObject445{value: val, isSet: true}
}

func (v NullableInlineObject445) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject445) UnmarshalJSON(src []byte) error {
	v.isSet = true
