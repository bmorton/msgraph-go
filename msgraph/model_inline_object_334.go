...
func (o *InlineObject334) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject334) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject334) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject334) SetSiteCollectionIdNil() {
...
func (o *InlineObject334) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject334) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject334 struct {
	value *InlineObject334
	isSet bool
}

func (v NullableInlineObject334) Get() *InlineObject334 {
	return v.value
}

func (v *NullableInlineObject334) Set(val *InlineObject334) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject334) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject334) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject334(val *InlineObject334) *NullableInlineObject334 {
	return &NullableInlineObject334{value: val, isSet: true}
}

func (v NullableInlineObject334) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject334) UnmarshalJSON(src []byte) error {
	v.isSet = true
