...
// InlineObject1051 struct for InlineObject1051
type InlineObject1051 struct {
...
func (o InlineObject1051) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1051 struct {
	value *InlineObject1051
	isSet bool
}

func (v NullableInlineObject1051) Get() *InlineObject1051 {
	return v.value
}

func (v *NullableInlineObject1051) Set(val *InlineObject1051) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1051) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1051) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1051(val *InlineObject1051) *NullableInlineObject1051 {
	return &NullableInlineObject1051{value: val, isSet: true}
}

func (v NullableInlineObject1051) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1051) UnmarshalJSON(src []byte) error {
	v.isSet = true
