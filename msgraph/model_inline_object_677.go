...
func (o *InlineObject677) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject677) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject677) SetNotebookFolderNil() {
...
func (o *InlineObject677) SetSiteCollectionIdNil() {
...
func (o *InlineObject677) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject677) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject677 struct {
	value *InlineObject677
	isSet bool
}

func (v NullableInlineObject677) Get() *InlineObject677 {
	return v.value
}

func (v *NullableInlineObject677) Set(val *InlineObject677) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject677) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject677) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject677(val *InlineObject677) *NullableInlineObject677 {
	return &NullableInlineObject677{value: val, isSet: true}
}

func (v NullableInlineObject677) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject677) UnmarshalJSON(src []byte) error {
	v.isSet = true
