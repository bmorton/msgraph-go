...
// InlineObject460 struct for InlineObject460
type InlineObject460 struct {
...
func (o *InlineObject460) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject460) SetSendResponseNil() {
...
func (o InlineObject460) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject460 struct {
	value *InlineObject460
	isSet bool
}

func (v NullableInlineObject460) Get() *InlineObject460 {
	return v.value
}

func (v *NullableInlineObject460) Set(val *InlineObject460) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject460) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject460) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject460(val *InlineObject460) *NullableInlineObject460 {
	return &NullableInlineObject460{value: val, isSet: true}
}

func (v NullableInlineObject460) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject460) UnmarshalJSON(src []byte) error {
	v.isSet = true
