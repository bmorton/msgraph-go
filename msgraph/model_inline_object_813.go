...
// InlineObject813 struct for InlineObject813
type InlineObject813 struct {
...
func (o *InlineObject813) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject813) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject813) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject813) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject813) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject813) SetSiteCollectionIdNil() {
...
func (o *InlineObject813) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject813) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject813 struct {
	value *InlineObject813
	isSet bool
}

func (v NullableInlineObject813) Get() *InlineObject813 {
	return v.value
}

func (v *NullableInlineObject813) Set(val *InlineObject813) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject813) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject813) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject813(val *InlineObject813) *NullableInlineObject813 {
	return &NullableInlineObject813{value: val, isSet: true}
}

func (v NullableInlineObject813) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject813) UnmarshalJSON(src []byte) error {
	v.isSet = true
