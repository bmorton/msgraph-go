...
func (o InlineObject341) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject341 struct {
	value *InlineObject341
	isSet bool
}

func (v NullableInlineObject341) Get() *InlineObject341 {
	return v.value
}

func (v *NullableInlineObject341) Set(val *InlineObject341) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject341) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject341) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject341(val *InlineObject341) *NullableInlineObject341 {
	return &NullableInlineObject341{value: val, isSet: true}
}

func (v NullableInlineObject341) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject341) UnmarshalJSON(src []byte) error {
	v.isSet = true
