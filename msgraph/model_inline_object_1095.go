...
func (o *InlineObject1095) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1095) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1095) SetSiteCollectionIdNil() {
...
func (o *InlineObject1095) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject1095 struct {
	value *InlineObject1095
	isSet bool
}

func (v NullableInlineObject1095) Get() *InlineObject1095 {
	return v.value
}

func (v *NullableInlineObject1095) Set(val *InlineObject1095) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1095) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1095) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1095(val *InlineObject1095) *NullableInlineObject1095 {
	return &NullableInlineObject1095{value: val, isSet: true}
}

func (v NullableInlineObject1095) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1095) UnmarshalJSON(src []byte) error {
	v.isSet = true
