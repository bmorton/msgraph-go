...
func (o *InlineObject943) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject943) SetSendResponseNil() {
...
func (o InlineObject943) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject943 struct {
	value *InlineObject943
	isSet bool
}

func (v NullableInlineObject943) Get() *InlineObject943 {
	return v.value
}

func (v *NullableInlineObject943) Set(val *InlineObject943) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject943) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject943) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject943(val *InlineObject943) *NullableInlineObject943 {
	return &NullableInlineObject943{value: val, isSet: true}
}

func (v NullableInlineObject943) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject943) UnmarshalJSON(src []byte) error {
	v.isSet = true
