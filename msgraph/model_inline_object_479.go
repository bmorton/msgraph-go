...
func (o *InlineObject479) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject479) SetSendResponseNil() {
...
func (o InlineObject479) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject479 struct {
	value *InlineObject479
	isSet bool
}

func (v NullableInlineObject479) Get() *InlineObject479 {
	return v.value
}

func (v *NullableInlineObject479) Set(val *InlineObject479) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject479) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject479) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject479(val *InlineObject479) *NullableInlineObject479 {
	return &NullableInlineObject479{value: val, isSet: true}
}

func (v NullableInlineObject479) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject479) UnmarshalJSON(src []byte) error {
	v.isSet = true
