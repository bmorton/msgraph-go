...
// InlineObject325 struct for InlineObject325
type InlineObject325 struct {
...
func (o *InlineObject325) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject325) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject325) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject325) SetSiteCollectionIdNil() {
...
func (o *InlineObject325) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject325) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject325 struct {
	value *InlineObject325
	isSet bool
}

func (v NullableInlineObject325) Get() *InlineObject325 {
	return v.value
}

func (v *NullableInlineObject325) Set(val *InlineObject325) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject325) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject325) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject325(val *InlineObject325) *NullableInlineObject325 {
	return &NullableInlineObject325{value: val, isSet: true}
}

func (v NullableInlineObject325) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject325) UnmarshalJSON(src []byte) error {
	v.isSet = true
