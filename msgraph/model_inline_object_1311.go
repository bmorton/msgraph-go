...
func (o InlineObject1311) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1311 struct {
	value *InlineObject1311
	isSet bool
}

func (v NullableInlineObject1311) Get() *InlineObject1311 {
	return v.value
}

func (v *NullableInlineObject1311) Set(val *InlineObject1311) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1311) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1311) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1311(val *InlineObject1311) *NullableInlineObject1311 {
	return &NullableInlineObject1311{value: val, isSet: true}
}

func (v NullableInlineObject1311) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1311) UnmarshalJSON(src []byte) error {
	v.isSet = true
