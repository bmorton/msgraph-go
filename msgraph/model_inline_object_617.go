...
// InlineObject617 struct for InlineObject617
type InlineObject617 struct {
...
func (o *InlineObject617) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject617) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject617) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject617) SetSiteCollectionIdNil() {
...
func (o *InlineObject617) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject617) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject617 struct {
	value *InlineObject617
	isSet bool
}

func (v NullableInlineObject617) Get() *InlineObject617 {
	return v.value
}

func (v *NullableInlineObject617) Set(val *InlineObject617) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject617) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject617) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject617(val *InlineObject617) *NullableInlineObject617 {
	return &NullableInlineObject617{value: val, isSet: true}
}

func (v NullableInlineObject617) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject617) UnmarshalJSON(src []byte) error {
	v.isSet = true
