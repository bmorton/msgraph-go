...
func (o *InlineObject590) SetMeetingDurationNil() {
...
func (o *InlineObject590) SetMaxCandidatesNil() {
...
func (o *InlineObject590) SetIsOrganizerOptionalNil() {
...
func (o *InlineObject590) SetReturnSuggestionReasonsNil() {
...
func (o InlineObject590) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject590 struct {
	value *InlineObject590
	isSet bool
}

func (v NullableInlineObject590) Get() *InlineObject590 {
	return v.value
}

func (v *NullableInlineObject590) Set(val *InlineObject590) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject590) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject590) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject590(val *InlineObject590) *NullableInlineObject590 {
	return &NullableInlineObject590{value: val, isSet: true}
}

func (v NullableInlineObject590) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject590) UnmarshalJSON(src []byte) error {
	v.isSet = true
