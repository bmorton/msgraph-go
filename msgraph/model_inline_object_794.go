...
func (o *InlineObject794) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject794) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject794) SetNotebookFolderNil() {
...
func (o *InlineObject794) SetSiteCollectionIdNil() {
...
func (o *InlineObject794) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject794 struct {
	value *InlineObject794
	isSet bool
}

func (v NullableInlineObject794) Get() *InlineObject794 {
	return v.value
}

func (v *NullableInlineObject794) Set(val *InlineObject794) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject794) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject794) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject794(val *InlineObject794) *NullableInlineObject794 {
	return &NullableInlineObject794{value: val, isSet: true}
}

func (v NullableInlineObject794) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject794) UnmarshalJSON(src []byte) error {
	v.isSet = true
