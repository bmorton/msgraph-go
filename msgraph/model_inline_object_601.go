...
// InlineObject601 struct for InlineObject601
type InlineObject601 struct {
...
func (o *InlineObject601) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject601) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject601) SetSiteCollectionIdNil() {
...
func (o *InlineObject601) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject601) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject601 struct {
	value *InlineObject601
	isSet bool
}

func (v NullableInlineObject601) Get() *InlineObject601 {
	return v.value
}

func (v *NullableInlineObject601) Set(val *InlineObject601) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject601) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject601) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject601(val *InlineObject601) *NullableInlineObject601 {
	return &NullableInlineObject601{value: val, isSet: true}
}

func (v NullableInlineObject601) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject601) UnmarshalJSON(src []byte) error {
	v.isSet = true
