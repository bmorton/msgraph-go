...
func (o *InlineObject661) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject661) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject661) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject661) SetSiteCollectionIdNil() {
...
func (o *InlineObject661) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject661 struct {
	value *InlineObject661
	isSet bool
}

func (v NullableInlineObject661) Get() *InlineObject661 {
	return v.value
}

func (v *NullableInlineObject661) Set(val *InlineObject661) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject661) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject661) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject661(val *InlineObject661) *NullableInlineObject661 {
	return &NullableInlineObject661{value: val, isSet: true}
}

func (v NullableInlineObject661) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject661) UnmarshalJSON(src []byte) error {
	v.isSet = true
