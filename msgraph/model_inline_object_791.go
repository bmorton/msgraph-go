...
func (o *InlineObject791) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject791) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject791) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject791) SetSiteCollectionIdNil() {
...
func (o *InlineObject791) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject791) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject791 struct {
	value *InlineObject791
	isSet bool
}

func (v NullableInlineObject791) Get() *InlineObject791 {
	return v.value
}

func (v *NullableInlineObject791) Set(val *InlineObject791) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject791) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject791) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject791(val *InlineObject791) *NullableInlineObject791 {
	return &NullableInlineObject791{value: val, isSet: true}
}

func (v NullableInlineObject791) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject791) UnmarshalJSON(src []byte) error {
	v.isSet = true
