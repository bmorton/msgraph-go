...
// InlineObject697 struct for InlineObject697
type InlineObject697 struct {
...
func (o *InlineObject697) SetSessionIdNil() {
	o.SessionId.Set(nil)
}
...
func (o *InlineObject697) SetExpirationDurationNil() {
...
func (o InlineObject697) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject697 struct {
	value *InlineObject697
	isSet bool
}

func (v NullableInlineObject697) Get() *InlineObject697 {
	return v.value
}

func (v *NullableInlineObject697) Set(val *InlineObject697) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject697) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject697) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject697(val *InlineObject697) *NullableInlineObject697 {
	return &NullableInlineObject697{value: val, isSet: true}
}

func (v NullableInlineObject697) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject697) UnmarshalJSON(src []byte) error {
	v.isSet = true
