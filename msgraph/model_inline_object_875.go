...
func (o *InlineObject875) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject875) SetSendResponseNil() {
...
type NullableInlineObject875 struct {
	value *InlineObject875
	isSet bool
}

func (v NullableInlineObject875) Get() *InlineObject875 {
	return v.value
}

func (v *NullableInlineObject875) Set(val *InlineObject875) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject875) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject875) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject875(val *InlineObject875) *NullableInlineObject875 {
	return &NullableInlineObject875{value: val, isSet: true}
}

func (v NullableInlineObject875) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject875) UnmarshalJSON(src []byte) error {
	v.isSet = true
