...
// InlineObject1632 struct for InlineObject1632
type InlineObject1632 struct {
...
func (o *InlineObject1632) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *InlineObject1632) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o InlineObject1632) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1632 struct {
	value *InlineObject1632
	isSet bool
}

func (v NullableInlineObject1632) Get() *InlineObject1632 {
	return v.value
}

func (v *NullableInlineObject1632) Set(val *InlineObject1632) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1632) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1632) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1632(val *InlineObject1632) *NullableInlineObject1632 {
	return &NullableInlineObject1632{value: val, isSet: true}
}

func (v NullableInlineObject1632) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1632) UnmarshalJSON(src []byte) error {
	v.isSet = true
