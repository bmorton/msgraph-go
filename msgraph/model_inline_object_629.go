...
func (o *InlineObject629) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject629) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject629) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject629) SetSiteCollectionIdNil() {
...
func (o *InlineObject629) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject629 struct {
	value *InlineObject629
	isSet bool
}

func (v NullableInlineObject629) Get() *InlineObject629 {
	return v.value
}

func (v *NullableInlineObject629) Set(val *InlineObject629) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject629) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject629) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject629(val *InlineObject629) *NullableInlineObject629 {
	return &NullableInlineObject629{value: val, isSet: true}
}

func (v NullableInlineObject629) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject629) UnmarshalJSON(src []byte) error {
	v.isSet = true
