...
func (o *InlineObject763) HasGroupId() bool {
...
func (o *InlineObject763) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject763) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject763) GetNotebookFolderOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject763) SetNotebookFolderNil() {
...
func (o *InlineObject763) SetSiteCollectionIdNil() {
...
func (o *InlineObject763) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject763) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject763 struct {
	value *InlineObject763
	isSet bool
}

func (v NullableInlineObject763) Get() *InlineObject763 {
	return v.value
}

func (v *NullableInlineObject763) Set(val *InlineObject763) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject763) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject763) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject763(val *InlineObject763) *NullableInlineObject763 {
	return &NullableInlineObject763{value: val, isSet: true}
}

func (v NullableInlineObject763) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject763) UnmarshalJSON(src []byte) error {
	v.isSet = true
