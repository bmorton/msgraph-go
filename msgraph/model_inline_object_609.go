...
func (o *InlineObject609) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject609) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject609) SetSiteCollectionIdNil() {
...
func (o *InlineObject609) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject609) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject609 struct {
	value *InlineObject609
	isSet bool
}

func (v NullableInlineObject609) Get() *InlineObject609 {
	return v.value
}

func (v *NullableInlineObject609) Set(val *InlineObject609) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject609) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject609) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject609(val *InlineObject609) *NullableInlineObject609 {
	return &NullableInlineObject609{value: val, isSet: true}
}

func (v NullableInlineObject609) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject609) UnmarshalJSON(src []byte) error {
	v.isSet = true
