...
func (o *InlineObject796) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject796) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject796) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject796) SetSiteCollectionIdNil() {
...
func (o *InlineObject796) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject796) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject796 struct {
	value *InlineObject796
	isSet bool
}

func (v NullableInlineObject796) Get() *InlineObject796 {
	return v.value
}

func (v *NullableInlineObject796) Set(val *InlineObject796) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject796) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject796) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject796(val *InlineObject796) *NullableInlineObject796 {
	return &NullableInlineObject796{value: val, isSet: true}
}

func (v NullableInlineObject796) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject796) UnmarshalJSON(src []byte) error {
	v.isSet = true
