...
// InlineObject435 struct for InlineObject435
type InlineObject435 struct {
...
func (o *InlineObject435) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject435) SetSendResponseNil() {
...
func (o InlineObject435) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject435 struct {
	value *InlineObject435
	isSet bool
}

func (v NullableInlineObject435) Get() *InlineObject435 {
	return v.value
}

func (v *NullableInlineObject435) Set(val *InlineObject435) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject435) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject435) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject435(val *InlineObject435) *NullableInlineObject435 {
	return &NullableInlineObject435{value: val, isSet: true}
}

func (v NullableInlineObject435) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject435) UnmarshalJSON(src []byte) error {
	v.isSet = true
