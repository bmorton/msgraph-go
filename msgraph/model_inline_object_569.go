...
// InlineObject569 struct for InlineObject569
type InlineObject569 struct {
...
func (o InlineObject569) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject569 struct {
	value *InlineObject569
	isSet bool
}

func (v NullableInlineObject569) Get() *InlineObject569 {
	return v.value
}

func (v *NullableInlineObject569) Set(val *InlineObject569) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject569) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject569) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject569(val *InlineObject569) *NullableInlineObject569 {
	return &NullableInlineObject569{value: val, isSet: true}
}

func (v NullableInlineObject569) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject569) UnmarshalJSON(src []byte) error {
	v.isSet = true
