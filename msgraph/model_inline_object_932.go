...
func (o *InlineObject932) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject932) SetSendResponseNil() {
...
func (o InlineObject932) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject932 struct {
	value *InlineObject932
	isSet bool
}

func (v NullableInlineObject932) Get() *InlineObject932 {
	return v.value
}

func (v *NullableInlineObject932) Set(val *InlineObject932) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject932) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject932) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject932(val *InlineObject932) *NullableInlineObject932 {
	return &NullableInlineObject932{value: val, isSet: true}
}

func (v NullableInlineObject932) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject932) UnmarshalJSON(src []byte) error {
	v.isSet = true
