...
func (o *InlineObject1165) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1165) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1165) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1165) SetSiteCollectionIdNil() {
...
func (o *InlineObject1165) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1165) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1165 struct {
	value *InlineObject1165
	isSet bool
}

func (v NullableInlineObject1165) Get() *InlineObject1165 {
	return v.value
}

func (v *NullableInlineObject1165) Set(val *InlineObject1165) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1165) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1165) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1165(val *InlineObject1165) *NullableInlineObject1165 {
	return &NullableInlineObject1165{value: val, isSet: true}
}

func (v NullableInlineObject1165) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1165) UnmarshalJSON(src []byte) error {
	v.isSet = true
