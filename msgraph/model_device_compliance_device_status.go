...
func NewDeviceComplianceDeviceStatus() *DeviceComplianceDeviceStatus {
	this := DeviceComplianceDeviceStatus{}
	return &this
}
...
func (o *DeviceComplianceDeviceStatus) SetDeviceDisplayNameNil() {
...
func (o *DeviceComplianceDeviceStatus) SetDeviceModelNil() {
...
func (o *DeviceComplianceDeviceStatus) SetUserNameNil() {
	o.UserName.Set(nil)
}
...
func (o *DeviceComplianceDeviceStatus) SetUserPrincipalNameNil() {
...
func (o DeviceComplianceDeviceStatus) MarshalJSON() ([]byte, error) {
...
type NullableDeviceComplianceDeviceStatus struct {
	value *DeviceComplianceDeviceStatus
	isSet bool
}

func (v NullableDeviceComplianceDeviceStatus) Get() *DeviceComplianceDeviceStatus {
	return v.value
}

func (v *NullableDeviceComplianceDeviceStatus) Set(val *DeviceComplianceDeviceStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceComplianceDeviceStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceComplianceDeviceStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceComplianceDeviceStatus(val *DeviceComplianceDeviceStatus) *NullableDeviceComplianceDeviceStatus {
	return &NullableDeviceComplianceDeviceStatus{value: val, isSet: true}
}

func (v NullableDeviceComplianceDeviceStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceComplianceDeviceStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
