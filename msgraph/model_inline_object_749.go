...
func (o *InlineObject749) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject749) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject749) SetSiteCollectionIdNil() {
...
func (o *InlineObject749) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject749) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject749 struct {
	value *InlineObject749
	isSet bool
}

func (v NullableInlineObject749) Get() *InlineObject749 {
	return v.value
}

func (v *NullableInlineObject749) Set(val *InlineObject749) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject749) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject749) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject749(val *InlineObject749) *NullableInlineObject749 {
	return &NullableInlineObject749{value: val, isSet: true}
}

func (v NullableInlineObject749) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject749) UnmarshalJSON(src []byte) error {
	v.isSet = true
