...
func (o *InlineObject304) HasGroupId() bool {
...
func (o *InlineObject304) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject304) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject304) GetNotebookFolderOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject304) SetNotebookFolderNil() {
...
func (o *InlineObject304) SetSiteCollectionIdNil() {
...
func (o *InlineObject304) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
