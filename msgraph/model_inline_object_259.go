...
func (o *InlineObject259) HasGroupId() bool {
...
func (o *InlineObject259) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject259) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject259) GetNotebookFolderOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject259) SetNotebookFolderNil() {
...
func (o *InlineObject259) SetSiteCollectionIdNil() {
...
func (o *InlineObject259) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
