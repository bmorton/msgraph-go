...
func (o *InlineObject1191) SetSessionIdNil() {
	o.SessionId.Set(nil)
}
...
func (o *InlineObject1191) SetExpirationDurationNil() {
...
func (o InlineObject1191) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1191 struct {
	value *InlineObject1191
	isSet bool
}

func (v NullableInlineObject1191) Get() *InlineObject1191 {
	return v.value
}

func (v *NullableInlineObject1191) Set(val *InlineObject1191) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1191) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1191) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1191(val *InlineObject1191) *NullableInlineObject1191 {
	return &NullableInlineObject1191{value: val, isSet: true}
}

func (v NullableInlineObject1191) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1191) UnmarshalJSON(src []byte) error {
	v.isSet = true
