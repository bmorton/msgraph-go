...
// InlineObject366 struct for InlineObject366
type InlineObject366 struct {
...
func (o *InlineObject366) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject366) SetSendResponseNil() {
...
func (o InlineObject366) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject366 struct {
	value *InlineObject366
	isSet bool
}

func (v NullableInlineObject366) Get() *InlineObject366 {
	return v.value
}

func (v *NullableInlineObject366) Set(val *InlineObject366) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject366) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject366) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject366(val *InlineObject366) *NullableInlineObject366 {
	return &NullableInlineObject366{value: val, isSet: true}
}

func (v NullableInlineObject366) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject366) UnmarshalJSON(src []byte) error {
	v.isSet = true
