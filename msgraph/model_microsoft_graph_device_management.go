...
func NewMicrosoftGraphDeviceManagement() *MicrosoftGraphDeviceManagement {
	this := MicrosoftGraphDeviceManagement{}
	return &this
}
...
type NullableMicrosoftGraphDeviceManagement struct {
	value *MicrosoftGraphDeviceManagement
	isSet bool
}

func (v NullableMicrosoftGraphDeviceManagement) Get() *MicrosoftGraphDeviceManagement {
	return v.value
}

func (v *NullableMicrosoftGraphDeviceManagement) Set(val *MicrosoftGraphDeviceManagement) {
	v.value = val
	v.isSet = true
}

func (v NullableMicrosoftGraphDeviceManagement) IsSet() bool {
	return v.isSet
}

func (v *NullableMicrosoftGraphDeviceManagement) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMicrosoftGraphDeviceManagement(val *MicrosoftGraphDeviceManagement) *NullableMicrosoftGraphDeviceManagement {
	return &NullableMicrosoftGraphDeviceManagement{value: val, isSet: true}
}

func (v NullableMicrosoftGraphDeviceManagement) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMicrosoftGraphDeviceManagement) UnmarshalJSON(src []byte) error {
	v.isSet = true
