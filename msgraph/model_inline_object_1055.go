...
type NullableInlineObject1055 struct {
	value *InlineObject1055
	isSet bool
}

func (v NullableInlineObject1055) Get() *InlineObject1055 {
	return v.value
}

func (v *NullableInlineObject1055) Set(val *InlineObject1055) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1055) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1055) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1055(val *InlineObject1055) *NullableInlineObject1055 {
	return &NullableInlineObject1055{value: val, isSet: true}
}

func (v NullableInlineObject1055) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1055) UnmarshalJSON(src []byte) error {
	v.isSet = true
