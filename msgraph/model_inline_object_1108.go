...
func (o *InlineObject1108) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1108) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1108) SetNotebookFolderNil() {
...
func (o *InlineObject1108) SetSiteCollectionIdNil() {
...
func (o *InlineObject1108) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject1108 struct {
	value *InlineObject1108
	isSet bool
}

func (v NullableInlineObject1108) Get() *InlineObject1108 {
	return v.value
}

func (v *NullableInlineObject1108) Set(val *InlineObject1108) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1108) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1108) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1108(val *InlineObject1108) *NullableInlineObject1108 {
	return &NullableInlineObject1108{value: val, isSet: true}
}

func (v NullableInlineObject1108) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1108) UnmarshalJSON(src []byte) error {
	v.isSet = true
