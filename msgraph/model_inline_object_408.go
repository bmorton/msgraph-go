...
// InlineObject408 struct for InlineObject408
type InlineObject408 struct {
...
func (o InlineObject408) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject408 struct {
	value *InlineObject408
	isSet bool
}

func (v NullableInlineObject408) Get() *InlineObject408 {
	return v.value
}

func (v *NullableInlineObject408) Set(val *InlineObject408) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject408) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject408) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject408(val *InlineObject408) *NullableInlineObject408 {
	return &NullableInlineObject408{value: val, isSet: true}
}

func (v NullableInlineObject408) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject408) UnmarshalJSON(src []byte) error {
	v.isSet = true
