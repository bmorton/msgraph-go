...
func (o *InlineObject890) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject890) SetSendResponseNil() {
...
type NullableInlineObject890 struct {
	value *InlineObject890
	isSet bool
}

func (v NullableInlineObject890) Get() *InlineObject890 {
	return v.value
}

func (v *NullableInlineObject890) Set(val *InlineObject890) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject890) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject890) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject890(val *InlineObject890) *NullableInlineObject890 {
	return &NullableInlineObject890{value: val, isSet: true}
}

func (v NullableInlineObject890) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject890) UnmarshalJSON(src []byte) error {
	v.isSet = true
