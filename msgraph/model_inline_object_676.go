...
func (o *InlineObject676) HasGroupId() bool {
...
func (o *InlineObject676) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject676) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject676) GetNotebookFolderOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject676) SetNotebookFolderNil() {
...
func (o *InlineObject676) SetSiteCollectionIdNil() {
...
func (o *InlineObject676) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject676) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject676 struct {
	value *InlineObject676
	isSet bool
}

func (v NullableInlineObject676) Get() *InlineObject676 {
	return v.value
}

func (v *NullableInlineObject676) Set(val *InlineObject676) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject676) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject676) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject676(val *InlineObject676) *NullableInlineObject676 {
	return &NullableInlineObject676{value: val, isSet: true}
}

func (v NullableInlineObject676) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject676) UnmarshalJSON(src []byte) error {
	v.isSet = true
