...
func (o *InlineObject671) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject671) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject671) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject671) SetSiteCollectionIdNil() {
...
func (o *InlineObject671) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject671) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject671 struct {
	value *InlineObject671
	isSet bool
}

func (v NullableInlineObject671) Get() *InlineObject671 {
	return v.value
}

func (v *NullableInlineObject671) Set(val *InlineObject671) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject671) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject671) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject671(val *InlineObject671) *NullableInlineObject671 {
	return &NullableInlineObject671{value: val, isSet: true}
}

func (v NullableInlineObject671) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject671) UnmarshalJSON(src []byte) error {
	v.isSet = true
