...
func (o *InlineObject1107) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1107) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1107) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1107) SetSiteCollectionIdNil() {
...
func (o *InlineObject1107) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1107) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1107 struct {
	value *InlineObject1107
	isSet bool
}

func (v NullableInlineObject1107) Get() *InlineObject1107 {
	return v.value
}

func (v *NullableInlineObject1107) Set(val *InlineObject1107) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1107) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1107) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1107(val *InlineObject1107) *NullableInlineObject1107 {
	return &NullableInlineObject1107{value: val, isSet: true}
}

func (v NullableInlineObject1107) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1107) UnmarshalJSON(src []byte) error {
	v.isSet = true
