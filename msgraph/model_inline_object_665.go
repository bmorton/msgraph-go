...
func (o *InlineObject665) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject665) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject665) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject665) SetSiteCollectionIdNil() {
...
func (o *InlineObject665) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject665) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject665 struct {
	value *InlineObject665
	isSet bool
}

func (v NullableInlineObject665) Get() *InlineObject665 {
	return v.value
}

func (v *NullableInlineObject665) Set(val *InlineObject665) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject665) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject665) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject665(val *InlineObject665) *NullableInlineObject665 {
	return &NullableInlineObject665{value: val, isSet: true}
}

func (v NullableInlineObject665) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject665) UnmarshalJSON(src []byte) error {
	v.isSet = true
