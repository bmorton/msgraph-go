...
// InlineObject1480 struct for InlineObject1480
type InlineObject1480 struct {
...
func (o InlineObject1480) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1480 struct {
	value *InlineObject1480
	isSet bool
}

func (v NullableInlineObject1480) Get() *InlineObject1480 {
	return v.value
}

func (v *NullableInlineObject1480) Set(val *InlineObject1480) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1480) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1480) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1480(val *InlineObject1480) *NullableInlineObject1480 {
	return &NullableInlineObject1480{value: val, isSet: true}
}

func (v NullableInlineObject1480) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1480) UnmarshalJSON(src []byte) error {
	v.isSet = true
