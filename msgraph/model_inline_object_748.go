...
// InlineObject748 struct for InlineObject748
type InlineObject748 struct {
...
func (o *InlineObject748) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject748) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject748) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject748) SetSiteCollectionIdNil() {
...
func (o *InlineObject748) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject748) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject748 struct {
	value *InlineObject748
	isSet bool
}

func (v NullableInlineObject748) Get() *InlineObject748 {
	return v.value
}

func (v *NullableInlineObject748) Set(val *InlineObject748) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject748) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject748) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject748(val *InlineObject748) *NullableInlineObject748 {
	return &NullableInlineObject748{value: val, isSet: true}
}

func (v NullableInlineObject748) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject748) UnmarshalJSON(src []byte) error {
	v.isSet = true
