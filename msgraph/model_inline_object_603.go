...
func (o *InlineObject603) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject603) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject603) SetNotebookFolderNil() {
...
func (o *InlineObject603) SetSiteCollectionIdNil() {
...
func (o *InlineObject603) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject603) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject603 struct {
	value *InlineObject603
	isSet bool
}

func (v NullableInlineObject603) Get() *InlineObject603 {
	return v.value
}

func (v *NullableInlineObject603) Set(val *InlineObject603) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject603) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject603) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject603(val *InlineObject603) *NullableInlineObject603 {
	return &NullableInlineObject603{value: val, isSet: true}
}

func (v NullableInlineObject603) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject603) UnmarshalJSON(src []byte) error {
	v.isSet = true
