...
func (o *InlineObject1138) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1138) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1138) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1138) SetSiteCollectionIdNil() {
...
func (o *InlineObject1138) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1138) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1138 struct {
	value *InlineObject1138
	isSet bool
}

func (v NullableInlineObject1138) Get() *InlineObject1138 {
	return v.value
}

func (v *NullableInlineObject1138) Set(val *InlineObject1138) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1138) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1138) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1138(val *InlineObject1138) *NullableInlineObject1138 {
	return &NullableInlineObject1138{value: val, isSet: true}
}

func (v NullableInlineObject1138) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1138) UnmarshalJSON(src []byte) error {
	v.isSet = true
