...
func (o *InlineObject386) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject386) SetSendResponseNil() {
...
func (o InlineObject386) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject386 struct {
	value *InlineObject386
	isSet bool
}

func (v NullableInlineObject386) Get() *InlineObject386 {
	return v.value
}

func (v *NullableInlineObject386) Set(val *InlineObject386) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject386) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject386) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject386(val *InlineObject386) *NullableInlineObject386 {
	return &NullableInlineObject386{value: val, isSet: true}
}

func (v NullableInlineObject386) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject386) UnmarshalJSON(src []byte) error {
	v.isSet = true
