...
`func (o *InlineObject233) GetToRecipients() []*AnyOfmicrosoftGraphRecipient`

GetToRecipients returns the ToRecipients field if non-nil, zero value otherwise.

### GetToRecipientsOk

`func (o *InlineObject233) GetToRecipientsOk() (*[]*AnyOfmicrosoftGraphRecipient, bool)`
...
`func (o *InlineObject233) SetToRecipients(v []*AnyOfmicrosoftGraphRecipient)`

SetToRecipients sets ToRecipients field to given value.

### HasToRecipients

`func (o *InlineObject233) HasToRecipients() bool`
...
`func (o *InlineObject233) SetCommentNil(b bool)`

 SetCommentNil sets the value for Comment to be an explicit nil

### UnsetComment
`func (o *InlineObject233) UnsetComment()`
