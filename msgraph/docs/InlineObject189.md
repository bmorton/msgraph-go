...
`func (o *InlineObject189) GetNewReminderTime() MicrosoftGraphDateTimeTimeZone`

GetNewReminderTime returns the NewReminderTime field if non-nil, zero value otherwise.

### GetNewReminderTimeOk

`func (o *InlineObject189) GetNewReminderTimeOk() (*MicrosoftGraphDateTimeTimeZone, bool)`
...
`func (o *InlineObject189) SetNewReminderTime(v MicrosoftGraphDateTimeTimeZone)`

SetNewReminderTime sets NewReminderTime field to given value.

### HasNewReminderTime

`func (o *InlineObject189) HasNewReminderTime() bool`
