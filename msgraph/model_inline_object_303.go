...
func (o *InlineObject303) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject303) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject303) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject303) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject303) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject303) SetSiteCollectionIdNil() {
...
func (o *InlineObject303) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
