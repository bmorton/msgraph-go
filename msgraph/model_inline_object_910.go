...
func (o *InlineObject910) SetAvailabilityViewIntervalNil() {
...
func (o InlineObject910) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject910 struct {
	value *InlineObject910
	isSet bool
}

func (v NullableInlineObject910) Get() *InlineObject910 {
	return v.value
}

func (v *NullableInlineObject910) Set(val *InlineObject910) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject910) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject910) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject910(val *InlineObject910) *NullableInlineObject910 {
	return &NullableInlineObject910{value: val, isSet: true}
}

func (v NullableInlineObject910) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject910) UnmarshalJSON(src []byte) error {
	v.isSet = true
