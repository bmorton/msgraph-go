...
func (o *InlineObject968) SetCommentNil() {
	o.Comment.Set(nil)
}
...
type NullableInlineObject968 struct {
	value *InlineObject968
	isSet bool
}

func (v NullableInlineObject968) Get() *InlineObject968 {
	return v.value
}

func (v *NullableInlineObject968) Set(val *InlineObject968) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject968) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject968) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject968(val *InlineObject968) *NullableInlineObject968 {
	return &NullableInlineObject968{value: val, isSet: true}
}

func (v NullableInlineObject968) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject968) UnmarshalJSON(src []byte) error {
	v.isSet = true
