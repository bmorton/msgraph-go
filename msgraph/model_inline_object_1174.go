...
func (o *InlineObject1174) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1174) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1174) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1174) SetSiteCollectionIdNil() {
...
func (o *InlineObject1174) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1174) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1174 struct {
	value *InlineObject1174
	isSet bool
}

func (v NullableInlineObject1174) Get() *InlineObject1174 {
	return v.value
}

func (v *NullableInlineObject1174) Set(val *InlineObject1174) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1174) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1174) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1174(val *InlineObject1174) *NullableInlineObject1174 {
	return &NullableInlineObject1174{value: val, isSet: true}
}

func (v NullableInlineObject1174) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1174) UnmarshalJSON(src []byte) error {
	v.isSet = true
