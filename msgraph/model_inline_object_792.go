...
func (o *InlineObject792) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject792) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject792) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject792) SetSiteCollectionIdNil() {
...
func (o *InlineObject792) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject792) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject792 struct {
	value *InlineObject792
	isSet bool
}

func (v NullableInlineObject792) Get() *InlineObject792 {
	return v.value
}

func (v *NullableInlineObject792) Set(val *InlineObject792) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject792) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject792) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject792(val *InlineObject792) *NullableInlineObject792 {
	return &NullableInlineObject792{value: val, isSet: true}
}

func (v NullableInlineObject792) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject792) UnmarshalJSON(src []byte) error {
	v.isSet = true
