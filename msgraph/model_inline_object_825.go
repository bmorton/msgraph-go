...
func (o *InlineObject825) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject825) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject825) SetNotebookFolderNil() {
...
func (o *InlineObject825) SetSiteCollectionIdNil() {
...
func (o *InlineObject825) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject825 struct {
	value *InlineObject825
	isSet bool
}

func (v NullableInlineObject825) Get() *InlineObject825 {
	return v.value
}

func (v *NullableInlineObject825) Set(val *InlineObject825) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject825) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject825) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject825(val *InlineObject825) *NullableInlineObject825 {
	return &NullableInlineObject825{value: val, isSet: true}
}

func (v NullableInlineObject825) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject825) UnmarshalJSON(src []byte) error {
	v.isSet = true
