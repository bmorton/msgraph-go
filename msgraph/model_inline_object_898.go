...
// InlineObject898 struct for InlineObject898
type InlineObject898 struct {
...
func (o *InlineObject898) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject898) SetSendResponseNil() {
...
func (o InlineObject898) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject898 struct {
	value *InlineObject898
	isSet bool
}

func (v NullableInlineObject898) Get() *InlineObject898 {
	return v.value
}

func (v *NullableInlineObject898) Set(val *InlineObject898) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject898) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject898) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject898(val *InlineObject898) *NullableInlineObject898 {
	return &NullableInlineObject898{value: val, isSet: true}
}

func (v NullableInlineObject898) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject898) UnmarshalJSON(src []byte) error {
	v.isSet = true
