...
func (o *InlineObject921) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject921) SetSendResponseNil() {
...
func (o InlineObject921) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject921 struct {
	value *InlineObject921
	isSet bool
}

func (v NullableInlineObject921) Get() *InlineObject921 {
	return v.value
}

func (v *NullableInlineObject921) Set(val *InlineObject921) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject921) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject921) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject921(val *InlineObject921) *NullableInlineObject921 {
	return &NullableInlineObject921{value: val, isSet: true}
}

func (v NullableInlineObject921) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject921) UnmarshalJSON(src []byte) error {
	v.isSet = true
