...
// InlineObject679 struct for InlineObject679
type InlineObject679 struct {
...
func (o *InlineObject679) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject679) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject679) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject679) SetSiteCollectionIdNil() {
...
func (o *InlineObject679) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject679) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject679 struct {
	value *InlineObject679
	isSet bool
}

func (v NullableInlineObject679) Get() *InlineObject679 {
	return v.value
}

func (v *NullableInlineObject679) Set(val *InlineObject679) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject679) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject679) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject679(val *InlineObject679) *NullableInlineObject679 {
	return &NullableInlineObject679{value: val, isSet: true}
}

func (v NullableInlineObject679) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject679) UnmarshalJSON(src []byte) error {
	v.isSet = true
