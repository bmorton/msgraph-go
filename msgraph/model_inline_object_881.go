...
func (o *InlineObject881) SetAvailabilityViewIntervalNil() {
...
type NullableInlineObject881 struct {
	value *InlineObject881
	isSet bool
}

func (v NullableInlineObject881) Get() *InlineObject881 {
	return v.value
}

func (v *NullableInlineObject881) Set(val *InlineObject881) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject881) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject881) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject881(val *InlineObject881) *NullableInlineObject881 {
	return &NullableInlineObject881{value: val, isSet: true}
}

func (v NullableInlineObject881) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject881) UnmarshalJSON(src []byte) error {
	v.isSet = true
