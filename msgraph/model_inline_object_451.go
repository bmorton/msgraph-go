...
// InlineObject451 struct for InlineObject451
type InlineObject451 struct {
...
func (o InlineObject451) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject451 struct {
	value *InlineObject451
	isSet bool
}

func (v NullableInlineObject451) Get() *InlineObject451 {
	return v.value
}

func (v *NullableInlineObject451) Set(val *InlineObject451) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject451) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject451) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject451(val *InlineObject451) *NullableInlineObject451 {
	return &NullableInlineObject451{value: val, isSet: true}
}

func (v NullableInlineObject451) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject451) UnmarshalJSON(src []byte) error {
	v.isSet = true
