...
func (o *InlineObject1168) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1168) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1168) SetSiteCollectionIdNil() {
...
func (o *InlineObject1168) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject1168 struct {
	value *InlineObject1168
	isSet bool
}

func (v NullableInlineObject1168) Get() *InlineObject1168 {
	return v.value
}

func (v *NullableInlineObject1168) Set(val *InlineObject1168) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1168) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1168) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1168(val *InlineObject1168) *NullableInlineObject1168 {
	return &NullableInlineObject1168{value: val, isSet: true}
}

func (v NullableInlineObject1168) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1168) UnmarshalJSON(src []byte) error {
	v.isSet = true
