...
func (o *InlineObject1181) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1181) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1181) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1181) SetSiteCollectionIdNil() {
...
func (o *InlineObject1181) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1181) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1181 struct {
	value *InlineObject1181
	isSet bool
}

func (v NullableInlineObject1181) Get() *InlineObject1181 {
	return v.value
}

func (v *NullableInlineObject1181) Set(val *InlineObject1181) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1181) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1181) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1181(val *InlineObject1181) *NullableInlineObject1181 {
	return &NullableInlineObject1181{value: val, isSet: true}
}

func (v NullableInlineObject1181) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1181) UnmarshalJSON(src []byte) error {
	v.isSet = true
