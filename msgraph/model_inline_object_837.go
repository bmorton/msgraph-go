...
// InlineObject837 struct for InlineObject837
type InlineObject837 struct {
...
func (o *InlineObject837) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject837) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject837) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject837) SetSiteCollectionIdNil() {
...
func (o *InlineObject837) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject837) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject837 struct {
	value *InlineObject837
	isSet bool
}

func (v NullableInlineObject837) Get() *InlineObject837 {
	return v.value
}

func (v *NullableInlineObject837) Set(val *InlineObject837) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject837) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject837) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject837(val *InlineObject837) *NullableInlineObject837 {
	return &NullableInlineObject837{value: val, isSet: true}
}

func (v NullableInlineObject837) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject837) UnmarshalJSON(src []byte) error {
	v.isSet = true
