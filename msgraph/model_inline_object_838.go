...
func (o *InlineObject838) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject838) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject838) SetNotebookFolderNil() {
...
func (o *InlineObject838) SetSiteCollectionIdNil() {
...
func (o *InlineObject838) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject838 struct {
	value *InlineObject838
	isSet bool
}

func (v NullableInlineObject838) Get() *InlineObject838 {
	return v.value
}

func (v *NullableInlineObject838) Set(val *InlineObject838) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject838) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject838) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject838(val *InlineObject838) *NullableInlineObject838 {
	return &NullableInlineObject838{value: val, isSet: true}
}

func (v NullableInlineObject838) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject838) UnmarshalJSON(src []byte) error {
	v.isSet = true
