...
// InlineObject441 struct for InlineObject441
type InlineObject441 struct {
...
func (o *InlineObject441) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject441) SetSendResponseNil() {
...
func (o InlineObject441) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject441 struct {
	value *InlineObject441
	isSet bool
}

func (v NullableInlineObject441) Get() *InlineObject441 {
	return v.value
}

func (v *NullableInlineObject441) Set(val *InlineObject441) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject441) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject441) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject441(val *InlineObject441) *NullableInlineObject441 {
	return &NullableInlineObject441{value: val, isSet: true}
}

func (v NullableInlineObject441) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject441) UnmarshalJSON(src []byte) error {
	v.isSet = true
