...
func (o *InlineObject759) HasGroupId() bool {
...
func (o *InlineObject759) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject759) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject759) GetNotebookFolderOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject759) SetNotebookFolderNil() {
...
func (o *InlineObject759) SetSiteCollectionIdNil() {
...
func (o *InlineObject759) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject759) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject759 struct {
	value *InlineObject759
	isSet bool
}

func (v NullableInlineObject759) Get() *InlineObject759 {
	return v.value
}

func (v *NullableInlineObject759) Set(val *InlineObject759) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject759) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject759) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject759(val *InlineObject759) *NullableInlineObject759 {
	return &NullableInlineObject759{value: val, isSet: true}
}

func (v NullableInlineObject759) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject759) UnmarshalJSON(src []byte) error {
	v.isSet = true
