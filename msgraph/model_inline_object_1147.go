...
func (o *InlineObject1147) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1147) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1147) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1147) SetSiteCollectionIdNil() {
...
func (o *InlineObject1147) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1147) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1147 struct {
	value *InlineObject1147
	isSet bool
}

func (v NullableInlineObject1147) Get() *InlineObject1147 {
	return v.value
}

func (v *NullableInlineObject1147) Set(val *InlineObject1147) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1147) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1147) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1147(val *InlineObject1147) *NullableInlineObject1147 {
	return &NullableInlineObject1147{value: val, isSet: true}
}

func (v NullableInlineObject1147) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1147) UnmarshalJSON(src []byte) error {
	v.isSet = true
