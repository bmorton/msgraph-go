...
// InlineObject439 struct for InlineObject439
type InlineObject439 struct {
...
func (o *InlineObject439) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject439) SetSendResponseNil() {
...
func (o InlineObject439) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject439 struct {
	value *InlineObject439
	isSet bool
}

func (v NullableInlineObject439) Get() *InlineObject439 {
	return v.value
}

func (v *NullableInlineObject439) Set(val *InlineObject439) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject439) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject439) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject439(val *InlineObject439) *NullableInlineObject439 {
	return &NullableInlineObject439{value: val, isSet: true}
}

func (v NullableInlineObject439) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject439) UnmarshalJSON(src []byte) error {
	v.isSet = true
