...
func (o *InlineObject390) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject390) SetSendResponseNil() {
...
func (o InlineObject390) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject390 struct {
	value *InlineObject390
	isSet bool
}

func (v NullableInlineObject390) Get() *InlineObject390 {
	return v.value
}

func (v *NullableInlineObject390) Set(val *InlineObject390) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject390) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject390) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject390(val *InlineObject390) *NullableInlineObject390 {
	return &NullableInlineObject390{value: val, isSet: true}
}

func (v NullableInlineObject390) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject390) UnmarshalJSON(src []byte) error {
	v.isSet = true
