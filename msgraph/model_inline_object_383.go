...
// InlineObject383 struct for InlineObject383
type InlineObject383 struct {
...
func (o *InlineObject383) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject383) SetSendResponseNil() {
...
func (o InlineObject383) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject383 struct {
	value *InlineObject383
	isSet bool
}

func (v NullableInlineObject383) Get() *InlineObject383 {
	return v.value
}

func (v *NullableInlineObject383) Set(val *InlineObject383) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject383) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject383) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject383(val *InlineObject383) *NullableInlineObject383 {
	return &NullableInlineObject383{value: val, isSet: true}
}

func (v NullableInlineObject383) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject383) UnmarshalJSON(src []byte) error {
	v.isSet = true
