...
// InlineObject688 struct for InlineObject688
type InlineObject688 struct {
...
func (o *InlineObject688) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject688) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject688) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject688) SetSiteCollectionIdNil() {
...
func (o *InlineObject688) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject688) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject688 struct {
	value *InlineObject688
	isSet bool
}

func (v NullableInlineObject688) Get() *InlineObject688 {
	return v.value
}

func (v *NullableInlineObject688) Set(val *InlineObject688) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject688) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject688) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject688(val *InlineObject688) *NullableInlineObject688 {
	return &NullableInlineObject688{value: val, isSet: true}
}

func (v NullableInlineObject688) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject688) UnmarshalJSON(src []byte) error {
	v.isSet = true
