...
func (o *InlineObject1170) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1170) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1170) SetNotebookFolderNil() {
...
func (o *InlineObject1170) SetSiteCollectionIdNil() {
...
func (o *InlineObject1170) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1170) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1170 struct {
	value *InlineObject1170
	isSet bool
}

func (v NullableInlineObject1170) Get() *InlineObject1170 {
	return v.value
}

func (v *NullableInlineObject1170) Set(val *InlineObject1170) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1170) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1170) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1170(val *InlineObject1170) *NullableInlineObject1170 {
	return &NullableInlineObject1170{value: val, isSet: true}
}

func (v NullableInlineObject1170) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1170) UnmarshalJSON(src []byte) error {
	v.isSet = true
