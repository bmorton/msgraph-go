...
// InlineObject468 struct for InlineObject468
type InlineObject468 struct {
...
func (o *InlineObject468) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject468) SetSendResponseNil() {
...
func (o InlineObject468) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject468 struct {
	value *InlineObject468
	isSet bool
}

func (v NullableInlineObject468) Get() *InlineObject468 {
	return v.value
}

func (v *NullableInlineObject468) Set(val *InlineObject468) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject468) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject468) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject468(val *InlineObject468) *NullableInlineObject468 {
	return &NullableInlineObject468{value: val, isSet: true}
}

func (v NullableInlineObject468) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject468) UnmarshalJSON(src []byte) error {
	v.isSet = true
