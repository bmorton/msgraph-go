...
func (o InlineObject379) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject379 struct {
	value *InlineObject379
	isSet bool
}

func (v NullableInlineObject379) Get() *InlineObject379 {
	return v.value
}

func (v *NullableInlineObject379) Set(val *InlineObject379) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject379) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject379) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject379(val *InlineObject379) *NullableInlineObject379 {
	return &NullableInlineObject379{value: val, isSet: true}
}

func (v NullableInlineObject379) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject379) UnmarshalJSON(src []byte) error {
	v.isSet = true
