...
func (o *InlineObject764) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject764) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject764) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject764) SetSiteCollectionIdNil() {
...
func (o *InlineObject764) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject764) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject764 struct {
	value *InlineObject764
	isSet bool
}

func (v NullableInlineObject764) Get() *InlineObject764 {
	return v.value
}

func (v *NullableInlineObject764) Set(val *InlineObject764) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject764) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject764) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject764(val *InlineObject764) *NullableInlineObject764 {
	return &NullableInlineObject764{value: val, isSet: true}
}

func (v NullableInlineObject764) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject764) UnmarshalJSON(src []byte) error {
	v.isSet = true
