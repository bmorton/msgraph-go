...
// InlineObject604 struct for InlineObject604
type InlineObject604 struct {
...
func (o *InlineObject604) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject604) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject604) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject604) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject604) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject604) SetSiteCollectionIdNil() {
...
func (o *InlineObject604) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject604) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject604 struct {
	value *InlineObject604
	isSet bool
}

func (v NullableInlineObject604) Get() *InlineObject604 {
	return v.value
}

func (v *NullableInlineObject604) Set(val *InlineObject604) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject604) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject604) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject604(val *InlineObject604) *NullableInlineObject604 {
	return &NullableInlineObject604{value: val, isSet: true}
}

func (v NullableInlineObject604) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject604) UnmarshalJSON(src []byte) error {
	v.isSet = true
