...
// InlineObject326 struct for InlineObject326
type InlineObject326 struct {
...
func (o *InlineObject326) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject326) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject326) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject326) SetSiteCollectionIdNil() {
...
func (o *InlineObject326) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject326) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject326 struct {
	value *InlineObject326
	isSet bool
}

func (v NullableInlineObject326) Get() *InlineObject326 {
	return v.value
}

func (v *NullableInlineObject326) Set(val *InlineObject326) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject326) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject326) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject326(val *InlineObject326) *NullableInlineObject326 {
	return &NullableInlineObject326{value: val, isSet: true}
}

func (v NullableInlineObject326) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject326) UnmarshalJSON(src []byte) error {
	v.isSet = true
