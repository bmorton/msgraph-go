...
// InlineObject662 struct for InlineObject662
type InlineObject662 struct {
...
func (o *InlineObject662) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject662) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject662) SetSiteCollectionIdNil() {
...
func (o *InlineObject662) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject662) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject662 struct {
	value *InlineObject662
	isSet bool
}

func (v NullableInlineObject662) Get() *InlineObject662 {
	return v.value
}

func (v *NullableInlineObject662) Set(val *InlineObject662) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject662) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject662) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject662(val *InlineObject662) *NullableInlineObject662 {
	return &NullableInlineObject662{value: val, isSet: true}
}

func (v NullableInlineObject662) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject662) UnmarshalJSON(src []byte) error {
	v.isSet = true
