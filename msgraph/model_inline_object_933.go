...
func (o *InlineObject933) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject933) SetSendResponseNil() {
...
func (o InlineObject933) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject933 struct {
	value *InlineObject933
	isSet bool
}

func (v NullableInlineObject933) Get() *InlineObject933 {
	return v.value
}

func (v *NullableInlineObject933) Set(val *InlineObject933) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject933) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject933) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject933(val *InlineObject933) *NullableInlineObject933 {
	return &NullableInlineObject933{value: val, isSet: true}
}

func (v NullableInlineObject933) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject933) UnmarshalJSON(src []byte) error {
	v.isSet = true
