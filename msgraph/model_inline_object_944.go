...
// InlineObject944 struct for InlineObject944
type InlineObject944 struct {
...
func (o *InlineObject944) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o InlineObject944) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject944 struct {
	value *InlineObject944
	isSet bool
}

func (v NullableInlineObject944) Get() *InlineObject944 {
	return v.value
}

func (v *NullableInlineObject944) Set(val *InlineObject944) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject944) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject944) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject944(val *InlineObject944) *NullableInlineObject944 {
	return &NullableInlineObject944{value: val, isSet: true}
}

func (v NullableInlineObject944) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject944) UnmarshalJSON(src []byte) error {
	v.isSet = true
