...
func (o *InlineObject1142) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1142) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1142) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1142) SetSiteCollectionIdNil() {
...
func (o *InlineObject1142) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1142) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1142 struct {
	value *InlineObject1142
	isSet bool
}

func (v NullableInlineObject1142) Get() *InlineObject1142 {
	return v.value
}

func (v *NullableInlineObject1142) Set(val *InlineObject1142) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1142) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1142) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1142(val *InlineObject1142) *NullableInlineObject1142 {
	return &NullableInlineObject1142{value: val, isSet: true}
}

func (v NullableInlineObject1142) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1142) UnmarshalJSON(src []byte) error {
	v.isSet = true
