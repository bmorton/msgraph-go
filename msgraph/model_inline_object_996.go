...
type NullableInlineObject996 struct {
	value *InlineObject996
	isSet bool
}

func (v NullableInlineObject996) Get() *InlineObject996 {
	return v.value
}

func (v *NullableInlineObject996) Set(val *InlineObject996) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject996) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject996) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject996(val *InlineObject996) *NullableInlineObject996 {
	return &NullableInlineObject996{value: val, isSet: true}
}

func (v NullableInlineObject996) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject996) UnmarshalJSON(src []byte) error {
	v.isSet = true
