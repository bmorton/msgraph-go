...
// InlineObject1390 struct for InlineObject1390
type InlineObject1390 struct {
...
func (o *InlineObject1390) HasRate() bool {
	if o != nil && o.Rate != nil {
		return true
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject1390) GetNperOk() (*AnyOfobject, bool) {
	if o == nil || o.Nper == nil {
		return nil, false
	}
	return &o.Nper, true
...
func (o *InlineObject1390) SetType(v AnyOfobject) {
	o.Type = v
}

func (o InlineObject1390) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1390 struct {
	value *InlineObject1390
	isSet bool
}

func (v NullableInlineObject1390) Get() *InlineObject1390 {
	return v.value
}

func (v *NullableInlineObject1390) Set(val *InlineObject1390) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1390) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1390) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1390(val *InlineObject1390) *NullableInlineObject1390 {
	return &NullableInlineObject1390{value: val, isSet: true}
}

func (v NullableInlineObject1390) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1390) UnmarshalJSON(src []byte) error {
	v.isSet = true
