...
func (o *InlineObject772) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject772) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject772) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject772) SetSiteCollectionIdNil() {
...
func (o *InlineObject772) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject772) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject772 struct {
	value *InlineObject772
	isSet bool
}

func (v NullableInlineObject772) Get() *InlineObject772 {
	return v.value
}

func (v *NullableInlineObject772) Set(val *InlineObject772) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject772) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject772) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject772(val *InlineObject772) *NullableInlineObject772 {
	return &NullableInlineObject772{value: val, isSet: true}
}

func (v NullableInlineObject772) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject772) UnmarshalJSON(src []byte) error {
	v.isSet = true
