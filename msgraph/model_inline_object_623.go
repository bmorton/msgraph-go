...
func (o *InlineObject623) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject623) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject623) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject623) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject623) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject623) SetSiteCollectionIdNil() {
...
func (o *InlineObject623) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject623) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject623 struct {
	value *InlineObject623
	isSet bool
}

func (v NullableInlineObject623) Get() *InlineObject623 {
	return v.value
}

func (v *NullableInlineObject623) Set(val *InlineObject623) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject623) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject623) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject623(val *InlineObject623) *NullableInlineObject623 {
	return &NullableInlineObject623{value: val, isSet: true}
}

func (v NullableInlineObject623) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject623) UnmarshalJSON(src []byte) error {
	v.isSet = true
