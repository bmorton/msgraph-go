...
func (o *InlineObject756) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject756) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject756) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject756) SetSiteCollectionIdNil() {
...
func (o *InlineObject756) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject756 struct {
	value *InlineObject756
	isSet bool
}

func (v NullableInlineObject756) Get() *InlineObject756 {
	return v.value
}

func (v *NullableInlineObject756) Set(val *InlineObject756) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject756) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject756) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject756(val *InlineObject756) *NullableInlineObject756 {
	return &NullableInlineObject756{value: val, isSet: true}
}

func (v NullableInlineObject756) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject756) UnmarshalJSON(src []byte) error {
	v.isSet = true
