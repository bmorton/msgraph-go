...
func (o *InlineObject831) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject831) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject831) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject831) SetSiteCollectionIdNil() {
...
func (o *InlineObject831) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject831) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject831 struct {
	value *InlineObject831
	isSet bool
}

func (v NullableInlineObject831) Get() *InlineObject831 {
	return v.value
}

func (v *NullableInlineObject831) Set(val *InlineObject831) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject831) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject831) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject831(val *InlineObject831) *NullableInlineObject831 {
	return &NullableInlineObject831{value: val, isSet: true}
}

func (v NullableInlineObject831) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject831) UnmarshalJSON(src []byte) error {
	v.isSet = true
