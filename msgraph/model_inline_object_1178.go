...
func (o *InlineObject1178) HasGroupId() bool {
...
func (o *InlineObject1178) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1178) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject1178) GetNotebookFolderOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject1178) SetNotebookFolderNil() {
...
func (o *InlineObject1178) SetSiteCollectionIdNil() {
...
func (o *InlineObject1178) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1178) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1178 struct {
	value *InlineObject1178
	isSet bool
}

func (v NullableInlineObject1178) Get() *InlineObject1178 {
	return v.value
}

func (v *NullableInlineObject1178) Set(val *InlineObject1178) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1178) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1178) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1178(val *InlineObject1178) *NullableInlineObject1178 {
	return &NullableInlineObject1178{value: val, isSet: true}
}

func (v NullableInlineObject1178) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1178) UnmarshalJSON(src []byte) error {
	v.isSet = true
