...
func (o *InlineObject869) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject869) SetSendResponseNil() {
...
type NullableInlineObject869 struct {
	value *InlineObject869
	isSet bool
}

func (v NullableInlineObject869) Get() *InlineObject869 {
	return v.value
}

func (v *NullableInlineObject869) Set(val *InlineObject869) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject869) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject869) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject869(val *InlineObject869) *NullableInlineObject869 {
	return &NullableInlineObject869{value: val, isSet: true}
}

func (v NullableInlineObject869) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject869) UnmarshalJSON(src []byte) error {
	v.isSet = true
