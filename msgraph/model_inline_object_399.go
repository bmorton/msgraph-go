...
func (o *InlineObject399) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o InlineObject399) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject399 struct {
	value *InlineObject399
	isSet bool
}

func (v NullableInlineObject399) Get() *InlineObject399 {
	return v.value
}

func (v *NullableInlineObject399) Set(val *InlineObject399) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject399) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject399) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject399(val *InlineObject399) *NullableInlineObject399 {
	return &NullableInlineObject399{value: val, isSet: true}
}

func (v NullableInlineObject399) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject399) UnmarshalJSON(src []byte) error {
	v.isSet = true
