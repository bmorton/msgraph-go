...
// InlineObject854 struct for InlineObject854
type InlineObject854 struct {
...
func (o *InlineObject854) SetAvailabilityViewIntervalNil() {
...
func (o InlineObject854) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject854 struct {
	value *InlineObject854
	isSet bool
}

func (v NullableInlineObject854) Get() *InlineObject854 {
	return v.value
}

func (v *NullableInlineObject854) Set(val *InlineObject854) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject854) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject854) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject854(val *InlineObject854) *NullableInlineObject854 {
	return &NullableInlineObject854{value: val, isSet: true}
}

func (v NullableInlineObject854) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject854) UnmarshalJSON(src []byte) error {
	v.isSet = true
