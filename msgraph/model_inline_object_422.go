...
// InlineObject422 struct for InlineObject422
type InlineObject422 struct {
...
func (o *InlineObject422) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o InlineObject422) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject422 struct {
	value *InlineObject422
	isSet bool
}

func (v NullableInlineObject422) Get() *InlineObject422 {
	return v.value
}

func (v *NullableInlineObject422) Set(val *InlineObject422) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject422) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject422) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject422(val *InlineObject422) *NullableInlineObject422 {
	return &NullableInlineObject422{value: val, isSet: true}
}

func (v NullableInlineObject422) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject422) UnmarshalJSON(src []byte) error {
	v.isSet = true
