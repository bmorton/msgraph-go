...
func (o *InlineObject1141) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1141) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1141) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1141) SetSiteCollectionIdNil() {
...
func (o *InlineObject1141) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject1141 struct {
	value *InlineObject1141
	isSet bool
}

func (v NullableInlineObject1141) Get() *InlineObject1141 {
	return v.value
}

func (v *NullableInlineObject1141) Set(val *InlineObject1141) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1141) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1141) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1141(val *InlineObject1141) *NullableInlineObject1141 {
	return &NullableInlineObject1141{value: val, isSet: true}
}

func (v NullableInlineObject1141) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1141) UnmarshalJSON(src []byte) error {
	v.isSet = true
