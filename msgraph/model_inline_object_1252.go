...
// InlineObject1252 struct for InlineObject1252
type InlineObject1252 struct {
...
func (o InlineObject1252) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1252 struct {
	value *InlineObject1252
	isSet bool
}

func (v NullableInlineObject1252) Get() *InlineObject1252 {
	return v.value
}

func (v *NullableInlineObject1252) Set(val *InlineObject1252) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1252) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1252) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1252(val *InlineObject1252) *NullableInlineObject1252 {
	return &NullableInlineObject1252{value: val, isSet: true}
}

func (v NullableInlineObject1252) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1252) UnmarshalJSON(src []byte) error {
	v.isSet = true
