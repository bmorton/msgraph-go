...
func (o *InlineObject1146) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1146) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1146) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1146) SetSiteCollectionIdNil() {
...
func (o *InlineObject1146) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject1146 struct {
	value *InlineObject1146
	isSet bool
}

func (v NullableInlineObject1146) Get() *InlineObject1146 {
	return v.value
}

func (v *NullableInlineObject1146) Set(val *InlineObject1146) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1146) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1146) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1146(val *InlineObject1146) *NullableInlineObject1146 {
	return &NullableInlineObject1146{value: val, isSet: true}
}

func (v NullableInlineObject1146) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1146) UnmarshalJSON(src []byte) error {
	v.isSet = true
