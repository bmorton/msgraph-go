...
func (o InlineObject873) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject873 struct {
	value *InlineObject873
	isSet bool
}

func (v NullableInlineObject873) Get() *InlineObject873 {
	return v.value
}

func (v *NullableInlineObject873) Set(val *InlineObject873) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject873) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject873) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject873(val *InlineObject873) *NullableInlineObject873 {
	return &NullableInlineObject873{value: val, isSet: true}
}

func (v NullableInlineObject873) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject873) UnmarshalJSON(src []byte) error {
	v.isSet = true
