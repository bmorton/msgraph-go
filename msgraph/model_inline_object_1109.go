...
func (o *InlineObject1109) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1109) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1109) SetNotebookFolderNil() {
...
func (o *InlineObject1109) SetSiteCollectionIdNil() {
...
func (o *InlineObject1109) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject1109 struct {
	value *InlineObject1109
	isSet bool
}

func (v NullableInlineObject1109) Get() *InlineObject1109 {
	return v.value
}

func (v *NullableInlineObject1109) Set(val *InlineObject1109) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1109) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1109) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1109(val *InlineObject1109) *NullableInlineObject1109 {
	return &NullableInlineObject1109{value: val, isSet: true}
}

func (v NullableInlineObject1109) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1109) UnmarshalJSON(src []byte) error {
	v.isSet = true
