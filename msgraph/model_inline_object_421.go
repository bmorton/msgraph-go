...
func (o *InlineObject421) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject421) SetSendResponseNil() {
...
type NullableInlineObject421 struct {
	value *InlineObject421
	isSet bool
}

func (v NullableInlineObject421) Get() *InlineObject421 {
	return v.value
}

func (v *NullableInlineObject421) Set(val *InlineObject421) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject421) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject421) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject421(val *InlineObject421) *NullableInlineObject421 {
	return &NullableInlineObject421{value: val, isSet: true}
}

func (v NullableInlineObject421) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject421) UnmarshalJSON(src []byte) error {
	v.isSet = true
