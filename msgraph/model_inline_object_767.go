...
func (o *InlineObject767) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject767) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject767) SetSiteCollectionIdNil() {
...
func (o *InlineObject767) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject767 struct {
	value *InlineObject767
	isSet bool
}

func (v NullableInlineObject767) Get() *InlineObject767 {
	return v.value
}

func (v *NullableInlineObject767) Set(val *InlineObject767) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject767) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject767) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject767(val *InlineObject767) *NullableInlineObject767 {
	return &NullableInlineObject767{value: val, isSet: true}
}

func (v NullableInlineObject767) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject767) UnmarshalJSON(src []byte) error {
	v.isSet = true
