...
func (o *InlineObject1127) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1127) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1127) SetNotebookFolderNil() {
...
func (o *InlineObject1127) SetSiteCollectionIdNil() {
...
func (o *InlineObject1127) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1127) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1127 struct {
	value *InlineObject1127
	isSet bool
}

func (v NullableInlineObject1127) Get() *InlineObject1127 {
	return v.value
}

func (v *NullableInlineObject1127) Set(val *InlineObject1127) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1127) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1127) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1127(val *InlineObject1127) *NullableInlineObject1127 {
	return &NullableInlineObject1127{value: val, isSet: true}
}

func (v NullableInlineObject1127) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1127) UnmarshalJSON(src []byte) error {
	v.isSet = true
