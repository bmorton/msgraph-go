...
func (o *InlineObject416) SetAvailabilityViewIntervalNil() {
...
func (o InlineObject416) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject416 struct {
	value *InlineObject416
	isSet bool
}

func (v NullableInlineObject416) Get() *InlineObject416 {
	return v.value
}

func (v *NullableInlineObject416) Set(val *InlineObject416) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject416) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject416) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject416(val *InlineObject416) *NullableInlineObject416 {
	return &NullableInlineObject416{value: val, isSet: true}
}

func (v NullableInlineObject416) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject416) UnmarshalJSON(src []byte) error {
	v.isSet = true
