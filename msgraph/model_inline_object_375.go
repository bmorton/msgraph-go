...
func (o *InlineObject375) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject375) SetSendResponseNil() {
...
func (o InlineObject375) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject375 struct {
	value *InlineObject375
	isSet bool
}

func (v NullableInlineObject375) Get() *InlineObject375 {
	return v.value
}

func (v *NullableInlineObject375) Set(val *InlineObject375) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject375) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject375) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject375(val *InlineObject375) *NullableInlineObject375 {
	return &NullableInlineObject375{value: val, isSet: true}
}

func (v NullableInlineObject375) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject375) UnmarshalJSON(src []byte) error {
	v.isSet = true
