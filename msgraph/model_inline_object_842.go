...
// InlineObject842 struct for InlineObject842
type InlineObject842 struct {
...
func (o *InlineObject842) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject842) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject842) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject842) SetSiteCollectionIdNil() {
...
func (o *InlineObject842) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject842) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject842 struct {
	value *InlineObject842
	isSet bool
}

func (v NullableInlineObject842) Get() *InlineObject842 {
	return v.value
}

func (v *NullableInlineObject842) Set(val *InlineObject842) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject842) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject842) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject842(val *InlineObject842) *NullableInlineObject842 {
	return &NullableInlineObject842{value: val, isSet: true}
}

func (v NullableInlineObject842) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject842) UnmarshalJSON(src []byte) error {
	v.isSet = true
