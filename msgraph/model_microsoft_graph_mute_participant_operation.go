...
func NewMicrosoftGraphMuteParticipantOperation() *MicrosoftGraphMuteParticipantOperation {
	this := MicrosoftGraphMuteParticipantOperation{}
	return &this
}
...
func (o *MicrosoftGraphMuteParticipantOperation) SetClientContextNil() {
...
func (o MicrosoftGraphMuteParticipantOperation) MarshalJSON() ([]byte, error) {
...
type NullableMicrosoftGraphMuteParticipantOperation struct {
	value *MicrosoftGraphMuteParticipantOperation
	isSet bool
}

func (v NullableMicrosoftGraphMuteParticipantOperation) Get() *MicrosoftGraphMuteParticipantOperation {
	return v.value
}

func (v *NullableMicrosoftGraphMuteParticipantOperation) Set(val *MicrosoftGraphMuteParticipantOperation) {
	v.value = val
	v.isSet = true
}

func (v NullableMicrosoftGraphMuteParticipantOperation) IsSet() bool {
	return v.isSet
}

func (v *NullableMicrosoftGraphMuteParticipantOperation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMicrosoftGraphMuteParticipantOperation(val *MicrosoftGraphMuteParticipantOperation) *NullableMicrosoftGraphMuteParticipantOperation {
	return &NullableMicrosoftGraphMuteParticipantOperation{value: val, isSet: true}
}

func (v NullableMicrosoftGraphMuteParticipantOperation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMicrosoftGraphMuteParticipantOperation) UnmarshalJSON(src []byte) error {
	v.isSet = true
