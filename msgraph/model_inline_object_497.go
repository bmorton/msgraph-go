...
// InlineObject497 struct for InlineObject497
type InlineObject497 struct {
...
func (o *InlineObject497) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject497) SetSendResponseNil() {
...
func (o InlineObject497) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject497 struct {
	value *InlineObject497
	isSet bool
}

func (v NullableInlineObject497) Get() *InlineObject497 {
	return v.value
}

func (v *NullableInlineObject497) Set(val *InlineObject497) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject497) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject497) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject497(val *InlineObject497) *NullableInlineObject497 {
	return &NullableInlineObject497{value: val, isSet: true}
}

func (v NullableInlineObject497) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject497) UnmarshalJSON(src []byte) error {
	v.isSet = true
