...
// InlineObject1649 struct for InlineObject1649
type InlineObject1649 struct {
...
func (o *InlineObject1649) SetAddressNil() {
	o.Address.Set(nil)
}
...
func (o InlineObject1649) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1649 struct {
	value *InlineObject1649
	isSet bool
}

func (v NullableInlineObject1649) Get() *InlineObject1649 {
	return v.value
}

func (v *NullableInlineObject1649) Set(val *InlineObject1649) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1649) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1649) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1649(val *InlineObject1649) *NullableInlineObject1649 {
	return &NullableInlineObject1649{value: val, isSet: true}
}

func (v NullableInlineObject1649) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1649) UnmarshalJSON(src []byte) error {
	v.isSet = true
