...
func (o *InlineObject935) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject935) SetSendResponseNil() {
...
func (o InlineObject935) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject935 struct {
	value *InlineObject935
	isSet bool
}

func (v NullableInlineObject935) Get() *InlineObject935 {
	return v.value
}

func (v *NullableInlineObject935) Set(val *InlineObject935) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject935) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject935) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject935(val *InlineObject935) *NullableInlineObject935 {
	return &NullableInlineObject935{value: val, isSet: true}
}

func (v NullableInlineObject935) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject935) UnmarshalJSON(src []byte) error {
	v.isSet = true
