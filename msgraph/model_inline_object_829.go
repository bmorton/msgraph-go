...
func (o *InlineObject829) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject829) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject829) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject829) SetSiteCollectionIdNil() {
...
func (o *InlineObject829) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject829 struct {
	value *InlineObject829
	isSet bool
}

func (v NullableInlineObject829) Get() *InlineObject829 {
	return v.value
}

func (v *NullableInlineObject829) Set(val *InlineObject829) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject829) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject829) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject829(val *InlineObject829) *NullableInlineObject829 {
	return &NullableInlineObject829{value: val, isSet: true}
}

func (v NullableInlineObject829) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject829) UnmarshalJSON(src []byte) error {
	v.isSet = true
