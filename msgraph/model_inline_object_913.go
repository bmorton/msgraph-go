...
func (o *InlineObject913) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject913) SetSendResponseNil() {
...
type NullableInlineObject913 struct {
	value *InlineObject913
	isSet bool
}

func (v NullableInlineObject913) Get() *InlineObject913 {
	return v.value
}

func (v *NullableInlineObject913) Set(val *InlineObject913) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject913) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject913) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject913(val *InlineObject913) *NullableInlineObject913 {
	return &NullableInlineObject913{value: val, isSet: true}
}

func (v NullableInlineObject913) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject913) UnmarshalJSON(src []byte) error {
	v.isSet = true
