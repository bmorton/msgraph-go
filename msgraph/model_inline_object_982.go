...
func (o *InlineObject982) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject982) SetSendResponseNil() {
...
type NullableInlineObject982 struct {
	value *InlineObject982
	isSet bool
}

func (v NullableInlineObject982) Get() *InlineObject982 {
	return v.value
}

func (v *NullableInlineObject982) Set(val *InlineObject982) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject982) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject982) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject982(val *InlineObject982) *NullableInlineObject982 {
	return &NullableInlineObject982{value: val, isSet: true}
}

func (v NullableInlineObject982) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject982) UnmarshalJSON(src []byte) error {
	v.isSet = true
