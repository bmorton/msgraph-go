...
// InlineObject877 struct for InlineObject877
type InlineObject877 struct {
...
func (o *InlineObject877) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject877) SetSendResponseNil() {
...
func (o InlineObject877) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject877 struct {
	value *InlineObject877
	isSet bool
}

func (v NullableInlineObject877) Get() *InlineObject877 {
	return v.value
}

func (v *NullableInlineObject877) Set(val *InlineObject877) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject877) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject877) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject877(val *InlineObject877) *NullableInlineObject877 {
	return &NullableInlineObject877{value: val, isSet: true}
}

func (v NullableInlineObject877) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject877) UnmarshalJSON(src []byte) error {
	v.isSet = true
