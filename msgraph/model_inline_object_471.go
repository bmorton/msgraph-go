...
// InlineObject471 struct for InlineObject471
type InlineObject471 struct {
...
func (o *InlineObject471) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject471) SetSendResponseNil() {
...
func (o InlineObject471) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject471 struct {
	value *InlineObject471
	isSet bool
}

func (v NullableInlineObject471) Get() *InlineObject471 {
	return v.value
}

func (v *NullableInlineObject471) Set(val *InlineObject471) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject471) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject471) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject471(val *InlineObject471) *NullableInlineObject471 {
	return &NullableInlineObject471{value: val, isSet: true}
}

func (v NullableInlineObject471) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject471) UnmarshalJSON(src []byte) error {
	v.isSet = true
