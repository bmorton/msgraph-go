...
func (o *ManagedAppPolicy) SetDescriptionNil() {
...
func (o *ManagedAppPolicy) SetVersionNil() {
	o.Version.Set(nil)
}
...
type NullableManagedAppPolicy struct {
	value *ManagedAppPolicy
	isSet bool
}

func (v NullableManagedAppPolicy) Get() *ManagedAppPolicy {
	return v.value
}

func (v *NullableManagedAppPolicy) Set(val *ManagedAppPolicy) {
	v.value = val
	v.isSet = true
}

func (v NullableManagedAppPolicy) IsSet() bool {
	return v.isSet
}

func (v *NullableManagedAppPolicy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagedAppPolicy(val *ManagedAppPolicy) *NullableManagedAppPolicy {
	return &NullableManagedAppPolicy{value: val, isSet: true}
}

func (v NullableManagedAppPolicy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagedAppPolicy) UnmarshalJSON(src []byte) error {
	v.isSet = true
