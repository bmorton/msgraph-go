...
func (o *InlineObject1188) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject1188) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1188) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject1188) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject1188) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1188) SetSiteCollectionIdNil() {
...
func (o *InlineObject1188) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1188) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1188 struct {
	value *InlineObject1188
	isSet bool
}

func (v NullableInlineObject1188) Get() *InlineObject1188 {
	return v.value
}

func (v *NullableInlineObject1188) Set(val *InlineObject1188) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1188) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1188) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1188(val *InlineObject1188) *NullableInlineObject1188 {
	return &NullableInlineObject1188{value: val, isSet: true}
}

func (v NullableInlineObject1188) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1188) UnmarshalJSON(src []byte) error {
	v.isSet = true
