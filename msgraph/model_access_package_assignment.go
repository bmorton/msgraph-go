...
// AccessPackageAssignment struct for AccessPackageAssignment
...
func (o *AccessPackageAssignment) SetExpiredDateTimeNil() {
...
func (o *AccessPackageAssignment) SetStatusNil() {
	o.Status.Set(nil)
}
...
func (o AccessPackageAssignment) MarshalJSON() ([]byte, error) {
...
type NullableAccessPackageAssignment struct {
	value *AccessPackageAssignment
	isSet bool
}

func (v NullableAccessPackageAssignment) Get() *AccessPackageAssignment {
	return v.value
}

func (v *NullableAccessPackageAssignment) Set(val *AccessPackageAssignment) {
	v.value = val
	v.isSet = true
}

func (v NullableAccessPackageAssignment) IsSet() bool {
	return v.isSet
}

func (v *NullableAccessPackageAssignment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccessPackageAssignment(val *AccessPackageAssignment) *NullableAccessPackageAssignment {
	return &NullableAccessPackageAssignment{value: val, isSet: true}
}

func (v NullableAccessPackageAssignment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccessPackageAssignment) UnmarshalJSON(src []byte) error {
	v.isSet = true
