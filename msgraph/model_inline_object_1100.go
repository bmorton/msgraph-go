...
func (o *InlineObject1100) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1100) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1100) SetNotebookFolderNil() {
...
func (o *InlineObject1100) SetSiteCollectionIdNil() {
...
func (o *InlineObject1100) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject1100 struct {
	value *InlineObject1100
	isSet bool
}

func (v NullableInlineObject1100) Get() *InlineObject1100 {
	return v.value
}

func (v *NullableInlineObject1100) Set(val *InlineObject1100) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1100) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1100) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1100(val *InlineObject1100) *NullableInlineObject1100 {
	return &NullableInlineObject1100{value: val, isSet: true}
}

func (v NullableInlineObject1100) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1100) UnmarshalJSON(src []byte) error {
	v.isSet = true
