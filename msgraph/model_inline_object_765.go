...
func (o *InlineObject765) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject765) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject765) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject765) SetSiteCollectionIdNil() {
...
func (o *InlineObject765) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject765) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject765 struct {
	value *InlineObject765
	isSet bool
}

func (v NullableInlineObject765) Get() *InlineObject765 {
	return v.value
}

func (v *NullableInlineObject765) Set(val *InlineObject765) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject765) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject765) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject765(val *InlineObject765) *NullableInlineObject765 {
	return &NullableInlineObject765{value: val, isSet: true}
}

func (v NullableInlineObject765) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject765) UnmarshalJSON(src []byte) error {
	v.isSet = true
