...
// InlineObject752 struct for InlineObject752
type InlineObject752 struct {
...
func (o *InlineObject752) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject752) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject752) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject752) SetSiteCollectionIdNil() {
...
func (o *InlineObject752) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject752) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject752 struct {
	value *InlineObject752
	isSet bool
}

func (v NullableInlineObject752) Get() *InlineObject752 {
	return v.value
}

func (v *NullableInlineObject752) Set(val *InlineObject752) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject752) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject752) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject752(val *InlineObject752) *NullableInlineObject752 {
	return &NullableInlineObject752{value: val, isSet: true}
}

func (v NullableInlineObject752) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject752) UnmarshalJSON(src []byte) error {
	v.isSet = true
