...
func (o *InlineObject333) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject333) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject333) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject333) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject333) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject333) SetSiteCollectionIdNil() {
...
func (o *InlineObject333) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject333) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject333 struct {
	value *InlineObject333
	isSet bool
}

func (v NullableInlineObject333) Get() *InlineObject333 {
	return v.value
}

func (v *NullableInlineObject333) Set(val *InlineObject333) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject333) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject333) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject333(val *InlineObject333) *NullableInlineObject333 {
	return &NullableInlineObject333{value: val, isSet: true}
}

func (v NullableInlineObject333) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject333) UnmarshalJSON(src []byte) error {
	v.isSet = true
