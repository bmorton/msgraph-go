...
// InlineObject564 struct for InlineObject564
type InlineObject564 struct {
...
func (o *InlineObject564) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o InlineObject564) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject564 struct {
	value *InlineObject564
	isSet bool
}

func (v NullableInlineObject564) Get() *InlineObject564 {
	return v.value
}

func (v *NullableInlineObject564) Set(val *InlineObject564) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject564) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject564) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject564(val *InlineObject564) *NullableInlineObject564 {
	return &NullableInlineObject564{value: val, isSet: true}
}

func (v NullableInlineObject564) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject564) UnmarshalJSON(src []byte) error {
	v.isSet = true
