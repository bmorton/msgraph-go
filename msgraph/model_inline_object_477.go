...
// InlineObject477 struct for InlineObject477
type InlineObject477 struct {
...
func (o InlineObject477) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject477 struct {
	value *InlineObject477
	isSet bool
}

func (v NullableInlineObject477) Get() *InlineObject477 {
	return v.value
}

func (v *NullableInlineObject477) Set(val *InlineObject477) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject477) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject477) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject477(val *InlineObject477) *NullableInlineObject477 {
	return &NullableInlineObject477{value: val, isSet: true}
}

func (v NullableInlineObject477) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject477) UnmarshalJSON(src []byte) error {
	v.isSet = true
