...
func (o *InlineObject807) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject807) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject807) SetNotebookFolderNil() {
...
func (o *InlineObject807) SetSiteCollectionIdNil() {
...
func (o *InlineObject807) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject807) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject807 struct {
	value *InlineObject807
	isSet bool
}

func (v NullableInlineObject807) Get() *InlineObject807 {
	return v.value
}

func (v *NullableInlineObject807) Set(val *InlineObject807) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject807) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject807) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject807(val *InlineObject807) *NullableInlineObject807 {
	return &NullableInlineObject807{value: val, isSet: true}
}

func (v NullableInlineObject807) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject807) UnmarshalJSON(src []byte) error {
	v.isSet = true
