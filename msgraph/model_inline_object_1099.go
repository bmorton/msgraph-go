...
func (o *InlineObject1099) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject1099) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1099) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject1099) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject1099) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1099) SetSiteCollectionIdNil() {
...
func (o *InlineObject1099) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject1099 struct {
	value *InlineObject1099
	isSet bool
}

func (v NullableInlineObject1099) Get() *InlineObject1099 {
	return v.value
}

func (v *NullableInlineObject1099) Set(val *InlineObject1099) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1099) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1099) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1099(val *InlineObject1099) *NullableInlineObject1099 {
	return &NullableInlineObject1099{value: val, isSet: true}
}

func (v NullableInlineObject1099) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1099) UnmarshalJSON(src []byte) error {
	v.isSet = true
