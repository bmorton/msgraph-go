...
func (o *InlineObject482) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o InlineObject482) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject482 struct {
	value *InlineObject482
	isSet bool
}

func (v NullableInlineObject482) Get() *InlineObject482 {
	return v.value
}

func (v *NullableInlineObject482) Set(val *InlineObject482) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject482) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject482) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject482(val *InlineObject482) *NullableInlineObject482 {
	return &NullableInlineObject482{value: val, isSet: true}
}

func (v NullableInlineObject482) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject482) UnmarshalJSON(src []byte) error {
	v.isSet = true
