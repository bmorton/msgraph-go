...
// InlineObject615 struct for InlineObject615
type InlineObject615 struct {
...
func (o *InlineObject615) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject615) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject615) SetNotebookFolderNil() {
...
func (o *InlineObject615) SetSiteCollectionIdNil() {
...
func (o *InlineObject615) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject615) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject615 struct {
	value *InlineObject615
	isSet bool
}

func (v NullableInlineObject615) Get() *InlineObject615 {
	return v.value
}

func (v *NullableInlineObject615) Set(val *InlineObject615) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject615) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject615) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject615(val *InlineObject615) *NullableInlineObject615 {
	return &NullableInlineObject615{value: val, isSet: true}
}

func (v NullableInlineObject615) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject615) UnmarshalJSON(src []byte) error {
	v.isSet = true
