...
// EducationRubric struct for EducationRubric
...
func (o *EducationRubric) SetCreatedDateTimeNil() {
...
func (o *EducationRubric) SetDisplayNameNil() {
...
func (o *EducationRubric) SetLastModifiedDateTimeNil() {
...
func (o EducationRubric) MarshalJSON() ([]byte, error) {
...
type NullableEducationRubric struct {
	value *EducationRubric
	isSet bool
}

func (v NullableEducationRubric) Get() *EducationRubric {
	return v.value
}

func (v *NullableEducationRubric) Set(val *EducationRubric) {
	v.value = val
	v.isSet = true
}

func (v NullableEducationRubric) IsSet() bool {
	return v.isSet
}

func (v *NullableEducationRubric) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEducationRubric(val *EducationRubric) *NullableEducationRubric {
	return &NullableEducationRubric{value: val, isSet: true}
}

func (v NullableEducationRubric) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEducationRubric) UnmarshalJSON(src []byte) error {
	v.isSet = true
