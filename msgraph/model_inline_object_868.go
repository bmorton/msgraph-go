...
func (o *InlineObject868) SetAvailabilityViewIntervalNil() {
...
type NullableInlineObject868 struct {
	value *InlineObject868
	isSet bool
}

func (v NullableInlineObject868) Get() *InlineObject868 {
	return v.value
}

func (v *NullableInlineObject868) Set(val *InlineObject868) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject868) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject868) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject868(val *InlineObject868) *NullableInlineObject868 {
	return &NullableInlineObject868{value: val, isSet: true}
}

func (v NullableInlineObject868) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject868) UnmarshalJSON(src []byte) error {
	v.isSet = true
