...
func (o *InlineObject886) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject886) SetSendResponseNil() {
...
type NullableInlineObject886 struct {
	value *InlineObject886
	isSet bool
}

func (v NullableInlineObject886) Get() *InlineObject886 {
	return v.value
}

func (v *NullableInlineObject886) Set(val *InlineObject886) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject886) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject886) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject886(val *InlineObject886) *NullableInlineObject886 {
	return &NullableInlineObject886{value: val, isSet: true}
}

func (v NullableInlineObject886) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject886) UnmarshalJSON(src []byte) error {
	v.isSet = true
