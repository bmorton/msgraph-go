...
func (o *InlineObject672) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject672) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject672) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject672) SetSiteCollectionIdNil() {
...
func (o *InlineObject672) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject672) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject672 struct {
	value *InlineObject672
	isSet bool
}

func (v NullableInlineObject672) Get() *InlineObject672 {
	return v.value
}

func (v *NullableInlineObject672) Set(val *InlineObject672) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject672) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject672) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject672(val *InlineObject672) *NullableInlineObject672 {
	return &NullableInlineObject672{value: val, isSet: true}
}

func (v NullableInlineObject672) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject672) UnmarshalJSON(src []byte) error {
	v.isSet = true
