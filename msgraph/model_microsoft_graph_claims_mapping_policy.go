...
func NewMicrosoftGraphClaimsMappingPolicy() *MicrosoftGraphClaimsMappingPolicy {
	this := MicrosoftGraphClaimsMappingPolicy{}
	return &this
}
...
func (o *MicrosoftGraphClaimsMappingPolicy) SetDeletedDateTimeNil() {
...
func (o *MicrosoftGraphClaimsMappingPolicy) SetDescriptionNil() {
...
func (o *MicrosoftGraphClaimsMappingPolicy) SetDisplayNameNil() {
...
func (o *MicrosoftGraphClaimsMappingPolicy) SetIsOrganizationDefaultNil() {
...
func (o MicrosoftGraphClaimsMappingPolicy) MarshalJSON() ([]byte, error) {
...
type NullableMicrosoftGraphClaimsMappingPolicy struct {
	value *MicrosoftGraphClaimsMappingPolicy
	isSet bool
}

func (v NullableMicrosoftGraphClaimsMappingPolicy) Get() *MicrosoftGraphClaimsMappingPolicy {
	return v.value
}

func (v *NullableMicrosoftGraphClaimsMappingPolicy) Set(val *MicrosoftGraphClaimsMappingPolicy) {
	v.value = val
	v.isSet = true
}

func (v NullableMicrosoftGraphClaimsMappingPolicy) IsSet() bool {
	return v.isSet
}

func (v *NullableMicrosoftGraphClaimsMappingPolicy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMicrosoftGraphClaimsMappingPolicy(val *MicrosoftGraphClaimsMappingPolicy) *NullableMicrosoftGraphClaimsMappingPolicy {
	return &NullableMicrosoftGraphClaimsMappingPolicy{value: val, isSet: true}
}

func (v NullableMicrosoftGraphClaimsMappingPolicy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMicrosoftGraphClaimsMappingPolicy) UnmarshalJSON(src []byte) error {
	v.isSet = true
