...
func (o *InlineObject957) SetCommentNil() {
	o.Comment.Set(nil)
}
...
type NullableInlineObject957 struct {
	value *InlineObject957
	isSet bool
}

func (v NullableInlineObject957) Get() *InlineObject957 {
	return v.value
}

func (v *NullableInlineObject957) Set(val *InlineObject957) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject957) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject957) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject957(val *InlineObject957) *NullableInlineObject957 {
	return &NullableInlineObject957{value: val, isSet: true}
}

func (v NullableInlineObject957) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject957) UnmarshalJSON(src []byte) error {
	v.isSet = true
