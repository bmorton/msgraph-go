...
func (o *InlineObject989) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o InlineObject989) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject989 struct {
	value *InlineObject989
	isSet bool
}

func (v NullableInlineObject989) Get() *InlineObject989 {
	return v.value
}

func (v *NullableInlineObject989) Set(val *InlineObject989) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject989) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject989) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject989(val *InlineObject989) *NullableInlineObject989 {
	return &NullableInlineObject989{value: val, isSet: true}
}

func (v NullableInlineObject989) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject989) UnmarshalJSON(src []byte) error {
	v.isSet = true
