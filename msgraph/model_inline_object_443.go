...
// InlineObject443 struct for InlineObject443
type InlineObject443 struct {
...
func (o InlineObject443) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject443 struct {
	value *InlineObject443
	isSet bool
}

func (v NullableInlineObject443) Get() *InlineObject443 {
	return v.value
}

func (v *NullableInlineObject443) Set(val *InlineObject443) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject443) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject443) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject443(val *InlineObject443) *NullableInlineObject443 {
	return &NullableInlineObject443{value: val, isSet: true}
}

func (v NullableInlineObject443) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject443) UnmarshalJSON(src []byte) error {
	v.isSet = true
