...
func (o *InlineObject835) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject835) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject835) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject835) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject835) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject835) SetSiteCollectionIdNil() {
...
func (o *InlineObject835) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject835) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject835 struct {
	value *InlineObject835
	isSet bool
}

func (v NullableInlineObject835) Get() *InlineObject835 {
	return v.value
}

func (v *NullableInlineObject835) Set(val *InlineObject835) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject835) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject835) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject835(val *InlineObject835) *NullableInlineObject835 {
	return &NullableInlineObject835{value: val, isSet: true}
}

func (v NullableInlineObject835) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject835) UnmarshalJSON(src []byte) error {
	v.isSet = true
