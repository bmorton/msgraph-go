...
func (o *InlineObject424) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject424) SetSendResponseNil() {
...
func (o InlineObject424) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject424 struct {
	value *InlineObject424
	isSet bool
}

func (v NullableInlineObject424) Get() *InlineObject424 {
	return v.value
}

func (v *NullableInlineObject424) Set(val *InlineObject424) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject424) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject424) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject424(val *InlineObject424) *NullableInlineObject424 {
	return &NullableInlineObject424{value: val, isSet: true}
}

func (v NullableInlineObject424) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject424) UnmarshalJSON(src []byte) error {
	v.isSet = true
