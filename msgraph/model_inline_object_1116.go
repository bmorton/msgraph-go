...
func (o *InlineObject1116) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1116) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1116) SetNotebookFolderNil() {
...
func (o *InlineObject1116) SetSiteCollectionIdNil() {
...
func (o *InlineObject1116) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1116) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1116 struct {
	value *InlineObject1116
	isSet bool
}

func (v NullableInlineObject1116) Get() *InlineObject1116 {
	return v.value
}

func (v *NullableInlineObject1116) Set(val *InlineObject1116) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1116) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1116) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1116(val *InlineObject1116) *NullableInlineObject1116 {
	return &NullableInlineObject1116{value: val, isSet: true}
}

func (v NullableInlineObject1116) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1116) UnmarshalJSON(src []byte) error {
	v.isSet = true
