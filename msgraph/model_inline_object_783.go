...
func (o *InlineObject783) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject783) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject783) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject783) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject783) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject783) SetSiteCollectionIdNil() {
...
func (o *InlineObject783) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject783 struct {
	value *InlineObject783
	isSet bool
}

func (v NullableInlineObject783) Get() *InlineObject783 {
	return v.value
}

func (v *NullableInlineObject783) Set(val *InlineObject783) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject783) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject783) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject783(val *InlineObject783) *NullableInlineObject783 {
	return &NullableInlineObject783{value: val, isSet: true}
}

func (v NullableInlineObject783) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject783) UnmarshalJSON(src []byte) error {
	v.isSet = true
