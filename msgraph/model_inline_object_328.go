...
func (o *InlineObject328) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject328) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject328) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject328) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject328) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject328) SetSiteCollectionIdNil() {
...
func (o *InlineObject328) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject328) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject328 struct {
	value *InlineObject328
	isSet bool
}

func (v NullableInlineObject328) Get() *InlineObject328 {
	return v.value
}

func (v *NullableInlineObject328) Set(val *InlineObject328) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject328) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject328) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject328(val *InlineObject328) *NullableInlineObject328 {
	return &NullableInlineObject328{value: val, isSet: true}
}

func (v NullableInlineObject328) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject328) UnmarshalJSON(src []byte) error {
	v.isSet = true
