...
func (o *InlineObject866) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject866) SetSendResponseNil() {
...
type NullableInlineObject866 struct {
	value *InlineObject866
	isSet bool
}

func (v NullableInlineObject866) Get() *InlineObject866 {
	return v.value
}

func (v *NullableInlineObject866) Set(val *InlineObject866) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject866) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject866) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject866(val *InlineObject866) *NullableInlineObject866 {
	return &NullableInlineObject866{value: val, isSet: true}
}

func (v NullableInlineObject866) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject866) UnmarshalJSON(src []byte) error {
	v.isSet = true
