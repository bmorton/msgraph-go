...
func (o *InlineObject622) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject622) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject622) SetNotebookFolderNil() {
...
func (o *InlineObject622) SetSiteCollectionIdNil() {
...
func (o *InlineObject622) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject622 struct {
	value *InlineObject622
	isSet bool
}

func (v NullableInlineObject622) Get() *InlineObject622 {
	return v.value
}

func (v *NullableInlineObject622) Set(val *InlineObject622) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject622) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject622) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject622(val *InlineObject622) *NullableInlineObject622 {
	return &NullableInlineObject622{value: val, isSet: true}
}

func (v NullableInlineObject622) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject622) UnmarshalJSON(src []byte) error {
	v.isSet = true
