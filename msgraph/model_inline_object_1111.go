...
// InlineObject1111 struct for InlineObject1111
type InlineObject1111 struct {
...
func (o *InlineObject1111) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1111) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1111) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1111) SetSiteCollectionIdNil() {
...
func (o *InlineObject1111) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1111) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1111 struct {
	value *InlineObject1111
	isSet bool
}

func (v NullableInlineObject1111) Get() *InlineObject1111 {
	return v.value
}

func (v *NullableInlineObject1111) Set(val *InlineObject1111) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1111) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1111) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1111(val *InlineObject1111) *NullableInlineObject1111 {
	return &NullableInlineObject1111{value: val, isSet: true}
}

func (v NullableInlineObject1111) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1111) UnmarshalJSON(src []byte) error {
	v.isSet = true
