...
func (o *InlineObject1092) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1092) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1092) SetNotebookFolderNil() {
...
func (o *InlineObject1092) SetSiteCollectionIdNil() {
...
func (o *InlineObject1092) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject1092 struct {
	value *InlineObject1092
	isSet bool
}

func (v NullableInlineObject1092) Get() *InlineObject1092 {
	return v.value
}

func (v *NullableInlineObject1092) Set(val *InlineObject1092) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1092) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1092) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1092(val *InlineObject1092) *NullableInlineObject1092 {
	return &NullableInlineObject1092{value: val, isSet: true}
}

func (v NullableInlineObject1092) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1092) UnmarshalJSON(src []byte) error {
	v.isSet = true
