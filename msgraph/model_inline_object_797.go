...
func (o *InlineObject797) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject797) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject797) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject797) SetSiteCollectionIdNil() {
...
func (o *InlineObject797) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject797 struct {
	value *InlineObject797
	isSet bool
}

func (v NullableInlineObject797) Get() *InlineObject797 {
	return v.value
}

func (v *NullableInlineObject797) Set(val *InlineObject797) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject797) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject797) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject797(val *InlineObject797) *NullableInlineObject797 {
	return &NullableInlineObject797{value: val, isSet: true}
}

func (v NullableInlineObject797) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject797) UnmarshalJSON(src []byte) error {
	v.isSet = true
