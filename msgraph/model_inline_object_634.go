...
func (o *InlineObject634) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject634) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject634) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject634) SetSiteCollectionIdNil() {
...
func (o *InlineObject634) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject634 struct {
	value *InlineObject634
	isSet bool
}

func (v NullableInlineObject634) Get() *InlineObject634 {
	return v.value
}

func (v *NullableInlineObject634) Set(val *InlineObject634) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject634) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject634) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject634(val *InlineObject634) *NullableInlineObject634 {
	return &NullableInlineObject634{value: val, isSet: true}
}

func (v NullableInlineObject634) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject634) UnmarshalJSON(src []byte) error {
	v.isSet = true
