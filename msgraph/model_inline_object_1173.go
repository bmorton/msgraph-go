...
func (o *InlineObject1173) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1173) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1173) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1173) SetSiteCollectionIdNil() {
...
func (o *InlineObject1173) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject1173 struct {
	value *InlineObject1173
	isSet bool
}

func (v NullableInlineObject1173) Get() *InlineObject1173 {
	return v.value
}

func (v *NullableInlineObject1173) Set(val *InlineObject1173) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1173) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1173) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1173(val *InlineObject1173) *NullableInlineObject1173 {
	return &NullableInlineObject1173{value: val, isSet: true}
}

func (v NullableInlineObject1173) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1173) UnmarshalJSON(src []byte) error {
	v.isSet = true
