...
func (o *InlineObject1185) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1185) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1185) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1185) SetSiteCollectionIdNil() {
...
func (o *InlineObject1185) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject1185 struct {
	value *InlineObject1185
	isSet bool
}

func (v NullableInlineObject1185) Get() *InlineObject1185 {
	return v.value
}

func (v *NullableInlineObject1185) Set(val *InlineObject1185) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1185) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1185) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1185(val *InlineObject1185) *NullableInlineObject1185 {
	return &NullableInlineObject1185{value: val, isSet: true}
}

func (v NullableInlineObject1185) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1185) UnmarshalJSON(src []byte) error {
	v.isSet = true
