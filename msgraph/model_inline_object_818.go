...
// InlineObject818 struct for InlineObject818
type InlineObject818 struct {
...
func (o *InlineObject818) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject818) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject818) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject818) SetSiteCollectionIdNil() {
...
func (o *InlineObject818) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject818) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject818 struct {
	value *InlineObject818
	isSet bool
}

func (v NullableInlineObject818) Get() *InlineObject818 {
	return v.value
}

func (v *NullableInlineObject818) Set(val *InlineObject818) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject818) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject818) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject818(val *InlineObject818) *NullableInlineObject818 {
	return &NullableInlineObject818{value: val, isSet: true}
}

func (v NullableInlineObject818) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject818) UnmarshalJSON(src []byte) error {
	v.isSet = true
