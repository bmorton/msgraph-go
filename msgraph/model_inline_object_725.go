...
// InlineObject725 struct for InlineObject725
type InlineObject725 struct {
...
func (o *InlineObject725) SetEntityTypeNil() {
...
func (o *InlineObject725) SetDisplayNameNil() {
...
func (o *InlineObject725) SetMailNicknameNil() {
...
func (o *InlineObject725) SetOnBehalfOfUserIdNil() {
...
func (o InlineObject725) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject725 struct {
	value *InlineObject725
	isSet bool
}

func (v NullableInlineObject725) Get() *InlineObject725 {
	return v.value
}

func (v *NullableInlineObject725) Set(val *InlineObject725) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject725) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject725) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject725(val *InlineObject725) *NullableInlineObject725 {
	return &NullableInlineObject725{value: val, isSet: true}
}

func (v NullableInlineObject725) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject725) UnmarshalJSON(src []byte) error {
	v.isSet = true
