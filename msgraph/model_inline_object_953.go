...
func (o *InlineObject953) SetAvailabilityViewIntervalNil() {
...
type NullableInlineObject953 struct {
	value *InlineObject953
	isSet bool
}

func (v NullableInlineObject953) Get() *InlineObject953 {
	return v.value
}

func (v *NullableInlineObject953) Set(val *InlineObject953) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject953) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject953) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject953(val *InlineObject953) *NullableInlineObject953 {
	return &NullableInlineObject953{value: val, isSet: true}
}

func (v NullableInlineObject953) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject953) UnmarshalJSON(src []byte) error {
	v.isSet = true
