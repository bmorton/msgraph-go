...
// InlineObject1158 struct for InlineObject1158
type InlineObject1158 struct {
...
func (o *InlineObject1158) HasGroupId() bool {
...
func (o *InlineObject1158) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1158) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject1158) GetNotebookFolderOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject1158) SetNotebookFolderNil() {
...
func (o *InlineObject1158) SetSiteCollectionIdNil() {
...
func (o *InlineObject1158) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1158) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1158 struct {
	value *InlineObject1158
	isSet bool
}

func (v NullableInlineObject1158) Get() *InlineObject1158 {
	return v.value
}

func (v *NullableInlineObject1158) Set(val *InlineObject1158) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1158) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1158) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1158(val *InlineObject1158) *NullableInlineObject1158 {
	return &NullableInlineObject1158{value: val, isSet: true}
}

func (v NullableInlineObject1158) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1158) UnmarshalJSON(src []byte) error {
	v.isSet = true
