...
type NullableInlineObject1033 struct {
	value *InlineObject1033
	isSet bool
}

func (v NullableInlineObject1033) Get() *InlineObject1033 {
	return v.value
}

func (v *NullableInlineObject1033) Set(val *InlineObject1033) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1033) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1033) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1033(val *InlineObject1033) *NullableInlineObject1033 {
	return &NullableInlineObject1033{value: val, isSet: true}
}

func (v NullableInlineObject1033) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1033) UnmarshalJSON(src []byte) error {
	v.isSet = true
