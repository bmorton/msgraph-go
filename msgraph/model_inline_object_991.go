...
func (o *InlineObject991) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject991) SetSendResponseNil() {
...
func (o InlineObject991) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject991 struct {
	value *InlineObject991
	isSet bool
}

func (v NullableInlineObject991) Get() *InlineObject991 {
	return v.value
}

func (v *NullableInlineObject991) Set(val *InlineObject991) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject991) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject991) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject991(val *InlineObject991) *NullableInlineObject991 {
	return &NullableInlineObject991{value: val, isSet: true}
}

func (v NullableInlineObject991) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject991) UnmarshalJSON(src []byte) error {
	v.isSet = true
