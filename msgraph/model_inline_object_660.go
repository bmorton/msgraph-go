...
func (o *InlineObject660) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject660) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject660) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject660) SetSiteCollectionIdNil() {
...
func (o *InlineObject660) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject660) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject660 struct {
	value *InlineObject660
	isSet bool
}

func (v NullableInlineObject660) Get() *InlineObject660 {
	return v.value
}

func (v *NullableInlineObject660) Set(val *InlineObject660) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject660) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject660) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject660(val *InlineObject660) *NullableInlineObject660 {
	return &NullableInlineObject660{value: val, isSet: true}
}

func (v NullableInlineObject660) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject660) UnmarshalJSON(src []byte) error {
	v.isSet = true
