...
func (o *InlineObject1166) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1166) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1166) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1166) SetSiteCollectionIdNil() {
...
func (o *InlineObject1166) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1166) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1166 struct {
	value *InlineObject1166
	isSet bool
}

func (v NullableInlineObject1166) Get() *InlineObject1166 {
	return v.value
}

func (v *NullableInlineObject1166) Set(val *InlineObject1166) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1166) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1166) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1166(val *InlineObject1166) *NullableInlineObject1166 {
	return &NullableInlineObject1166{value: val, isSet: true}
}

func (v NullableInlineObject1166) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1166) UnmarshalJSON(src []byte) error {
	v.isSet = true
