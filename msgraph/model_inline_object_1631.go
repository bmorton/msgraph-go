...
// InlineObject1631 struct for InlineObject1631
type InlineObject1631 struct {
...
func (o InlineObject1631) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1631 struct {
	value *InlineObject1631
	isSet bool
}

func (v NullableInlineObject1631) Get() *InlineObject1631 {
	return v.value
}

func (v *NullableInlineObject1631) Set(val *InlineObject1631) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1631) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1631) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1631(val *InlineObject1631) *NullableInlineObject1631 {
	return &NullableInlineObject1631{value: val, isSet: true}
}

func (v NullableInlineObject1631) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1631) UnmarshalJSON(src []byte) error {
	v.isSet = true
