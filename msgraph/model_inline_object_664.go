...
// InlineObject664 struct for InlineObject664
type InlineObject664 struct {
...
func (o *InlineObject664) HasGroupId() bool {
...
func (o *InlineObject664) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject664) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject664) GetNotebookFolderOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject664) SetNotebookFolderNil() {
...
func (o *InlineObject664) SetSiteCollectionIdNil() {
...
func (o *InlineObject664) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject664) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject664 struct {
	value *InlineObject664
	isSet bool
}

func (v NullableInlineObject664) Get() *InlineObject664 {
	return v.value
}

func (v *NullableInlineObject664) Set(val *InlineObject664) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject664) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject664) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject664(val *InlineObject664) *NullableInlineObject664 {
	return &NullableInlineObject664{value: val, isSet: true}
}

func (v NullableInlineObject664) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject664) UnmarshalJSON(src []byte) error {
	v.isSet = true
