...
// InlineObject1337 struct for InlineObject1337
type InlineObject1337 struct {
...
func (o InlineObject1337) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1337 struct {
	value *InlineObject1337
	isSet bool
}

func (v NullableInlineObject1337) Get() *InlineObject1337 {
	return v.value
}

func (v *NullableInlineObject1337) Set(val *InlineObject1337) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1337) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1337) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1337(val *InlineObject1337) *NullableInlineObject1337 {
	return &NullableInlineObject1337{value: val, isSet: true}
}

func (v NullableInlineObject1337) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1337) UnmarshalJSON(src []byte) error {
	v.isSet = true
