...
// InlineObject594 struct for InlineObject594
type InlineObject594 struct {
...
func (o *InlineObject594) SetSaveToSentItemsNil() {
...
func (o InlineObject594) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject594 struct {
	value *InlineObject594
	isSet bool
}

func (v NullableInlineObject594) Get() *InlineObject594 {
	return v.value
}

func (v *NullableInlineObject594) Set(val *InlineObject594) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject594) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject594) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject594(val *InlineObject594) *NullableInlineObject594 {
	return &NullableInlineObject594{value: val, isSet: true}
}

func (v NullableInlineObject594) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject594) UnmarshalJSON(src []byte) error {
	v.isSet = true
