...
// InlineObject960 struct for InlineObject960
type InlineObject960 struct {
...
func (o *InlineObject960) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject960) SetSendResponseNil() {
...
func (o InlineObject960) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject960 struct {
	value *InlineObject960
	isSet bool
}

func (v NullableInlineObject960) Get() *InlineObject960 {
	return v.value
}

func (v *NullableInlineObject960) Set(val *InlineObject960) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject960) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject960) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject960(val *InlineObject960) *NullableInlineObject960 {
	return &NullableInlineObject960{value: val, isSet: true}
}

func (v NullableInlineObject960) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject960) UnmarshalJSON(src []byte) error {
	v.isSet = true
