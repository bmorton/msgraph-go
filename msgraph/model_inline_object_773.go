...
// InlineObject773 struct for InlineObject773
type InlineObject773 struct {
...
func (o *InlineObject773) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject773) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject773) SetSiteCollectionIdNil() {
...
func (o *InlineObject773) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject773) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject773 struct {
	value *InlineObject773
	isSet bool
}

func (v NullableInlineObject773) Get() *InlineObject773 {
	return v.value
}

func (v *NullableInlineObject773) Set(val *InlineObject773) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject773) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject773) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject773(val *InlineObject773) *NullableInlineObject773 {
	return &NullableInlineObject773{value: val, isSet: true}
}

func (v NullableInlineObject773) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject773) UnmarshalJSON(src []byte) error {
	v.isSet = true
