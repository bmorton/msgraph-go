...
func (o *InlineObject1189) SetEndDateTimeNil() {
...
func (o *InlineObject1189) SetStartDateTimeNil() {
...
func (o *InlineObject1189) SetSubjectNil() {
	o.Subject.Set(nil)
}
...
type NullableInlineObject1189 struct {
	value *InlineObject1189
	isSet bool
}

func (v NullableInlineObject1189) Get() *InlineObject1189 {
	return v.value
}

func (v *NullableInlineObject1189) Set(val *InlineObject1189) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1189) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1189) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1189(val *InlineObject1189) *NullableInlineObject1189 {
	return &NullableInlineObject1189{value: val, isSet: true}
}

func (v NullableInlineObject1189) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1189) UnmarshalJSON(src []byte) error {
	v.isSet = true
