...
type NullableInlineObject1006 struct {
	value *InlineObject1006
	isSet bool
}

func (v NullableInlineObject1006) Get() *InlineObject1006 {
	return v.value
}

func (v *NullableInlineObject1006) Set(val *InlineObject1006) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1006) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1006) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1006(val *InlineObject1006) *NullableInlineObject1006 {
	return &NullableInlineObject1006{value: val, isSet: true}
}

func (v NullableInlineObject1006) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1006) UnmarshalJSON(src []byte) error {
	v.isSet = true
