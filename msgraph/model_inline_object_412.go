...
// InlineObject412 struct for InlineObject412
type InlineObject412 struct {
...
func (o *InlineObject412) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject412) SetSendResponseNil() {
...
func (o InlineObject412) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject412 struct {
	value *InlineObject412
	isSet bool
}

func (v NullableInlineObject412) Get() *InlineObject412 {
	return v.value
}

func (v *NullableInlineObject412) Set(val *InlineObject412) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject412) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject412) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject412(val *InlineObject412) *NullableInlineObject412 {
	return &NullableInlineObject412{value: val, isSet: true}
}

func (v NullableInlineObject412) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject412) UnmarshalJSON(src []byte) error {
	v.isSet = true
