...
// InlineObject481 struct for InlineObject481
type InlineObject481 struct {
...
func (o *InlineObject481) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject481) SetSendResponseNil() {
...
func (o InlineObject481) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject481 struct {
	value *InlineObject481
	isSet bool
}

func (v NullableInlineObject481) Get() *InlineObject481 {
	return v.value
}

func (v *NullableInlineObject481) Set(val *InlineObject481) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject481) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject481) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject481(val *InlineObject481) *NullableInlineObject481 {
	return &NullableInlineObject481{value: val, isSet: true}
}

func (v NullableInlineObject481) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject481) UnmarshalJSON(src []byte) error {
	v.isSet = true
