...
// InlineObject321 struct for InlineObject321
type InlineObject321 struct {
...
func (o *InlineObject321) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject321) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject321) SetNotebookFolderNil() {
...
func (o *InlineObject321) SetSiteCollectionIdNil() {
...
func (o *InlineObject321) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject321) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject321 struct {
	value *InlineObject321
	isSet bool
}

func (v NullableInlineObject321) Get() *InlineObject321 {
	return v.value
}

func (v *NullableInlineObject321) Set(val *InlineObject321) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject321) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject321) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject321(val *InlineObject321) *NullableInlineObject321 {
	return &NullableInlineObject321{value: val, isSet: true}
}

func (v NullableInlineObject321) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject321) UnmarshalJSON(src []byte) error {
	v.isSet = true
