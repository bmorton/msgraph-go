...
// InlineObject455 struct for InlineObject455
type InlineObject455 struct {
...
func (o *InlineObject455) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject455) SetSendResponseNil() {
...
func (o InlineObject455) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject455 struct {
	value *InlineObject455
	isSet bool
}

func (v NullableInlineObject455) Get() *InlineObject455 {
	return v.value
}

func (v *NullableInlineObject455) Set(val *InlineObject455) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject455) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject455) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject455(val *InlineObject455) *NullableInlineObject455 {
	return &NullableInlineObject455{value: val, isSet: true}
}

func (v NullableInlineObject455) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject455) UnmarshalJSON(src []byte) error {
	v.isSet = true
