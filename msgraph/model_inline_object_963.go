...
// InlineObject963 struct for InlineObject963
type InlineObject963 struct {
...
func (o *InlineObject963) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o InlineObject963) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject963 struct {
	value *InlineObject963
	isSet bool
}

func (v NullableInlineObject963) Get() *InlineObject963 {
	return v.value
}

func (v *NullableInlineObject963) Set(val *InlineObject963) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject963) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject963) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject963(val *InlineObject963) *NullableInlineObject963 {
	return &NullableInlineObject963{value: val, isSet: true}
}

func (v NullableInlineObject963) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject963) UnmarshalJSON(src []byte) error {
	v.isSet = true
