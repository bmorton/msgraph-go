...
// InlineObject1075 struct for InlineObject1075
type InlineObject1075 struct {
...
func (o *InlineObject1075) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o InlineObject1075) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1075 struct {
	value *InlineObject1075
	isSet bool
}

func (v NullableInlineObject1075) Get() *InlineObject1075 {
	return v.value
}

func (v *NullableInlineObject1075) Set(val *InlineObject1075) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1075) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1075) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1075(val *InlineObject1075) *NullableInlineObject1075 {
	return &NullableInlineObject1075{value: val, isSet: true}
}

func (v NullableInlineObject1075) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1075) UnmarshalJSON(src []byte) error {
	v.isSet = true
