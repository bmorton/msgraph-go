...
func (o *InlineObject753) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject753) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject753) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject753) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject753) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject753) SetSiteCollectionIdNil() {
...
func (o *InlineObject753) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject753 struct {
	value *InlineObject753
	isSet bool
}

func (v NullableInlineObject753) Get() *InlineObject753 {
	return v.value
}

func (v *NullableInlineObject753) Set(val *InlineObject753) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject753) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject753) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject753(val *InlineObject753) *NullableInlineObject753 {
	return &NullableInlineObject753{value: val, isSet: true}
}

func (v NullableInlineObject753) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject753) UnmarshalJSON(src []byte) error {
	v.isSet = true
