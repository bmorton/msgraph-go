...
// InlineObject645 struct for InlineObject645
type InlineObject645 struct {
...
func (o *InlineObject645) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject645) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject645) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject645) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject645) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject645) SetSiteCollectionIdNil() {
...
func (o *InlineObject645) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject645) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject645 struct {
	value *InlineObject645
	isSet bool
}

func (v NullableInlineObject645) Get() *InlineObject645 {
	return v.value
}

func (v *NullableInlineObject645) Set(val *InlineObject645) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject645) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject645) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject645(val *InlineObject645) *NullableInlineObject645 {
	return &NullableInlineObject645{value: val, isSet: true}
}

func (v NullableInlineObject645) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject645) UnmarshalJSON(src []byte) error {
	v.isSet = true
