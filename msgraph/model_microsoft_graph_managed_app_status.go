...
func NewMicrosoftGraphManagedAppStatus() *MicrosoftGraphManagedAppStatus {
	this := MicrosoftGraphManagedAppStatus{}
	return &this
}
...
func (o *MicrosoftGraphManagedAppStatus) SetDisplayNameNil() {
...
func (o *MicrosoftGraphManagedAppStatus) SetVersionNil() {
	o.Version.Set(nil)
}
...
type NullableMicrosoftGraphManagedAppStatus struct {
	value *MicrosoftGraphManagedAppStatus
	isSet bool
}

func (v NullableMicrosoftGraphManagedAppStatus) Get() *MicrosoftGraphManagedAppStatus {
	return v.value
}

func (v *NullableMicrosoftGraphManagedAppStatus) Set(val *MicrosoftGraphManagedAppStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableMicrosoftGraphManagedAppStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableMicrosoftGraphManagedAppStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMicrosoftGraphManagedAppStatus(val *MicrosoftGraphManagedAppStatus) *NullableMicrosoftGraphManagedAppStatus {
	return &NullableMicrosoftGraphManagedAppStatus{value: val, isSet: true}
}

func (v NullableMicrosoftGraphManagedAppStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMicrosoftGraphManagedAppStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
