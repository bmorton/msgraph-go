...
func (o *InlineObject1105) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1105) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1105) SetNotebookFolderNil() {
...
func (o *InlineObject1105) SetSiteCollectionIdNil() {
...
func (o *InlineObject1105) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1105) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1105 struct {
	value *InlineObject1105
	isSet bool
}

func (v NullableInlineObject1105) Get() *InlineObject1105 {
	return v.value
}

func (v *NullableInlineObject1105) Set(val *InlineObject1105) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1105) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1105) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1105(val *InlineObject1105) *NullableInlineObject1105 {
	return &NullableInlineObject1105{value: val, isSet: true}
}

func (v NullableInlineObject1105) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1105) UnmarshalJSON(src []byte) error {
	v.isSet = true
