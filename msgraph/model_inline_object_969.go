...
func (o *InlineObject969) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject969) SetSendResponseNil() {
...
type NullableInlineObject969 struct {
	value *InlineObject969
	isSet bool
}

func (v NullableInlineObject969) Get() *InlineObject969 {
	return v.value
}

func (v *NullableInlineObject969) Set(val *InlineObject969) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject969) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject969) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject969(val *InlineObject969) *NullableInlineObject969 {
	return &NullableInlineObject969{value: val, isSet: true}
}

func (v NullableInlineObject969) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject969) UnmarshalJSON(src []byte) error {
	v.isSet = true
