...
func (o *InlineObject324) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject324) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject324) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject324) SetSiteCollectionIdNil() {
...
func (o *InlineObject324) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject324) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject324 struct {
	value *InlineObject324
	isSet bool
}

func (v NullableInlineObject324) Get() *InlineObject324 {
	return v.value
}

func (v *NullableInlineObject324) Set(val *InlineObject324) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject324) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject324) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject324(val *InlineObject324) *NullableInlineObject324 {
	return &NullableInlineObject324{value: val, isSet: true}
}

func (v NullableInlineObject324) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject324) UnmarshalJSON(src []byte) error {
	v.isSet = true
