...
func (o *InlineObject372) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject372) SetSendResponseNil() {
...
func (o InlineObject372) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject372 struct {
	value *InlineObject372
	isSet bool
}

func (v NullableInlineObject372) Get() *InlineObject372 {
	return v.value
}

func (v *NullableInlineObject372) Set(val *InlineObject372) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject372) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject372) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject372(val *InlineObject372) *NullableInlineObject372 {
	return &NullableInlineObject372{value: val, isSet: true}
}

func (v NullableInlineObject372) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject372) UnmarshalJSON(src []byte) error {
	v.isSet = true
