...
func NewMicrosoftGraphEducationClass() *MicrosoftGraphEducationClass {
	this := MicrosoftGraphEducationClass{}
	return &this
}
...
func (o *MicrosoftGraphEducationClass) SetClassCodeNil() {
	o.ClassCode.Set(nil)
}
...
func (o *MicrosoftGraphEducationClass) SetDescriptionNil() {
...
func (o *MicrosoftGraphEducationClass) SetExternalIdNil() {
...
func (o *MicrosoftGraphEducationClass) SetExternalNameNil() {
...
func (o *MicrosoftGraphEducationClass) SetExternalSourceDetailNil() {
...
func (o *MicrosoftGraphEducationClass) SetGradeNil() {
	o.Grade.Set(nil)
}
...
type NullableMicrosoftGraphEducationClass struct {
	value *MicrosoftGraphEducationClass
	isSet bool
}

func (v NullableMicrosoftGraphEducationClass) Get() *MicrosoftGraphEducationClass {
	return v.value
}

func (v *NullableMicrosoftGraphEducationClass) Set(val *MicrosoftGraphEducationClass) {
	v.value = val
	v.isSet = true
}

func (v NullableMicrosoftGraphEducationClass) IsSet() bool {
	return v.isSet
}

func (v *NullableMicrosoftGraphEducationClass) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMicrosoftGraphEducationClass(val *MicrosoftGraphEducationClass) *NullableMicrosoftGraphEducationClass {
	return &NullableMicrosoftGraphEducationClass{value: val, isSet: true}
}

func (v NullableMicrosoftGraphEducationClass) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMicrosoftGraphEducationClass) UnmarshalJSON(src []byte) error {
	v.isSet = true
