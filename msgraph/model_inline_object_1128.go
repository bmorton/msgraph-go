...
func (o *InlineObject1128) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1128) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1128) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1128) SetSiteCollectionIdNil() {
...
func (o *InlineObject1128) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1128) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1128 struct {
	value *InlineObject1128
	isSet bool
}

func (v NullableInlineObject1128) Get() *InlineObject1128 {
	return v.value
}

func (v *NullableInlineObject1128) Set(val *InlineObject1128) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1128) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1128) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1128(val *InlineObject1128) *NullableInlineObject1128 {
	return &NullableInlineObject1128{value: val, isSet: true}
}

func (v NullableInlineObject1128) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1128) UnmarshalJSON(src []byte) error {
	v.isSet = true
