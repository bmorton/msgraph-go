...
// InlineObject450 struct for InlineObject450
type InlineObject450 struct {
...
func (o *InlineObject450) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o InlineObject450) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject450 struct {
	value *InlineObject450
	isSet bool
}

func (v NullableInlineObject450) Get() *InlineObject450 {
	return v.value
}

func (v *NullableInlineObject450) Set(val *InlineObject450) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject450) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject450) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject450(val *InlineObject450) *NullableInlineObject450 {
	return &NullableInlineObject450{value: val, isSet: true}
}

func (v NullableInlineObject450) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject450) UnmarshalJSON(src []byte) error {
	v.isSet = true
