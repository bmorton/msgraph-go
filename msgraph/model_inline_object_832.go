...
// InlineObject832 struct for InlineObject832
type InlineObject832 struct {
...
func (o *InlineObject832) HasGroupId() bool {
...
func (o *InlineObject832) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject832) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject832) GetNotebookFolderOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject832) SetNotebookFolderNil() {
...
func (o *InlineObject832) SetSiteCollectionIdNil() {
...
func (o *InlineObject832) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject832) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject832 struct {
	value *InlineObject832
	isSet bool
}

func (v NullableInlineObject832) Get() *InlineObject832 {
	return v.value
}

func (v *NullableInlineObject832) Set(val *InlineObject832) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject832) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject832) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject832(val *InlineObject832) *NullableInlineObject832 {
	return &NullableInlineObject832{value: val, isSet: true}
}

func (v NullableInlineObject832) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject832) UnmarshalJSON(src []byte) error {
	v.isSet = true
