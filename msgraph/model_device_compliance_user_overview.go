...
func NewDeviceComplianceUserOverview() *DeviceComplianceUserOverview {
	this := DeviceComplianceUserOverview{}
	return &this
}
...
func (o DeviceComplianceUserOverview) MarshalJSON() ([]byte, error) {
...
type NullableDeviceComplianceUserOverview struct {
	value *DeviceComplianceUserOverview
	isSet bool
}

func (v NullableDeviceComplianceUserOverview) Get() *DeviceComplianceUserOverview {
	return v.value
}

func (v *NullableDeviceComplianceUserOverview) Set(val *DeviceComplianceUserOverview) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceComplianceUserOverview) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceComplianceUserOverview) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceComplianceUserOverview(val *DeviceComplianceUserOverview) *NullableDeviceComplianceUserOverview {
	return &NullableDeviceComplianceUserOverview{value: val, isSet: true}
}

func (v NullableDeviceComplianceUserOverview) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceComplianceUserOverview) UnmarshalJSON(src []byte) error {
	v.isSet = true
