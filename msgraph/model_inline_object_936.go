...
func (o *InlineObject936) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o InlineObject936) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject936 struct {
	value *InlineObject936
	isSet bool
}

func (v NullableInlineObject936) Get() *InlineObject936 {
	return v.value
}

func (v *NullableInlineObject936) Set(val *InlineObject936) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject936) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject936) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject936(val *InlineObject936) *NullableInlineObject936 {
	return &NullableInlineObject936{value: val, isSet: true}
}

func (v NullableInlineObject936) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject936) UnmarshalJSON(src []byte) error {
	v.isSet = true
