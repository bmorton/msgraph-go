...
// InlineObject453 struct for InlineObject453
type InlineObject453 struct {
...
func (o *InlineObject453) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject453) SetSendResponseNil() {
...
func (o InlineObject453) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject453 struct {
	value *InlineObject453
	isSet bool
}

func (v NullableInlineObject453) Get() *InlineObject453 {
	return v.value
}

func (v *NullableInlineObject453) Set(val *InlineObject453) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject453) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject453) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject453(val *InlineObject453) *NullableInlineObject453 {
	return &NullableInlineObject453{value: val, isSet: true}
}

func (v NullableInlineObject453) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject453) UnmarshalJSON(src []byte) error {
	v.isSet = true
