...
func (o *InlineObject648) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject648) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject648) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject648) SetSiteCollectionIdNil() {
...
func (o *InlineObject648) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject648) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject648 struct {
	value *InlineObject648
	isSet bool
}

func (v NullableInlineObject648) Get() *InlineObject648 {
	return v.value
}

func (v *NullableInlineObject648) Set(val *InlineObject648) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject648) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject648) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject648(val *InlineObject648) *NullableInlineObject648 {
	return &NullableInlineObject648{value: val, isSet: true}
}

func (v NullableInlineObject648) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject648) UnmarshalJSON(src []byte) error {
	v.isSet = true
