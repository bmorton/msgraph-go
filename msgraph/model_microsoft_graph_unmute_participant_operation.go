...
// MicrosoftGraphUnmuteParticipantOperation struct for MicrosoftGraphUnmuteParticipantOperation
type MicrosoftGraphUnmuteParticipantOperation struct {
	// Read-only.
...
func NewMicrosoftGraphUnmuteParticipantOperation() *MicrosoftGraphUnmuteParticipantOperation {
	this := MicrosoftGraphUnmuteParticipantOperation{}
	return &this
}
...
func (o *MicrosoftGraphUnmuteParticipantOperation) SetClientContextNil() {
...
func (o MicrosoftGraphUnmuteParticipantOperation) MarshalJSON() ([]byte, error) {
...
type NullableMicrosoftGraphUnmuteParticipantOperation struct {
	value *MicrosoftGraphUnmuteParticipantOperation
	isSet bool
}

func (v NullableMicrosoftGraphUnmuteParticipantOperation) Get() *MicrosoftGraphUnmuteParticipantOperation {
	return v.value
}

func (v *NullableMicrosoftGraphUnmuteParticipantOperation) Set(val *MicrosoftGraphUnmuteParticipantOperation) {
	v.value = val
	v.isSet = true
}

func (v NullableMicrosoftGraphUnmuteParticipantOperation) IsSet() bool {
	return v.isSet
}

func (v *NullableMicrosoftGraphUnmuteParticipantOperation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMicrosoftGraphUnmuteParticipantOperation(val *MicrosoftGraphUnmuteParticipantOperation) *NullableMicrosoftGraphUnmuteParticipantOperation {
	return &NullableMicrosoftGraphUnmuteParticipantOperation{value: val, isSet: true}
}

func (v NullableMicrosoftGraphUnmuteParticipantOperation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMicrosoftGraphUnmuteParticipantOperation) UnmarshalJSON(src []byte) error {
	v.isSet = true
