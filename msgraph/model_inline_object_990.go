...
func (o InlineObject990) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject990 struct {
	value *InlineObject990
	isSet bool
}

func (v NullableInlineObject990) Get() *InlineObject990 {
	return v.value
}

func (v *NullableInlineObject990) Set(val *InlineObject990) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject990) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject990) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject990(val *InlineObject990) *NullableInlineObject990 {
	return &NullableInlineObject990{value: val, isSet: true}
}

func (v NullableInlineObject990) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject990) UnmarshalJSON(src []byte) error {
	v.isSet = true
