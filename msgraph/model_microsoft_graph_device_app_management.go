...
func NewMicrosoftGraphDeviceAppManagement() *MicrosoftGraphDeviceAppManagement {
	this := MicrosoftGraphDeviceAppManagement{}
	return &this
}
...
func (o *MicrosoftGraphDeviceAppManagement) SetMicrosoftStoreForBusinessLanguageNil() {
...
type NullableMicrosoftGraphDeviceAppManagement struct {
	value *MicrosoftGraphDeviceAppManagement
	isSet bool
}

func (v NullableMicrosoftGraphDeviceAppManagement) Get() *MicrosoftGraphDeviceAppManagement {
	return v.value
}

func (v *NullableMicrosoftGraphDeviceAppManagement) Set(val *MicrosoftGraphDeviceAppManagement) {
	v.value = val
	v.isSet = true
}

func (v NullableMicrosoftGraphDeviceAppManagement) IsSet() bool {
	return v.isSet
}

func (v *NullableMicrosoftGraphDeviceAppManagement) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMicrosoftGraphDeviceAppManagement(val *MicrosoftGraphDeviceAppManagement) *NullableMicrosoftGraphDeviceAppManagement {
	return &NullableMicrosoftGraphDeviceAppManagement{value: val, isSet: true}
}

func (v NullableMicrosoftGraphDeviceAppManagement) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMicrosoftGraphDeviceAppManagement) UnmarshalJSON(src []byte) error {
	v.isSet = true
