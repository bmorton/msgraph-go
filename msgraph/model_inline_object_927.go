...
func (o *InlineObject927) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject927) SetSendResponseNil() {
...
type NullableInlineObject927 struct {
	value *InlineObject927
	isSet bool
}

func (v NullableInlineObject927) Get() *InlineObject927 {
	return v.value
}

func (v *NullableInlineObject927) Set(val *InlineObject927) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject927) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject927) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject927(val *InlineObject927) *NullableInlineObject927 {
	return &NullableInlineObject927{value: val, isSet: true}
}

func (v NullableInlineObject927) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject927) UnmarshalJSON(src []byte) error {
	v.isSet = true
