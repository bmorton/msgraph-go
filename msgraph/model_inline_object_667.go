...
// InlineObject667 struct for InlineObject667
type InlineObject667 struct {
...
func (o *InlineObject667) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject667) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject667) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject667) SetSiteCollectionIdNil() {
...
func (o *InlineObject667) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject667) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject667 struct {
	value *InlineObject667
	isSet bool
}

func (v NullableInlineObject667) Get() *InlineObject667 {
	return v.value
}

func (v *NullableInlineObject667) Set(val *InlineObject667) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject667) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject667) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject667(val *InlineObject667) *NullableInlineObject667 {
	return &NullableInlineObject667{value: val, isSet: true}
}

func (v NullableInlineObject667) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject667) UnmarshalJSON(src []byte) error {
	v.isSet = true
