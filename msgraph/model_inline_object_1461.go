...
// InlineObject1461 struct for InlineObject1461
type InlineObject1461 struct {
...
func (o InlineObject1461) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1461 struct {
	value *InlineObject1461
	isSet bool
}

func (v NullableInlineObject1461) Get() *InlineObject1461 {
	return v.value
}

func (v *NullableInlineObject1461) Set(val *InlineObject1461) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1461) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1461) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1461(val *InlineObject1461) *NullableInlineObject1461 {
	return &NullableInlineObject1461{value: val, isSet: true}
}

func (v NullableInlineObject1461) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1461) UnmarshalJSON(src []byte) error {
	v.isSet = true
