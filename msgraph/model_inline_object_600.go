...
func (o *InlineObject600) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject600) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject600) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject600) SetSiteCollectionIdNil() {
...
func (o *InlineObject600) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject600) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject600 struct {
	value *InlineObject600
	isSet bool
}

func (v NullableInlineObject600) Get() *InlineObject600 {
	return v.value
}

func (v *NullableInlineObject600) Set(val *InlineObject600) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject600) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject600) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject600(val *InlineObject600) *NullableInlineObject600 {
	return &NullableInlineObject600{value: val, isSet: true}
}

func (v NullableInlineObject600) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject600) UnmarshalJSON(src []byte) error {
	v.isSet = true
