...
func (o *InlineObject815) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject815) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject815) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject815) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject815) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject815) SetSiteCollectionIdNil() {
...
func (o *InlineObject815) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject815 struct {
	value *InlineObject815
	isSet bool
}

func (v NullableInlineObject815) Get() *InlineObject815 {
	return v.value
}

func (v *NullableInlineObject815) Set(val *InlineObject815) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject815) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject815) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject815(val *InlineObject815) *NullableInlineObject815 {
	return &NullableInlineObject815{value: val, isSet: true}
}

func (v NullableInlineObject815) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject815) UnmarshalJSON(src []byte) error {
	v.isSet = true
