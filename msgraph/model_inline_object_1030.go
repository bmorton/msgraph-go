...
func (o InlineObject1030) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1030 struct {
	value *InlineObject1030
	isSet bool
}

func (v NullableInlineObject1030) Get() *InlineObject1030 {
	return v.value
}

func (v *NullableInlineObject1030) Set(val *InlineObject1030) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1030) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1030) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1030(val *InlineObject1030) *NullableInlineObject1030 {
	return &NullableInlineObject1030{value: val, isSet: true}
}

func (v NullableInlineObject1030) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1030) UnmarshalJSON(src []byte) error {
	v.isSet = true
