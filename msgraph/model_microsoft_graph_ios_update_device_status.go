...
func NewMicrosoftGraphIosUpdateDeviceStatus() *MicrosoftGraphIosUpdateDeviceStatus {
	this := MicrosoftGraphIosUpdateDeviceStatus{}
	return &this
}
...
func (o *MicrosoftGraphIosUpdateDeviceStatus) SetDeviceDisplayNameNil() {
...
func (o *MicrosoftGraphIosUpdateDeviceStatus) SetDeviceIdNil() {
	o.DeviceId.Set(nil)
}
...
func (o *MicrosoftGraphIosUpdateDeviceStatus) SetDeviceModelNil() {
...
func (o *MicrosoftGraphIosUpdateDeviceStatus) SetOsVersionNil() {
	o.OsVersion.Set(nil)
}
...
func (o *MicrosoftGraphIosUpdateDeviceStatus) SetUserIdNil() {
	o.UserId.Set(nil)
}
...
func (o *MicrosoftGraphIosUpdateDeviceStatus) SetUserNameNil() {
	o.UserName.Set(nil)
}
...
func (o *MicrosoftGraphIosUpdateDeviceStatus) SetUserPrincipalNameNil() {
...
type NullableMicrosoftGraphIosUpdateDeviceStatus struct {
	value *MicrosoftGraphIosUpdateDeviceStatus
	isSet bool
}

func (v NullableMicrosoftGraphIosUpdateDeviceStatus) Get() *MicrosoftGraphIosUpdateDeviceStatus {
	return v.value
}

func (v *NullableMicrosoftGraphIosUpdateDeviceStatus) Set(val *MicrosoftGraphIosUpdateDeviceStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableMicrosoftGraphIosUpdateDeviceStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableMicrosoftGraphIosUpdateDeviceStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMicrosoftGraphIosUpdateDeviceStatus(val *MicrosoftGraphIosUpdateDeviceStatus) *NullableMicrosoftGraphIosUpdateDeviceStatus {
	return &NullableMicrosoftGraphIosUpdateDeviceStatus{value: val, isSet: true}
}

func (v NullableMicrosoftGraphIosUpdateDeviceStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMicrosoftGraphIosUpdateDeviceStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
