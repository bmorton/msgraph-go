...
func (o *InlineObject800) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject800) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject800) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject800) SetSiteCollectionIdNil() {
...
func (o *InlineObject800) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject800 struct {
	value *InlineObject800
	isSet bool
}

func (v NullableInlineObject800) Get() *InlineObject800 {
	return v.value
}

func (v *NullableInlineObject800) Set(val *InlineObject800) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject800) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject800) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject800(val *InlineObject800) *NullableInlineObject800 {
	return &NullableInlineObject800{value: val, isSet: true}
}

func (v NullableInlineObject800) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject800) UnmarshalJSON(src []byte) error {
	v.isSet = true
