...
// InlineObject967 struct for InlineObject967
type InlineObject967 struct {
...
func (o *InlineObject967) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject967) SetSendResponseNil() {
...
func (o InlineObject967) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject967 struct {
	value *InlineObject967
	isSet bool
}

func (v NullableInlineObject967) Get() *InlineObject967 {
	return v.value
}

func (v *NullableInlineObject967) Set(val *InlineObject967) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject967) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject967) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject967(val *InlineObject967) *NullableInlineObject967 {
	return &NullableInlineObject967{value: val, isSet: true}
}

func (v NullableInlineObject967) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject967) UnmarshalJSON(src []byte) error {
	v.isSet = true
