...
func (o *InlineObject775) HasGroupId() bool {
...
func (o *InlineObject775) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject775) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject775) GetNotebookFolderOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject775) SetNotebookFolderNil() {
...
func (o *InlineObject775) SetSiteCollectionIdNil() {
...
func (o *InlineObject775) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject775 struct {
	value *InlineObject775
	isSet bool
}

func (v NullableInlineObject775) Get() *InlineObject775 {
	return v.value
}

func (v *NullableInlineObject775) Set(val *InlineObject775) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject775) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject775) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject775(val *InlineObject775) *NullableInlineObject775 {
	return &NullableInlineObject775{value: val, isSet: true}
}

func (v NullableInlineObject775) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject775) UnmarshalJSON(src []byte) error {
	v.isSet = true
