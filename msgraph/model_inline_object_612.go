...
func (o *InlineObject612) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject612) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject612) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject612) SetSiteCollectionIdNil() {
...
func (o *InlineObject612) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject612 struct {
	value *InlineObject612
	isSet bool
}

func (v NullableInlineObject612) Get() *InlineObject612 {
	return v.value
}

func (v *NullableInlineObject612) Set(val *InlineObject612) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject612) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject612) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject612(val *InlineObject612) *NullableInlineObject612 {
	return &NullableInlineObject612{value: val, isSet: true}
}

func (v NullableInlineObject612) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject612) UnmarshalJSON(src []byte) error {
	v.isSet = true
