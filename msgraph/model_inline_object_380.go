...
func (o *InlineObject380) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject380) SetSendResponseNil() {
...
type NullableInlineObject380 struct {
	value *InlineObject380
	isSet bool
}

func (v NullableInlineObject380) Get() *InlineObject380 {
	return v.value
}

func (v *NullableInlineObject380) Set(val *InlineObject380) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject380) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject380) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject380(val *InlineObject380) *NullableInlineObject380 {
	return &NullableInlineObject380{value: val, isSet: true}
}

func (v NullableInlineObject380) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject380) UnmarshalJSON(src []byte) error {
	v.isSet = true
