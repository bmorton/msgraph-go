...
func (o *InlineObject1163) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1163) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1163) SetNotebookFolderNil() {
...
func (o *InlineObject1163) SetSiteCollectionIdNil() {
...
func (o *InlineObject1163) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1163) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1163 struct {
	value *InlineObject1163
	isSet bool
}

func (v NullableInlineObject1163) Get() *InlineObject1163 {
	return v.value
}

func (v *NullableInlineObject1163) Set(val *InlineObject1163) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1163) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1163) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1163(val *InlineObject1163) *NullableInlineObject1163 {
	return &NullableInlineObject1163{value: val, isSet: true}
}

func (v NullableInlineObject1163) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1163) UnmarshalJSON(src []byte) error {
	v.isSet = true
