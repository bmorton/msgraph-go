...
func (o *InlineObject906) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject906) SetSendResponseNil() {
...
func (o InlineObject906) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject906 struct {
	value *InlineObject906
	isSet bool
}

func (v NullableInlineObject906) Get() *InlineObject906 {
	return v.value
}

func (v *NullableInlineObject906) Set(val *InlineObject906) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject906) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject906) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject906(val *InlineObject906) *NullableInlineObject906 {
	return &NullableInlineObject906{value: val, isSet: true}
}

func (v NullableInlineObject906) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject906) UnmarshalJSON(src []byte) error {
	v.isSet = true
