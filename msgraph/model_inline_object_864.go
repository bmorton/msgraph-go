...
func (o *InlineObject864) SetCommentNil() {
	o.Comment.Set(nil)
}
...
type NullableInlineObject864 struct {
	value *InlineObject864
	isSet bool
}

func (v NullableInlineObject864) Get() *InlineObject864 {
	return v.value
}

func (v *NullableInlineObject864) Set(val *InlineObject864) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject864) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject864) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject864(val *InlineObject864) *NullableInlineObject864 {
	return &NullableInlineObject864{value: val, isSet: true}
}

func (v NullableInlineObject864) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject864) UnmarshalJSON(src []byte) error {
	v.isSet = true
