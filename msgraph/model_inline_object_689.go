...
func (o *InlineObject689) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject689) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject689) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject689) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject689) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject689) SetSiteCollectionIdNil() {
...
func (o *InlineObject689) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject689) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject689 struct {
	value *InlineObject689
	isSet bool
}

func (v NullableInlineObject689) Get() *InlineObject689 {
	return v.value
}

func (v *NullableInlineObject689) Set(val *InlineObject689) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject689) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject689) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject689(val *InlineObject689) *NullableInlineObject689 {
	return &NullableInlineObject689{value: val, isSet: true}
}

func (v NullableInlineObject689) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject689) UnmarshalJSON(src []byte) error {
	v.isSet = true
