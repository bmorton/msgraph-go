...
func (o *InlineObject316) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject316) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject316) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject316) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject316) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject316) SetSiteCollectionIdNil() {
...
func (o *InlineObject316) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
