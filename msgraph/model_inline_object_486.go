...
// InlineObject486 struct for InlineObject486
type InlineObject486 struct {
...
func (o *InlineObject486) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject486) SetSendResponseNil() {
...
func (o InlineObject486) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject486 struct {
	value *InlineObject486
	isSet bool
}

func (v NullableInlineObject486) Get() *InlineObject486 {
	return v.value
}

func (v *NullableInlineObject486) Set(val *InlineObject486) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject486) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject486) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject486(val *InlineObject486) *NullableInlineObject486 {
	return &NullableInlineObject486{value: val, isSet: true}
}

func (v NullableInlineObject486) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject486) UnmarshalJSON(src []byte) error {
	v.isSet = true
