...
func (o *InlineObject949) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject949) SetSendResponseNil() {
...
func (o InlineObject949) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject949 struct {
	value *InlineObject949
	isSet bool
}

func (v NullableInlineObject949) Get() *InlineObject949 {
	return v.value
}

func (v *NullableInlineObject949) Set(val *InlineObject949) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject949) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject949) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject949(val *InlineObject949) *NullableInlineObject949 {
	return &NullableInlineObject949{value: val, isSet: true}
}

func (v NullableInlineObject949) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject949) UnmarshalJSON(src []byte) error {
	v.isSet = true
