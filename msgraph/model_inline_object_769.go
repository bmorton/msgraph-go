...
func (o *InlineObject769) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject769) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject769) SetNotebookFolderNil() {
...
func (o *InlineObject769) SetSiteCollectionIdNil() {
...
func (o *InlineObject769) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject769 struct {
	value *InlineObject769
	isSet bool
}

func (v NullableInlineObject769) Get() *InlineObject769 {
	return v.value
}

func (v *NullableInlineObject769) Set(val *InlineObject769) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject769) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject769) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject769(val *InlineObject769) *NullableInlineObject769 {
	return &NullableInlineObject769{value: val, isSet: true}
}

func (v NullableInlineObject769) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject769) UnmarshalJSON(src []byte) error {
	v.isSet = true
