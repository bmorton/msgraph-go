...
func (o *InlineObject1091) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1091) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1091) SetNotebookFolderNil() {
...
func (o *InlineObject1091) SetSiteCollectionIdNil() {
...
func (o *InlineObject1091) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject1091 struct {
	value *InlineObject1091
	isSet bool
}

func (v NullableInlineObject1091) Get() *InlineObject1091 {
	return v.value
}

func (v *NullableInlineObject1091) Set(val *InlineObject1091) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1091) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1091) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1091(val *InlineObject1091) *NullableInlineObject1091 {
	return &NullableInlineObject1091{value: val, isSet: true}
}

func (v NullableInlineObject1091) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1091) UnmarshalJSON(src []byte) error {
	v.isSet = true
