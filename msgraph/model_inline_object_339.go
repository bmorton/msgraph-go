...
func (o *InlineObject339) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject339) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject339) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject339) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject339) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject339) SetSiteCollectionIdNil() {
...
func (o *InlineObject339) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject339) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject339 struct {
	value *InlineObject339
	isSet bool
}

func (v NullableInlineObject339) Get() *InlineObject339 {
	return v.value
}

func (v *NullableInlineObject339) Set(val *InlineObject339) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject339) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject339) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject339(val *InlineObject339) *NullableInlineObject339 {
	return &NullableInlineObject339{value: val, isSet: true}
}

func (v NullableInlineObject339) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject339) UnmarshalJSON(src []byte) error {
	v.isSet = true
