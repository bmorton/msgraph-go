...
// MicrosoftGraphStopHoldMusicOperation struct for MicrosoftGraphStopHoldMusicOperation
type MicrosoftGraphStopHoldMusicOperation struct {
	// Read-only.
...
func NewMicrosoftGraphStopHoldMusicOperation() *MicrosoftGraphStopHoldMusicOperation {
	this := MicrosoftGraphStopHoldMusicOperation{}
	return &this
}
...
func (o *MicrosoftGraphStopHoldMusicOperation) SetClientContextNil() {
...
func (o MicrosoftGraphStopHoldMusicOperation) MarshalJSON() ([]byte, error) {
...
type NullableMicrosoftGraphStopHoldMusicOperation struct {
	value *MicrosoftGraphStopHoldMusicOperation
	isSet bool
}

func (v NullableMicrosoftGraphStopHoldMusicOperation) Get() *MicrosoftGraphStopHoldMusicOperation {
	return v.value
}

func (v *NullableMicrosoftGraphStopHoldMusicOperation) Set(val *MicrosoftGraphStopHoldMusicOperation) {
	v.value = val
	v.isSet = true
}

func (v NullableMicrosoftGraphStopHoldMusicOperation) IsSet() bool {
	return v.isSet
}

func (v *NullableMicrosoftGraphStopHoldMusicOperation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMicrosoftGraphStopHoldMusicOperation(val *MicrosoftGraphStopHoldMusicOperation) *NullableMicrosoftGraphStopHoldMusicOperation {
	return &NullableMicrosoftGraphStopHoldMusicOperation{value: val, isSet: true}
}

func (v NullableMicrosoftGraphStopHoldMusicOperation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMicrosoftGraphStopHoldMusicOperation) UnmarshalJSON(src []byte) error {
	v.isSet = true
