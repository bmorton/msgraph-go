...
func (o *MicrosoftGraphTodoTask) SetTitleNil() {
	o.Title.Set(nil)
}
...
func (o MicrosoftGraphTodoTask) MarshalJSON() ([]byte, error) {
...
type NullableMicrosoftGraphTodoTask struct {
	value *MicrosoftGraphTodoTask
	isSet bool
}

func (v NullableMicrosoftGraphTodoTask) Get() *MicrosoftGraphTodoTask {
	return v.value
}

func (v *NullableMicrosoftGraphTodoTask) Set(val *MicrosoftGraphTodoTask) {
	v.value = val
	v.isSet = true
}

func (v NullableMicrosoftGraphTodoTask) IsSet() bool {
	return v.isSet
}

func (v *NullableMicrosoftGraphTodoTask) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMicrosoftGraphTodoTask(val *MicrosoftGraphTodoTask) *NullableMicrosoftGraphTodoTask {
	return &NullableMicrosoftGraphTodoTask{value: val, isSet: true}
}

func (v NullableMicrosoftGraphTodoTask) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMicrosoftGraphTodoTask) UnmarshalJSON(src []byte) error {
	v.isSet = true
