...
func (o *InlineObject1135) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1135) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1135) SetNotebookFolderNil() {
...
func (o *InlineObject1135) SetSiteCollectionIdNil() {
...
func (o *InlineObject1135) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1135) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1135 struct {
	value *InlineObject1135
	isSet bool
}

func (v NullableInlineObject1135) Get() *InlineObject1135 {
	return v.value
}

func (v *NullableInlineObject1135) Set(val *InlineObject1135) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1135) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1135) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1135(val *InlineObject1135) *NullableInlineObject1135 {
	return &NullableInlineObject1135{value: val, isSet: true}
}

func (v NullableInlineObject1135) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1135) UnmarshalJSON(src []byte) error {
	v.isSet = true
