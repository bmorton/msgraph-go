...
// InlineObject808 struct for InlineObject808
type InlineObject808 struct {
...
func (o *InlineObject808) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject808) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject808) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject808) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject808) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject808) SetSiteCollectionIdNil() {
...
func (o *InlineObject808) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject808) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject808 struct {
	value *InlineObject808
	isSet bool
}

func (v NullableInlineObject808) Get() *InlineObject808 {
	return v.value
}

func (v *NullableInlineObject808) Set(val *InlineObject808) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject808) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject808) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject808(val *InlineObject808) *NullableInlineObject808 {
	return &NullableInlineObject808{value: val, isSet: true}
}

func (v NullableInlineObject808) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject808) UnmarshalJSON(src []byte) error {
	v.isSet = true
