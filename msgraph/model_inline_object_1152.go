...
func (o *InlineObject1152) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1152) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1152) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1152) SetSiteCollectionIdNil() {
...
func (o *InlineObject1152) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1152) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1152 struct {
	value *InlineObject1152
	isSet bool
}

func (v NullableInlineObject1152) Get() *InlineObject1152 {
	return v.value
}

func (v *NullableInlineObject1152) Set(val *InlineObject1152) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1152) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1152) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1152(val *InlineObject1152) *NullableInlineObject1152 {
	return &NullableInlineObject1152{value: val, isSet: true}
}

func (v NullableInlineObject1152) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1152) UnmarshalJSON(src []byte) error {
	v.isSet = true
