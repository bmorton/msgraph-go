...
// InlineObject332 struct for InlineObject332
type InlineObject332 struct {
...
func (o *InlineObject332) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject332) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject332) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject332) SetSiteCollectionIdNil() {
...
func (o *InlineObject332) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject332) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject332 struct {
	value *InlineObject332
	isSet bool
}

func (v NullableInlineObject332) Get() *InlineObject332 {
	return v.value
}

func (v *NullableInlineObject332) Set(val *InlineObject332) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject332) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject332) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject332(val *InlineObject332) *NullableInlineObject332 {
	return &NullableInlineObject332{value: val, isSet: true}
}

func (v NullableInlineObject332) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject332) UnmarshalJSON(src []byte) error {
	v.isSet = true
