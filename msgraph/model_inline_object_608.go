...
func (o *InlineObject608) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject608) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject608) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject608) SetSiteCollectionIdNil() {
...
func (o *InlineObject608) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject608 struct {
	value *InlineObject608
	isSet bool
}

func (v NullableInlineObject608) Get() *InlineObject608 {
	return v.value
}

func (v *NullableInlineObject608) Set(val *InlineObject608) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject608) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject608) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject608(val *InlineObject608) *NullableInlineObject608 {
	return &NullableInlineObject608{value: val, isSet: true}
}

func (v NullableInlineObject608) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject608) UnmarshalJSON(src []byte) error {
	v.isSet = true
