...
// InlineObject802 struct for InlineObject802
type InlineObject802 struct {
...
func (o *InlineObject802) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject802) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject802) SetSiteCollectionIdNil() {
...
func (o *InlineObject802) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject802) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject802 struct {
	value *InlineObject802
	isSet bool
}

func (v NullableInlineObject802) Get() *InlineObject802 {
	return v.value
}

func (v *NullableInlineObject802) Set(val *InlineObject802) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject802) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject802) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject802(val *InlineObject802) *NullableInlineObject802 {
	return &NullableInlineObject802{value: val, isSet: true}
}

func (v NullableInlineObject802) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject802) UnmarshalJSON(src []byte) error {
	v.isSet = true
