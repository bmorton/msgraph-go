...
// InlineObject924 struct for InlineObject924
type InlineObject924 struct {
...
func (o *InlineObject924) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject924) SetSendResponseNil() {
...
func (o InlineObject924) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject924 struct {
	value *InlineObject924
	isSet bool
}

func (v NullableInlineObject924) Get() *InlineObject924 {
	return v.value
}

func (v *NullableInlineObject924) Set(val *InlineObject924) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject924) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject924) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject924(val *InlineObject924) *NullableInlineObject924 {
	return &NullableInlineObject924{value: val, isSet: true}
}

func (v NullableInlineObject924) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject924) UnmarshalJSON(src []byte) error {
	v.isSet = true
