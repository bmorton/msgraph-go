...
func (o *InlineObject1180) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1180) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1180) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1180) SetSiteCollectionIdNil() {
...
func (o *InlineObject1180) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject1180 struct {
	value *InlineObject1180
	isSet bool
}

func (v NullableInlineObject1180) Get() *InlineObject1180 {
	return v.value
}

func (v *NullableInlineObject1180) Set(val *InlineObject1180) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1180) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1180) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1180(val *InlineObject1180) *NullableInlineObject1180 {
	return &NullableInlineObject1180{value: val, isSet: true}
}

func (v NullableInlineObject1180) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1180) UnmarshalJSON(src []byte) error {
	v.isSet = true
