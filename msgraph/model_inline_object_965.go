...
func (o *InlineObject965) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject965) SetSendResponseNil() {
...
type NullableInlineObject965 struct {
	value *InlineObject965
	isSet bool
}

func (v NullableInlineObject965) Get() *InlineObject965 {
	return v.value
}

func (v *NullableInlineObject965) Set(val *InlineObject965) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject965) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject965) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject965(val *InlineObject965) *NullableInlineObject965 {
	return &NullableInlineObject965{value: val, isSet: true}
}

func (v NullableInlineObject965) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject965) UnmarshalJSON(src []byte) error {
	v.isSet = true
