...
func (o *InlineObject777) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject777) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject777) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject777) SetSiteCollectionIdNil() {
...
func (o *InlineObject777) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject777) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject777 struct {
	value *InlineObject777
	isSet bool
}

func (v NullableInlineObject777) Get() *InlineObject777 {
	return v.value
}

func (v *NullableInlineObject777) Set(val *InlineObject777) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject777) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject777) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject777(val *InlineObject777) *NullableInlineObject777 {
	return &NullableInlineObject777{value: val, isSet: true}
}

func (v NullableInlineObject777) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject777) UnmarshalJSON(src []byte) error {
	v.isSet = true
