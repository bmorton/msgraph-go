...
func (o *MicrosoftGraphMailFolder) SetChildFolderCountNil() {
...
func (o *MicrosoftGraphMailFolder) SetDisplayNameNil() {
...
func (o *MicrosoftGraphMailFolder) SetIsHiddenNil() {
	o.IsHidden.Set(nil)
}
...
func (o *MicrosoftGraphMailFolder) SetParentFolderIdNil() {
...
func (o *MicrosoftGraphMailFolder) SetTotalItemCountNil() {
...
func (o *MicrosoftGraphMailFolder) SetUnreadItemCountNil() {
...
type NullableMicrosoftGraphMailFolder struct {
	value *MicrosoftGraphMailFolder
	isSet bool
}

func (v NullableMicrosoftGraphMailFolder) Get() *MicrosoftGraphMailFolder {
	return v.value
}

func (v *NullableMicrosoftGraphMailFolder) Set(val *MicrosoftGraphMailFolder) {
	v.value = val
	v.isSet = true
}

func (v NullableMicrosoftGraphMailFolder) IsSet() bool {
	return v.isSet
}

func (v *NullableMicrosoftGraphMailFolder) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMicrosoftGraphMailFolder(val *MicrosoftGraphMailFolder) *NullableMicrosoftGraphMailFolder {
	return &NullableMicrosoftGraphMailFolder{value: val, isSet: true}
}

func (v NullableMicrosoftGraphMailFolder) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMicrosoftGraphMailFolder) UnmarshalJSON(src []byte) error {
	v.isSet = true
