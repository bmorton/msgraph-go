...
func (o *InlineObject396) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject396) SetSendResponseNil() {
...
func (o InlineObject396) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject396 struct {
	value *InlineObject396
	isSet bool
}

func (v NullableInlineObject396) Get() *InlineObject396 {
	return v.value
}

func (v *NullableInlineObject396) Set(val *InlineObject396) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject396) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject396) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject396(val *InlineObject396) *NullableInlineObject396 {
	return &NullableInlineObject396{value: val, isSet: true}
}

func (v NullableInlineObject396) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject396) UnmarshalJSON(src []byte) error {
	v.isSet = true
