...
// GetDeviceComplianceScheduledActionForRules returns the DeviceComplianceScheduledActionForRules field value if set, zero value otherwise.
...
// GetDeviceComplianceScheduledActionForRulesOk returns a tuple with the DeviceComplianceScheduledActionForRules field value if set, nil otherwise
