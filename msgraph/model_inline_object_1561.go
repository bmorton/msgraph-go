...
// InlineObject1561 struct for InlineObject1561
type InlineObject1561 struct {
...
func (o InlineObject1561) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1561 struct {
	value *InlineObject1561
	isSet bool
}

func (v NullableInlineObject1561) Get() *InlineObject1561 {
	return v.value
}

func (v *NullableInlineObject1561) Set(val *InlineObject1561) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1561) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1561) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1561(val *InlineObject1561) *NullableInlineObject1561 {
	return &NullableInlineObject1561{value: val, isSet: true}
}

func (v NullableInlineObject1561) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1561) UnmarshalJSON(src []byte) error {
	v.isSet = true
