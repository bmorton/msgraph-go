...
// InlineObject646 struct for InlineObject646
type InlineObject646 struct {
...
func (o *InlineObject646) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject646) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject646) SetNotebookFolderNil() {
...
func (o *InlineObject646) SetSiteCollectionIdNil() {
...
func (o *InlineObject646) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject646) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject646 struct {
	value *InlineObject646
	isSet bool
}

func (v NullableInlineObject646) Get() *InlineObject646 {
	return v.value
}

func (v *NullableInlineObject646) Set(val *InlineObject646) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject646) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject646) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject646(val *InlineObject646) *NullableInlineObject646 {
	return &NullableInlineObject646{value: val, isSet: true}
}

func (v NullableInlineObject646) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject646) UnmarshalJSON(src []byte) error {
	v.isSet = true
