...
func (o *InlineObject1155) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1155) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1155) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1155) SetSiteCollectionIdNil() {
...
func (o *InlineObject1155) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1155) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1155 struct {
	value *InlineObject1155
	isSet bool
}

func (v NullableInlineObject1155) Get() *InlineObject1155 {
	return v.value
}

func (v *NullableInlineObject1155) Set(val *InlineObject1155) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1155) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1155) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1155(val *InlineObject1155) *NullableInlineObject1155 {
	return &NullableInlineObject1155{value: val, isSet: true}
}

func (v NullableInlineObject1155) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1155) UnmarshalJSON(src []byte) error {
	v.isSet = true
