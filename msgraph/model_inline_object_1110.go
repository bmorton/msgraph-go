...
func (o *InlineObject1110) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1110) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1110) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1110) SetSiteCollectionIdNil() {
...
func (o *InlineObject1110) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1110) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1110 struct {
	value *InlineObject1110
	isSet bool
}

func (v NullableInlineObject1110) Get() *InlineObject1110 {
	return v.value
}

func (v *NullableInlineObject1110) Set(val *InlineObject1110) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1110) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1110) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1110(val *InlineObject1110) *NullableInlineObject1110 {
	return &NullableInlineObject1110{value: val, isSet: true}
}

func (v NullableInlineObject1110) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1110) UnmarshalJSON(src []byte) error {
	v.isSet = true
