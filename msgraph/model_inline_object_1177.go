...
func (o *InlineObject1177) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1177) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1177) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1177) SetSiteCollectionIdNil() {
...
func (o *InlineObject1177) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1177) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1177 struct {
	value *InlineObject1177
	isSet bool
}

func (v NullableInlineObject1177) Get() *InlineObject1177 {
	return v.value
}

func (v *NullableInlineObject1177) Set(val *InlineObject1177) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1177) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1177) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1177(val *InlineObject1177) *NullableInlineObject1177 {
	return &NullableInlineObject1177{value: val, isSet: true}
}

func (v NullableInlineObject1177) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1177) UnmarshalJSON(src []byte) error {
	v.isSet = true
