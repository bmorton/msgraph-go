...
// InlineObject488 struct for InlineObject488
type InlineObject488 struct {
...
func (o *InlineObject488) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject488) SetSendResponseNil() {
...
func (o InlineObject488) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject488 struct {
	value *InlineObject488
	isSet bool
}

func (v NullableInlineObject488) Get() *InlineObject488 {
	return v.value
}

func (v *NullableInlineObject488) Set(val *InlineObject488) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject488) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject488) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject488(val *InlineObject488) *NullableInlineObject488 {
	return &NullableInlineObject488{value: val, isSet: true}
}

func (v NullableInlineObject488) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject488) UnmarshalJSON(src []byte) error {
	v.isSet = true
