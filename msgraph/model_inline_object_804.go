...
func (o *InlineObject804) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject804) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject804) SetNotebookFolderNil() {
...
func (o *InlineObject804) SetSiteCollectionIdNil() {
...
func (o *InlineObject804) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject804 struct {
	value *InlineObject804
	isSet bool
}

func (v NullableInlineObject804) Get() *InlineObject804 {
	return v.value
}

func (v *NullableInlineObject804) Set(val *InlineObject804) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject804) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject804) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject804(val *InlineObject804) *NullableInlineObject804 {
	return &NullableInlineObject804{value: val, isSet: true}
}

func (v NullableInlineObject804) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject804) UnmarshalJSON(src []byte) error {
	v.isSet = true
