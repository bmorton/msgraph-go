...
func (o *InlineObject1151) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1151) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1151) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1151) SetSiteCollectionIdNil() {
...
func (o *InlineObject1151) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1151) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1151 struct {
	value *InlineObject1151
	isSet bool
}

func (v NullableInlineObject1151) Get() *InlineObject1151 {
	return v.value
}

func (v *NullableInlineObject1151) Set(val *InlineObject1151) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1151) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1151) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1151(val *InlineObject1151) *NullableInlineObject1151 {
	return &NullableInlineObject1151{value: val, isSet: true}
}

func (v NullableInlineObject1151) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1151) UnmarshalJSON(src []byte) error {
	v.isSet = true
