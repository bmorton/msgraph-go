...
func (o *InlineObject952) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject952) SetSendResponseNil() {
...
func (o InlineObject952) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject952 struct {
	value *InlineObject952
	isSet bool
}

func (v NullableInlineObject952) Get() *InlineObject952 {
	return v.value
}

func (v *NullableInlineObject952) Set(val *InlineObject952) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject952) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject952) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject952(val *InlineObject952) *NullableInlineObject952 {
	return &NullableInlineObject952{value: val, isSet: true}
}

func (v NullableInlineObject952) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject952) UnmarshalJSON(src []byte) error {
	v.isSet = true
