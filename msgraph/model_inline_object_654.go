...
func (o *InlineObject654) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject654) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject654) SetSiteCollectionIdNil() {
...
func (o *InlineObject654) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject654) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject654 struct {
	value *InlineObject654
	isSet bool
}

func (v NullableInlineObject654) Get() *InlineObject654 {
	return v.value
}

func (v *NullableInlineObject654) Set(val *InlineObject654) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject654) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject654) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject654(val *InlineObject654) *NullableInlineObject654 {
	return &NullableInlineObject654{value: val, isSet: true}
}

func (v NullableInlineObject654) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject654) UnmarshalJSON(src []byte) error {
	v.isSet = true
