...
func (o InlineObject1298) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1298 struct {
	value *InlineObject1298
	isSet bool
}

func (v NullableInlineObject1298) Get() *InlineObject1298 {
	return v.value
}

func (v *NullableInlineObject1298) Set(val *InlineObject1298) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1298) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1298) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1298(val *InlineObject1298) *NullableInlineObject1298 {
	return &NullableInlineObject1298{value: val, isSet: true}
}

func (v NullableInlineObject1298) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1298) UnmarshalJSON(src []byte) error {
	v.isSet = true
