...
func (o *InlineObject415) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject415) SetSendResponseNil() {
...
func (o InlineObject415) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject415 struct {
	value *InlineObject415
	isSet bool
}

func (v NullableInlineObject415) Get() *InlineObject415 {
	return v.value
}

func (v *NullableInlineObject415) Set(val *InlineObject415) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject415) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject415) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject415(val *InlineObject415) *NullableInlineObject415 {
	return &NullableInlineObject415{value: val, isSet: true}
}

func (v NullableInlineObject415) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject415) UnmarshalJSON(src []byte) error {
	v.isSet = true
