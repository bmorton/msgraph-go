...
func (o *InlineObject781) HasGroupId() bool {
...
func (o *InlineObject781) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject781) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject781) GetNotebookFolderOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject781) SetNotebookFolderNil() {
...
func (o *InlineObject781) SetSiteCollectionIdNil() {
...
func (o *InlineObject781) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject781 struct {
	value *InlineObject781
	isSet bool
}

func (v NullableInlineObject781) Get() *InlineObject781 {
	return v.value
}

func (v *NullableInlineObject781) Set(val *InlineObject781) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject781) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject781) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject781(val *InlineObject781) *NullableInlineObject781 {
	return &NullableInlineObject781{value: val, isSet: true}
}

func (v NullableInlineObject781) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject781) UnmarshalJSON(src []byte) error {
	v.isSet = true
