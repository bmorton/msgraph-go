...
// InlineObject613 struct for InlineObject613
type InlineObject613 struct {
...
func (o *InlineObject613) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject613) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject613) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject613) SetSiteCollectionIdNil() {
...
func (o *InlineObject613) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject613) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject613 struct {
	value *InlineObject613
	isSet bool
}

func (v NullableInlineObject613) Get() *InlineObject613 {
	return v.value
}

func (v *NullableInlineObject613) Set(val *InlineObject613) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject613) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject613) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject613(val *InlineObject613) *NullableInlineObject613 {
	return &NullableInlineObject613{value: val, isSet: true}
}

func (v NullableInlineObject613) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject613) UnmarshalJSON(src []byte) error {
	v.isSet = true
