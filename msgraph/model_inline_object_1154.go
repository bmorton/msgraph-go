...
// InlineObject1154 struct for InlineObject1154
type InlineObject1154 struct {
...
func (o *InlineObject1154) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1154) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1154) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1154) SetSiteCollectionIdNil() {
...
func (o *InlineObject1154) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1154) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1154 struct {
	value *InlineObject1154
	isSet bool
}

func (v NullableInlineObject1154) Get() *InlineObject1154 {
	return v.value
}

func (v *NullableInlineObject1154) Set(val *InlineObject1154) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1154) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1154) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1154(val *InlineObject1154) *NullableInlineObject1154 {
	return &NullableInlineObject1154{value: val, isSet: true}
}

func (v NullableInlineObject1154) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1154) UnmarshalJSON(src []byte) error {
	v.isSet = true
