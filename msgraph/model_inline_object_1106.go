...
func (o *InlineObject1106) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1106) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1106) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1106) SetSiteCollectionIdNil() {
...
func (o *InlineObject1106) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1106) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1106 struct {
	value *InlineObject1106
	isSet bool
}

func (v NullableInlineObject1106) Get() *InlineObject1106 {
	return v.value
}

func (v *NullableInlineObject1106) Set(val *InlineObject1106) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1106) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1106) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1106(val *InlineObject1106) *NullableInlineObject1106 {
	return &NullableInlineObject1106{value: val, isSet: true}
}

func (v NullableInlineObject1106) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1106) UnmarshalJSON(src []byte) error {
	v.isSet = true
