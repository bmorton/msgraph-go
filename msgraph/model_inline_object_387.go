...
// InlineObject387 struct for InlineObject387
type InlineObject387 struct {
...
func (o *InlineObject387) SetAvailabilityViewIntervalNil() {
...
func (o InlineObject387) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject387 struct {
	value *InlineObject387
	isSet bool
}

func (v NullableInlineObject387) Get() *InlineObject387 {
	return v.value
}

func (v *NullableInlineObject387) Set(val *InlineObject387) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject387) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject387) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject387(val *InlineObject387) *NullableInlineObject387 {
	return &NullableInlineObject387{value: val, isSet: true}
}

func (v NullableInlineObject387) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject387) UnmarshalJSON(src []byte) error {
	v.isSet = true
