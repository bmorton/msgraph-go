...
func (o *InlineObject1161) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1161) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1161) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1161) SetSiteCollectionIdNil() {
...
func (o *InlineObject1161) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1161) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1161 struct {
	value *InlineObject1161
	isSet bool
}

func (v NullableInlineObject1161) Get() *InlineObject1161 {
	return v.value
}

func (v *NullableInlineObject1161) Set(val *InlineObject1161) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1161) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1161) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1161(val *InlineObject1161) *NullableInlineObject1161 {
	return &NullableInlineObject1161{value: val, isSet: true}
}

func (v NullableInlineObject1161) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1161) UnmarshalJSON(src []byte) error {
	v.isSet = true
