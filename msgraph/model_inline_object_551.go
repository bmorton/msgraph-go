...
// InlineObject551 struct for InlineObject551
type InlineObject551 struct {
...
func (o InlineObject551) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject551 struct {
	value *InlineObject551
	isSet bool
}

func (v NullableInlineObject551) Get() *InlineObject551 {
	return v.value
}

func (v *NullableInlineObject551) Set(val *InlineObject551) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject551) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject551) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject551(val *InlineObject551) *NullableInlineObject551 {
	return &NullableInlineObject551{value: val, isSet: true}
}

func (v NullableInlineObject551) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject551) UnmarshalJSON(src []byte) error {
	v.isSet = true
