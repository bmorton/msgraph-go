...
func (o *InlineObject251) HasGroupId() bool {
...
func (o *InlineObject251) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject251) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject251) GetNotebookFolderOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject251) SetNotebookFolderNil() {
...
func (o *InlineObject251) SetSiteCollectionIdNil() {
...
func (o *InlineObject251) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
