...
// InlineObject475 struct for InlineObject475
type InlineObject475 struct {
...
func (o *InlineObject475) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject475) SetSendResponseNil() {
...
func (o InlineObject475) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject475 struct {
	value *InlineObject475
	isSet bool
}

func (v NullableInlineObject475) Get() *InlineObject475 {
	return v.value
}

func (v *NullableInlineObject475) Set(val *InlineObject475) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject475) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject475) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject475(val *InlineObject475) *NullableInlineObject475 {
	return &NullableInlineObject475{value: val, isSet: true}
}

func (v NullableInlineObject475) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject475) UnmarshalJSON(src []byte) error {
	v.isSet = true
