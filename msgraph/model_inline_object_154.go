...
func (o *InlineObject154) GetToRecipients() []*AnyOfmicrosoftGraphRecipient {
...
func (o *InlineObject154) GetToRecipientsOk() (*[]*AnyOfmicrosoftGraphRecipient, bool) {
	if o == nil || o.ToRecipients == nil {
		return nil, false
	}
...
func (o *InlineObject154) HasToRecipients() bool {
	if o != nil && o.ToRecipients != nil {
		return true
	}
...
func (o *InlineObject154) SetToRecipients(v []*AnyOfmicrosoftGraphRecipient) {
	o.ToRecipients = &v
}

// GetComment returns the Comment field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *InlineObject154) GetComment() string {
...
func (o *InlineObject154) GetCommentOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject154) HasComment() bool {
...
func (o *InlineObject154) SetComment(v string) {
	o.Comment.Set(&v)
}
// SetCommentNil sets the value for Comment to be an explicit nil
func (o *InlineObject154) SetCommentNil() {
	o.Comment.Set(nil)
}

// UnsetComment ensures that no value is present for Comment, not even an explicit nil
func (o *InlineObject154) UnsetComment() {
	o.Comment.Unset()
}
