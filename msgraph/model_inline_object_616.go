...
// InlineObject616 struct for InlineObject616
type InlineObject616 struct {
...
func (o *InlineObject616) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject616) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject616) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject616) SetSiteCollectionIdNil() {
...
func (o *InlineObject616) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject616) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject616 struct {
	value *InlineObject616
	isSet bool
}

func (v NullableInlineObject616) Get() *InlineObject616 {
	return v.value
}

func (v *NullableInlineObject616) Set(val *InlineObject616) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject616) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject616) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject616(val *InlineObject616) *NullableInlineObject616 {
	return &NullableInlineObject616{value: val, isSet: true}
}

func (v NullableInlineObject616) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject616) UnmarshalJSON(src []byte) error {
	v.isSet = true
