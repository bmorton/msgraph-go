...
func (o *InlineObject1182) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject1182) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1182) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject1182) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject1182) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1182) SetSiteCollectionIdNil() {
...
func (o *InlineObject1182) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1182) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1182 struct {
	value *InlineObject1182
	isSet bool
}

func (v NullableInlineObject1182) Get() *InlineObject1182 {
	return v.value
}

func (v *NullableInlineObject1182) Set(val *InlineObject1182) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1182) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1182) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1182(val *InlineObject1182) *NullableInlineObject1182 {
	return &NullableInlineObject1182{value: val, isSet: true}
}

func (v NullableInlineObject1182) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1182) UnmarshalJSON(src []byte) error {
	v.isSet = true
