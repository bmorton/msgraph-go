...
func (o *InlineObject978) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject978) SetSendResponseNil() {
...
type NullableInlineObject978 struct {
	value *InlineObject978
	isSet bool
}

func (v NullableInlineObject978) Get() *InlineObject978 {
	return v.value
}

func (v *NullableInlineObject978) Set(val *InlineObject978) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject978) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject978) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject978(val *InlineObject978) *NullableInlineObject978 {
	return &NullableInlineObject978{value: val, isSet: true}
}

func (v NullableInlineObject978) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject978) UnmarshalJSON(src []byte) error {
	v.isSet = true
