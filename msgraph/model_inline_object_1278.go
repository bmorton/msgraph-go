...
// InlineObject1278 struct for InlineObject1278
type InlineObject1278 struct {
...
func (o InlineObject1278) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1278 struct {
	value *InlineObject1278
	isSet bool
}

func (v NullableInlineObject1278) Get() *InlineObject1278 {
	return v.value
}

func (v *NullableInlineObject1278) Set(val *InlineObject1278) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1278) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1278) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1278(val *InlineObject1278) *NullableInlineObject1278 {
	return &NullableInlineObject1278{value: val, isSet: true}
}

func (v NullableInlineObject1278) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1278) UnmarshalJSON(src []byte) error {
	v.isSet = true
