...
func (o *InlineObject889) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject889) SetSendResponseNil() {
...
func (o InlineObject889) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject889 struct {
	value *InlineObject889
	isSet bool
}

func (v NullableInlineObject889) Get() *InlineObject889 {
	return v.value
}

func (v *NullableInlineObject889) Set(val *InlineObject889) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject889) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject889) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject889(val *InlineObject889) *NullableInlineObject889 {
	return &NullableInlineObject889{value: val, isSet: true}
}

func (v NullableInlineObject889) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject889) UnmarshalJSON(src []byte) error {
	v.isSet = true
