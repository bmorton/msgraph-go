...
func (o *InlineObject1137) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1137) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1137) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1137) SetSiteCollectionIdNil() {
...
func (o *InlineObject1137) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1137) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1137 struct {
	value *InlineObject1137
	isSet bool
}

func (v NullableInlineObject1137) Get() *InlineObject1137 {
	return v.value
}

func (v *NullableInlineObject1137) Set(val *InlineObject1137) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1137) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1137) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1137(val *InlineObject1137) *NullableInlineObject1137 {
	return &NullableInlineObject1137{value: val, isSet: true}
}

func (v NullableInlineObject1137) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1137) UnmarshalJSON(src []byte) error {
	v.isSet = true
