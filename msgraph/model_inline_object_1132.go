...
func (o *InlineObject1132) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1132) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1132) SetSiteCollectionIdNil() {
...
func (o *InlineObject1132) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject1132 struct {
	value *InlineObject1132
	isSet bool
}

func (v NullableInlineObject1132) Get() *InlineObject1132 {
	return v.value
}

func (v *NullableInlineObject1132) Set(val *InlineObject1132) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1132) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1132) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1132(val *InlineObject1132) *NullableInlineObject1132 {
	return &NullableInlineObject1132{value: val, isSet: true}
}

func (v NullableInlineObject1132) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1132) UnmarshalJSON(src []byte) error {
	v.isSet = true
