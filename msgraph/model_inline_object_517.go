...
// InlineObject517 struct for InlineObject517
type InlineObject517 struct {
...
func (o InlineObject517) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject517 struct {
	value *InlineObject517
	isSet bool
}

func (v NullableInlineObject517) Get() *InlineObject517 {
	return v.value
}

func (v *NullableInlineObject517) Set(val *InlineObject517) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject517) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject517) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject517(val *InlineObject517) *NullableInlineObject517 {
	return &NullableInlineObject517{value: val, isSet: true}
}

func (v NullableInlineObject517) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject517) UnmarshalJSON(src []byte) error {
	v.isSet = true
