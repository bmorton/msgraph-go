...
func (o *InlineObject1131) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1131) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1131) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1131) SetSiteCollectionIdNil() {
...
func (o *InlineObject1131) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject1131 struct {
	value *InlineObject1131
	isSet bool
}

func (v NullableInlineObject1131) Get() *InlineObject1131 {
	return v.value
}

func (v *NullableInlineObject1131) Set(val *InlineObject1131) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1131) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1131) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1131(val *InlineObject1131) *NullableInlineObject1131 {
	return &NullableInlineObject1131{value: val, isSet: true}
}

func (v NullableInlineObject1131) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1131) UnmarshalJSON(src []byte) error {
	v.isSet = true
