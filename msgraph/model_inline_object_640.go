...
func (o *InlineObject640) HasGroupId() bool {
...
func (o *InlineObject640) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject640) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject640) GetNotebookFolderOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject640) SetNotebookFolderNil() {
...
func (o *InlineObject640) SetSiteCollectionIdNil() {
...
func (o *InlineObject640) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject640) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject640 struct {
	value *InlineObject640
	isSet bool
}

func (v NullableInlineObject640) Get() *InlineObject640 {
	return v.value
}

func (v *NullableInlineObject640) Set(val *InlineObject640) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject640) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject640) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject640(val *InlineObject640) *NullableInlineObject640 {
	return &NullableInlineObject640{value: val, isSet: true}
}

func (v NullableInlineObject640) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject640) UnmarshalJSON(src []byte) error {
	v.isSet = true
