...
func (o InlineObject1301) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1301 struct {
	value *InlineObject1301
	isSet bool
}

func (v NullableInlineObject1301) Get() *InlineObject1301 {
	return v.value
}

func (v *NullableInlineObject1301) Set(val *InlineObject1301) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1301) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1301) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1301(val *InlineObject1301) *NullableInlineObject1301 {
	return &NullableInlineObject1301{value: val, isSet: true}
}

func (v NullableInlineObject1301) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1301) UnmarshalJSON(src []byte) error {
	v.isSet = true
