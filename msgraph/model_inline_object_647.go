...
// InlineObject647 struct for InlineObject647
type InlineObject647 struct {
...
func (o *InlineObject647) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject647) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject647) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject647) SetSiteCollectionIdNil() {
...
func (o *InlineObject647) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject647) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject647 struct {
	value *InlineObject647
	isSet bool
}

func (v NullableInlineObject647) Get() *InlineObject647 {
	return v.value
}

func (v *NullableInlineObject647) Set(val *InlineObject647) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject647) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject647) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject647(val *InlineObject647) *NullableInlineObject647 {
	return &NullableInlineObject647{value: val, isSet: true}
}

func (v NullableInlineObject647) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject647) UnmarshalJSON(src []byte) error {
	v.isSet = true
