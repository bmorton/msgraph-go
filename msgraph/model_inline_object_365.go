...
func (o InlineObject365) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject365 struct {
	value *InlineObject365
	isSet bool
}

func (v NullableInlineObject365) Get() *InlineObject365 {
	return v.value
}

func (v *NullableInlineObject365) Set(val *InlineObject365) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject365) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject365) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject365(val *InlineObject365) *NullableInlineObject365 {
	return &NullableInlineObject365{value: val, isSet: true}
}

func (v NullableInlineObject365) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject365) UnmarshalJSON(src []byte) error {
	v.isSet = true
