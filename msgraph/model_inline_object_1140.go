...
// InlineObject1140 struct for InlineObject1140
type InlineObject1140 struct {
...
func (o *InlineObject1140) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1140) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1140) SetNotebookFolderNil() {
...
func (o *InlineObject1140) SetSiteCollectionIdNil() {
...
func (o *InlineObject1140) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1140) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1140 struct {
	value *InlineObject1140
	isSet bool
}

func (v NullableInlineObject1140) Get() *InlineObject1140 {
	return v.value
}

func (v *NullableInlineObject1140) Set(val *InlineObject1140) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1140) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1140) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1140(val *InlineObject1140) *NullableInlineObject1140 {
	return &NullableInlineObject1140{value: val, isSet: true}
}

func (v NullableInlineObject1140) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1140) UnmarshalJSON(src []byte) error {
	v.isSet = true
