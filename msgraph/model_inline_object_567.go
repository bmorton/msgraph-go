...
func (o *InlineObject567) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o InlineObject567) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject567 struct {
	value *InlineObject567
	isSet bool
}

func (v NullableInlineObject567) Get() *InlineObject567 {
	return v.value
}

func (v *NullableInlineObject567) Set(val *InlineObject567) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject567) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject567) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject567(val *InlineObject567) *NullableInlineObject567 {
	return &NullableInlineObject567{value: val, isSet: true}
}

func (v NullableInlineObject567) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject567) UnmarshalJSON(src []byte) error {
	v.isSet = true
