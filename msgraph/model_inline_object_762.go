...
func (o *InlineObject762) HasGroupId() bool {
...
func (o *InlineObject762) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject762) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject762) GetNotebookFolderOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject762) SetNotebookFolderNil() {
...
func (o *InlineObject762) SetSiteCollectionIdNil() {
...
func (o *InlineObject762) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject762 struct {
	value *InlineObject762
	isSet bool
}

func (v NullableInlineObject762) Get() *InlineObject762 {
	return v.value
}

func (v *NullableInlineObject762) Set(val *InlineObject762) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject762) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject762) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject762(val *InlineObject762) *NullableInlineObject762 {
	return &NullableInlineObject762{value: val, isSet: true}
}

func (v NullableInlineObject762) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject762) UnmarshalJSON(src []byte) error {
	v.isSet = true
