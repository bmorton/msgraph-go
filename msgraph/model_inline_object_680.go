...
func (o *InlineObject680) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject680) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject680) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject680) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject680) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject680) SetSiteCollectionIdNil() {
...
func (o *InlineObject680) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject680) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject680 struct {
	value *InlineObject680
	isSet bool
}

func (v NullableInlineObject680) Get() *InlineObject680 {
	return v.value
}

func (v *NullableInlineObject680) Set(val *InlineObject680) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject680) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject680) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject680(val *InlineObject680) *NullableInlineObject680 {
	return &NullableInlineObject680{value: val, isSet: true}
}

func (v NullableInlineObject680) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject680) UnmarshalJSON(src []byte) error {
	v.isSet = true
