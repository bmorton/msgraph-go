...
func (o *InlineObject892) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject892) SetSendResponseNil() {
...
type NullableInlineObject892 struct {
	value *InlineObject892
	isSet bool
}

func (v NullableInlineObject892) Get() *InlineObject892 {
	return v.value
}

func (v *NullableInlineObject892) Set(val *InlineObject892) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject892) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject892) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject892(val *InlineObject892) *NullableInlineObject892 {
	return &NullableInlineObject892{value: val, isSet: true}
}

func (v NullableInlineObject892) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject892) UnmarshalJSON(src []byte) error {
	v.isSet = true
