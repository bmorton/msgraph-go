...
func (o *InlineObject364) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o InlineObject364) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject364 struct {
	value *InlineObject364
	isSet bool
}

func (v NullableInlineObject364) Get() *InlineObject364 {
	return v.value
}

func (v *NullableInlineObject364) Set(val *InlineObject364) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject364) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject364) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject364(val *InlineObject364) *NullableInlineObject364 {
	return &NullableInlineObject364{value: val, isSet: true}
}

func (v NullableInlineObject364) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject364) UnmarshalJSON(src []byte) error {
	v.isSet = true
