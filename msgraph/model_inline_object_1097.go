...
// InlineObject1097 struct for InlineObject1097
type InlineObject1097 struct {
...
func (o *InlineObject1097) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1097) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1097) SetNotebookFolderNil() {
...
func (o *InlineObject1097) SetSiteCollectionIdNil() {
...
func (o *InlineObject1097) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1097) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1097 struct {
	value *InlineObject1097
	isSet bool
}

func (v NullableInlineObject1097) Get() *InlineObject1097 {
	return v.value
}

func (v *NullableInlineObject1097) Set(val *InlineObject1097) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1097) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1097) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1097(val *InlineObject1097) *NullableInlineObject1097 {
	return &NullableInlineObject1097{value: val, isSet: true}
}

func (v NullableInlineObject1097) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1097) UnmarshalJSON(src []byte) error {
	v.isSet = true
