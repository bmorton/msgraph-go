...
func (o *InlineObject747) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject747) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject747) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject747) SetSiteCollectionIdNil() {
...
func (o *InlineObject747) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject747 struct {
	value *InlineObject747
	isSet bool
}

func (v NullableInlineObject747) Get() *InlineObject747 {
	return v.value
}

func (v *NullableInlineObject747) Set(val *InlineObject747) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject747) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject747) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject747(val *InlineObject747) *NullableInlineObject747 {
	return &NullableInlineObject747{value: val, isSet: true}
}

func (v NullableInlineObject747) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject747) UnmarshalJSON(src []byte) error {
	v.isSet = true
