...
func (o *InlineObject659) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject659) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject659) SetNotebookFolderNil() {
...
func (o *InlineObject659) SetSiteCollectionIdNil() {
...
func (o *InlineObject659) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject659) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject659 struct {
	value *InlineObject659
	isSet bool
}

func (v NullableInlineObject659) Get() *InlineObject659 {
	return v.value
}

func (v *NullableInlineObject659) Set(val *InlineObject659) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject659) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject659) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject659(val *InlineObject659) *NullableInlineObject659 {
	return &NullableInlineObject659{value: val, isSet: true}
}

func (v NullableInlineObject659) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject659) UnmarshalJSON(src []byte) error {
	v.isSet = true
