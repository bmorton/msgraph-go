...
func (o *InlineObject1144) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1144) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1144) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1144) SetSiteCollectionIdNil() {
...
func (o *InlineObject1144) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1144) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1144 struct {
	value *InlineObject1144
	isSet bool
}

func (v NullableInlineObject1144) Get() *InlineObject1144 {
	return v.value
}

func (v *NullableInlineObject1144) Set(val *InlineObject1144) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1144) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1144) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1144(val *InlineObject1144) *NullableInlineObject1144 {
	return &NullableInlineObject1144{value: val, isSet: true}
}

func (v NullableInlineObject1144) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1144) UnmarshalJSON(src []byte) error {
	v.isSet = true
