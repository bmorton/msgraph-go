...
func (o *InlineObject683) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject683) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject683) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject683) SetSiteCollectionIdNil() {
...
func (o *InlineObject683) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject683) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject683 struct {
	value *InlineObject683
	isSet bool
}

func (v NullableInlineObject683) Get() *InlineObject683 {
	return v.value
}

func (v *NullableInlineObject683) Set(val *InlineObject683) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject683) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject683) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject683(val *InlineObject683) *NullableInlineObject683 {
	return &NullableInlineObject683{value: val, isSet: true}
}

func (v NullableInlineObject683) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject683) UnmarshalJSON(src []byte) error {
	v.isSet = true
