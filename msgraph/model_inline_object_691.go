...
// InlineObject691 struct for InlineObject691
type InlineObject691 struct {
...
func (o *InlineObject691) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject691) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject691) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject691) SetSiteCollectionIdNil() {
...
func (o *InlineObject691) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject691) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject691 struct {
	value *InlineObject691
	isSet bool
}

func (v NullableInlineObject691) Get() *InlineObject691 {
	return v.value
}

func (v *NullableInlineObject691) Set(val *InlineObject691) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject691) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject691) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject691(val *InlineObject691) *NullableInlineObject691 {
	return &NullableInlineObject691{value: val, isSet: true}
}

func (v NullableInlineObject691) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject691) UnmarshalJSON(src []byte) error {
	v.isSet = true
