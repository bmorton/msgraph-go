...
func (o *InlineObject611) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject611) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject611) SetNotebookFolderNil() {
...
func (o *InlineObject611) SetSiteCollectionIdNil() {
...
func (o *InlineObject611) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject611) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject611 struct {
	value *InlineObject611
	isSet bool
}

func (v NullableInlineObject611) Get() *InlineObject611 {
	return v.value
}

func (v *NullableInlineObject611) Set(val *InlineObject611) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject611) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject611) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject611(val *InlineObject611) *NullableInlineObject611 {
	return &NullableInlineObject611{value: val, isSet: true}
}

func (v NullableInlineObject611) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject611) UnmarshalJSON(src []byte) error {
	v.isSet = true
