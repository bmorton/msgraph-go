...
func (o *InlineObject754) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject754) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject754) SetNotebookFolderNil() {
...
func (o *InlineObject754) SetSiteCollectionIdNil() {
...
func (o *InlineObject754) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject754) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject754 struct {
	value *InlineObject754
	isSet bool
}

func (v NullableInlineObject754) Get() *InlineObject754 {
	return v.value
}

func (v *NullableInlineObject754) Set(val *InlineObject754) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject754) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject754) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject754(val *InlineObject754) *NullableInlineObject754 {
	return &NullableInlineObject754{value: val, isSet: true}
}

func (v NullableInlineObject754) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject754) UnmarshalJSON(src []byte) error {
	v.isSet = true
