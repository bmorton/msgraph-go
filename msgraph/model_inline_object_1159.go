...
func (o *InlineObject1159) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1159) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1159) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1159) SetSiteCollectionIdNil() {
...
func (o *InlineObject1159) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject1159 struct {
	value *InlineObject1159
	isSet bool
}

func (v NullableInlineObject1159) Get() *InlineObject1159 {
	return v.value
}

func (v *NullableInlineObject1159) Set(val *InlineObject1159) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1159) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1159) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1159(val *InlineObject1159) *NullableInlineObject1159 {
	return &NullableInlineObject1159{value: val, isSet: true}
}

func (v NullableInlineObject1159) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1159) UnmarshalJSON(src []byte) error {
	v.isSet = true
