...
// InlineObject584 struct for InlineObject584
type InlineObject584 struct {
...
func (o *InlineObject584) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o InlineObject584) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject584 struct {
	value *InlineObject584
	isSet bool
}

func (v NullableInlineObject584) Get() *InlineObject584 {
	return v.value
}

func (v *NullableInlineObject584) Set(val *InlineObject584) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject584) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject584) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject584(val *InlineObject584) *NullableInlineObject584 {
	return &NullableInlineObject584{value: val, isSet: true}
}

func (v NullableInlineObject584) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject584) UnmarshalJSON(src []byte) error {
	v.isSet = true
