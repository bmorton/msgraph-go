...
func (o *InlineObject1130) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1130) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1130) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1130) SetSiteCollectionIdNil() {
...
func (o *InlineObject1130) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject1130 struct {
	value *InlineObject1130
	isSet bool
}

func (v NullableInlineObject1130) Get() *InlineObject1130 {
	return v.value
}

func (v *NullableInlineObject1130) Set(val *InlineObject1130) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1130) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1130) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1130(val *InlineObject1130) *NullableInlineObject1130 {
	return &NullableInlineObject1130{value: val, isSet: true}
}

func (v NullableInlineObject1130) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1130) UnmarshalJSON(src []byte) error {
	v.isSet = true
