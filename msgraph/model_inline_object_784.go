...
func (o *InlineObject784) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject784) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject784) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject784) SetSiteCollectionIdNil() {
...
func (o *InlineObject784) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject784 struct {
	value *InlineObject784
	isSet bool
}

func (v NullableInlineObject784) Get() *InlineObject784 {
	return v.value
}

func (v *NullableInlineObject784) Set(val *InlineObject784) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject784) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject784) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject784(val *InlineObject784) *NullableInlineObject784 {
	return &NullableInlineObject784{value: val, isSet: true}
}

func (v NullableInlineObject784) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject784) UnmarshalJSON(src []byte) error {
	v.isSet = true
