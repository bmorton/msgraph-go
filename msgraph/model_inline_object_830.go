...
func (o *InlineObject830) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject830) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject830) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject830) SetSiteCollectionIdNil() {
...
func (o *InlineObject830) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject830 struct {
	value *InlineObject830
	isSet bool
}

func (v NullableInlineObject830) Get() *InlineObject830 {
	return v.value
}

func (v *NullableInlineObject830) Set(val *InlineObject830) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject830) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject830) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject830(val *InlineObject830) *NullableInlineObject830 {
	return &NullableInlineObject830{value: val, isSet: true}
}

func (v NullableInlineObject830) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject830) UnmarshalJSON(src []byte) error {
	v.isSet = true
