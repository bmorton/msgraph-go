...
// InlineObject614 struct for InlineObject614
type InlineObject614 struct {
...
func (o *InlineObject614) HasGroupId() bool {
...
func (o *InlineObject614) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject614) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject614) GetNotebookFolderOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject614) SetNotebookFolderNil() {
...
func (o *InlineObject614) SetSiteCollectionIdNil() {
...
func (o *InlineObject614) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject614) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject614 struct {
	value *InlineObject614
	isSet bool
}

func (v NullableInlineObject614) Get() *InlineObject614 {
	return v.value
}

func (v *NullableInlineObject614) Set(val *InlineObject614) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject614) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject614) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject614(val *InlineObject614) *NullableInlineObject614 {
	return &NullableInlineObject614{value: val, isSet: true}
}

func (v NullableInlineObject614) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject614) UnmarshalJSON(src []byte) error {
	v.isSet = true
