...
func (o *InlineObject972) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject972) SetSendResponseNil() {
...
type NullableInlineObject972 struct {
	value *InlineObject972
	isSet bool
}

func (v NullableInlineObject972) Get() *InlineObject972 {
	return v.value
}

func (v *NullableInlineObject972) Set(val *InlineObject972) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject972) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject972) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject972(val *InlineObject972) *NullableInlineObject972 {
	return &NullableInlineObject972{value: val, isSet: true}
}

func (v NullableInlineObject972) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject972) UnmarshalJSON(src []byte) error {
	v.isSet = true
