...
// InlineObject536 struct for InlineObject536
type InlineObject536 struct {
...
func (o InlineObject536) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject536 struct {
	value *InlineObject536
	isSet bool
}

func (v NullableInlineObject536) Get() *InlineObject536 {
	return v.value
}

func (v *NullableInlineObject536) Set(val *InlineObject536) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject536) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject536) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject536(val *InlineObject536) *NullableInlineObject536 {
	return &NullableInlineObject536{value: val, isSet: true}
}

func (v NullableInlineObject536) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject536) UnmarshalJSON(src []byte) error {
	v.isSet = true
