...
func (o InlineObject1052) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1052 struct {
	value *InlineObject1052
	isSet bool
}

func (v NullableInlineObject1052) Get() *InlineObject1052 {
	return v.value
}

func (v *NullableInlineObject1052) Set(val *InlineObject1052) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1052) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1052) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1052(val *InlineObject1052) *NullableInlineObject1052 {
	return &NullableInlineObject1052{value: val, isSet: true}
}

func (v NullableInlineObject1052) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1052) UnmarshalJSON(src []byte) error {
	v.isSet = true
