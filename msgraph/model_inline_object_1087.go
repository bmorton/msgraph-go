...
func (o *InlineObject1087) SetSecurityEnabledOnlyNil() {
...
func (o InlineObject1087) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1087 struct {
	value *InlineObject1087
	isSet bool
}

func (v NullableInlineObject1087) Get() *InlineObject1087 {
	return v.value
}

func (v *NullableInlineObject1087) Set(val *InlineObject1087) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1087) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1087) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1087(val *InlineObject1087) *NullableInlineObject1087 {
	return &NullableInlineObject1087{value: val, isSet: true}
}

func (v NullableInlineObject1087) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1087) UnmarshalJSON(src []byte) error {
	v.isSet = true
