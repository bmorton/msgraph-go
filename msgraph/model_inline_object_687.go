...
// InlineObject687 struct for InlineObject687
type InlineObject687 struct {
...
func (o *InlineObject687) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject687) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject687) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject687) SetSiteCollectionIdNil() {
...
func (o *InlineObject687) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject687) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject687 struct {
	value *InlineObject687
	isSet bool
}

func (v NullableInlineObject687) Get() *InlineObject687 {
	return v.value
}

func (v *NullableInlineObject687) Set(val *InlineObject687) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject687) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject687) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject687(val *InlineObject687) *NullableInlineObject687 {
	return &NullableInlineObject687{value: val, isSet: true}
}

func (v NullableInlineObject687) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject687) UnmarshalJSON(src []byte) error {
	v.isSet = true
