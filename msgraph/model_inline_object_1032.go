...
func (o InlineObject1032) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1032 struct {
	value *InlineObject1032
	isSet bool
}

func (v NullableInlineObject1032) Get() *InlineObject1032 {
	return v.value
}

func (v *NullableInlineObject1032) Set(val *InlineObject1032) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1032) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1032) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1032(val *InlineObject1032) *NullableInlineObject1032 {
	return &NullableInlineObject1032{value: val, isSet: true}
}

func (v NullableInlineObject1032) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1032) UnmarshalJSON(src []byte) error {
	v.isSet = true
