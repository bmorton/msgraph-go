...
func NewMicrosoftGraphInviteParticipantsOperation() *MicrosoftGraphInviteParticipantsOperation {
	this := MicrosoftGraphInviteParticipantsOperation{}
	return &this
}
...
func (o *MicrosoftGraphInviteParticipantsOperation) SetClientContextNil() {
...
func (o MicrosoftGraphInviteParticipantsOperation) MarshalJSON() ([]byte, error) {
...
type NullableMicrosoftGraphInviteParticipantsOperation struct {
	value *MicrosoftGraphInviteParticipantsOperation
	isSet bool
}

func (v NullableMicrosoftGraphInviteParticipantsOperation) Get() *MicrosoftGraphInviteParticipantsOperation {
	return v.value
}

func (v *NullableMicrosoftGraphInviteParticipantsOperation) Set(val *MicrosoftGraphInviteParticipantsOperation) {
	v.value = val
	v.isSet = true
}

func (v NullableMicrosoftGraphInviteParticipantsOperation) IsSet() bool {
	return v.isSet
}

func (v *NullableMicrosoftGraphInviteParticipantsOperation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMicrosoftGraphInviteParticipantsOperation(val *MicrosoftGraphInviteParticipantsOperation) *NullableMicrosoftGraphInviteParticipantsOperation {
	return &NullableMicrosoftGraphInviteParticipantsOperation{value: val, isSet: true}
}

func (v NullableMicrosoftGraphInviteParticipantsOperation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMicrosoftGraphInviteParticipantsOperation) UnmarshalJSON(src []byte) error {
	v.isSet = true
