...
type NullableInlineObject977 struct {
	value *InlineObject977
	isSet bool
}

func (v NullableInlineObject977) Get() *InlineObject977 {
	return v.value
}

func (v *NullableInlineObject977) Set(val *InlineObject977) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject977) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject977) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject977(val *InlineObject977) *NullableInlineObject977 {
	return &NullableInlineObject977{value: val, isSet: true}
}

func (v NullableInlineObject977) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject977) UnmarshalJSON(src []byte) error {
	v.isSet = true
