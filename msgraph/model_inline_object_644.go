...
// InlineObject644 struct for InlineObject644
type InlineObject644 struct {
...
func (o *InlineObject644) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject644) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject644) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject644) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject644) SetSiteCollectionIdNil() {
...
func (o *InlineObject644) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject644) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject644 struct {
	value *InlineObject644
	isSet bool
}

func (v NullableInlineObject644) Get() *InlineObject644 {
	return v.value
}

func (v *NullableInlineObject644) Set(val *InlineObject644) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject644) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject644) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject644(val *InlineObject644) *NullableInlineObject644 {
	return &NullableInlineObject644{value: val, isSet: true}
}

func (v NullableInlineObject644) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject644) UnmarshalJSON(src []byte) error {
	v.isSet = true
