...
func (o *InlineObject918) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject918) SetSendResponseNil() {
...
func (o InlineObject918) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject918 struct {
	value *InlineObject918
	isSet bool
}

func (v NullableInlineObject918) Get() *InlineObject918 {
	return v.value
}

func (v *NullableInlineObject918) Set(val *InlineObject918) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject918) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject918) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject918(val *InlineObject918) *NullableInlineObject918 {
	return &NullableInlineObject918{value: val, isSet: true}
}

func (v NullableInlineObject918) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject918) UnmarshalJSON(src []byte) error {
	v.isSet = true
