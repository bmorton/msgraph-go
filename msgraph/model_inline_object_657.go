...
func (o *InlineObject657) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject657) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject657) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject657) SetSiteCollectionIdNil() {
...
func (o *InlineObject657) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject657) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject657 struct {
	value *InlineObject657
	isSet bool
}

func (v NullableInlineObject657) Get() *InlineObject657 {
	return v.value
}

func (v *NullableInlineObject657) Set(val *InlineObject657) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject657) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject657) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject657(val *InlineObject657) *NullableInlineObject657 {
	return &NullableInlineObject657{value: val, isSet: true}
}

func (v NullableInlineObject657) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject657) UnmarshalJSON(src []byte) error {
	v.isSet = true
