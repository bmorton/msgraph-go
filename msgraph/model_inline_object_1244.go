...
func (o InlineObject1244) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1244 struct {
	value *InlineObject1244
	isSet bool
}

func (v NullableInlineObject1244) Get() *InlineObject1244 {
	return v.value
}

func (v *NullableInlineObject1244) Set(val *InlineObject1244) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1244) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1244) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1244(val *InlineObject1244) *NullableInlineObject1244 {
	return &NullableInlineObject1244{value: val, isSet: true}
}

func (v NullableInlineObject1244) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1244) UnmarshalJSON(src []byte) error {
	v.isSet = true
