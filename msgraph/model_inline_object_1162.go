...
func (o *InlineObject1162) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1162) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1162) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1162) SetSiteCollectionIdNil() {
...
func (o *InlineObject1162) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1162) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1162 struct {
	value *InlineObject1162
	isSet bool
}

func (v NullableInlineObject1162) Get() *InlineObject1162 {
	return v.value
}

func (v *NullableInlineObject1162) Set(val *InlineObject1162) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1162) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1162) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1162(val *InlineObject1162) *NullableInlineObject1162 {
	return &NullableInlineObject1162{value: val, isSet: true}
}

func (v NullableInlineObject1162) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1162) UnmarshalJSON(src []byte) error {
	v.isSet = true
