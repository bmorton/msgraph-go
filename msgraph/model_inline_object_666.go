...
// InlineObject666 struct for InlineObject666
type InlineObject666 struct {
...
func (o *InlineObject666) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject666) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject666) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject666) SetSiteCollectionIdNil() {
...
func (o *InlineObject666) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject666) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject666 struct {
	value *InlineObject666
	isSet bool
}

func (v NullableInlineObject666) Get() *InlineObject666 {
	return v.value
}

func (v *NullableInlineObject666) Set(val *InlineObject666) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject666) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject666) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject666(val *InlineObject666) *NullableInlineObject666 {
	return &NullableInlineObject666{value: val, isSet: true}
}

func (v NullableInlineObject666) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject666) UnmarshalJSON(src []byte) error {
	v.isSet = true
