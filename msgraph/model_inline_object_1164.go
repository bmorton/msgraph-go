...
func (o *InlineObject1164) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1164) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1164) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1164) SetSiteCollectionIdNil() {
...
func (o *InlineObject1164) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1164) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1164 struct {
	value *InlineObject1164
	isSet bool
}

func (v NullableInlineObject1164) Get() *InlineObject1164 {
	return v.value
}

func (v *NullableInlineObject1164) Set(val *InlineObject1164) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1164) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1164) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1164(val *InlineObject1164) *NullableInlineObject1164 {
	return &NullableInlineObject1164{value: val, isSet: true}
}

func (v NullableInlineObject1164) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1164) UnmarshalJSON(src []byte) error {
	v.isSet = true
