...
func (o *InlineObject708) SetSecurityEnabledOnlyNil() {
...
func (o InlineObject708) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject708 struct {
	value *InlineObject708
	isSet bool
}

func (v NullableInlineObject708) Get() *InlineObject708 {
	return v.value
}

func (v *NullableInlineObject708) Set(val *InlineObject708) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject708) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject708) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject708(val *InlineObject708) *NullableInlineObject708 {
	return &NullableInlineObject708{value: val, isSet: true}
}

func (v NullableInlineObject708) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject708) UnmarshalJSON(src []byte) error {
	v.isSet = true
