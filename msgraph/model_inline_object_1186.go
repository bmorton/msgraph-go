...
func (o *InlineObject1186) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1186) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1186) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1186) SetSiteCollectionIdNil() {
...
func (o *InlineObject1186) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject1186 struct {
	value *InlineObject1186
	isSet bool
}

func (v NullableInlineObject1186) Get() *InlineObject1186 {
	return v.value
}

func (v *NullableInlineObject1186) Set(val *InlineObject1186) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1186) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1186) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1186(val *InlineObject1186) *NullableInlineObject1186 {
	return &NullableInlineObject1186{value: val, isSet: true}
}

func (v NullableInlineObject1186) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1186) UnmarshalJSON(src []byte) error {
	v.isSet = true
