...
func (o *InlineObject686) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject686) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject686) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject686) SetSiteCollectionIdNil() {
...
func (o *InlineObject686) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject686) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject686 struct {
	value *InlineObject686
	isSet bool
}

func (v NullableInlineObject686) Get() *InlineObject686 {
	return v.value
}

func (v *NullableInlineObject686) Set(val *InlineObject686) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject686) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject686) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject686(val *InlineObject686) *NullableInlineObject686 {
	return &NullableInlineObject686{value: val, isSet: true}
}

func (v NullableInlineObject686) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject686) UnmarshalJSON(src []byte) error {
	v.isSet = true
