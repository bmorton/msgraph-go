...
// InlineObject492 struct for InlineObject492
type InlineObject492 struct {
...
func (o *InlineObject492) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject492) SetSendResponseNil() {
...
func (o InlineObject492) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject492 struct {
	value *InlineObject492
	isSet bool
}

func (v NullableInlineObject492) Get() *InlineObject492 {
	return v.value
}

func (v *NullableInlineObject492) Set(val *InlineObject492) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject492) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject492) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject492(val *InlineObject492) *NullableInlineObject492 {
	return &NullableInlineObject492{value: val, isSet: true}
}

func (v NullableInlineObject492) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject492) UnmarshalJSON(src []byte) error {
	v.isSet = true
