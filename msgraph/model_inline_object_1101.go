...
func (o *InlineObject1101) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject1101) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1101) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject1101) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject1101) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1101) SetSiteCollectionIdNil() {
...
func (o *InlineObject1101) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject1101 struct {
	value *InlineObject1101
	isSet bool
}

func (v NullableInlineObject1101) Get() *InlineObject1101 {
	return v.value
}

func (v *NullableInlineObject1101) Set(val *InlineObject1101) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1101) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1101) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1101(val *InlineObject1101) *NullableInlineObject1101 {
	return &NullableInlineObject1101{value: val, isSet: true}
}

func (v NullableInlineObject1101) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1101) UnmarshalJSON(src []byte) error {
	v.isSet = true
