...
func (o *InlineObject822) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject822) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject822) SetSiteCollectionIdNil() {
...
func (o *InlineObject822) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject822 struct {
	value *InlineObject822
	isSet bool
}

func (v NullableInlineObject822) Get() *InlineObject822 {
	return v.value
}

func (v *NullableInlineObject822) Set(val *InlineObject822) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject822) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject822) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject822(val *InlineObject822) *NullableInlineObject822 {
	return &NullableInlineObject822{value: val, isSet: true}
}

func (v NullableInlineObject822) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject822) UnmarshalJSON(src []byte) error {
	v.isSet = true
