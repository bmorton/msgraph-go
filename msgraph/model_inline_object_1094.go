...
func (o *InlineObject1094) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1094) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1094) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1094) SetSiteCollectionIdNil() {
...
func (o *InlineObject1094) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject1094 struct {
	value *InlineObject1094
	isSet bool
}

func (v NullableInlineObject1094) Get() *InlineObject1094 {
	return v.value
}

func (v *NullableInlineObject1094) Set(val *InlineObject1094) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1094) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1094) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1094(val *InlineObject1094) *NullableInlineObject1094 {
	return &NullableInlineObject1094{value: val, isSet: true}
}

func (v NullableInlineObject1094) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1094) UnmarshalJSON(src []byte) error {
	v.isSet = true
