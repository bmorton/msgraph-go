...
func (o *InlineObject1143) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject1143) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1143) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject1143) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject1143) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1143) SetSiteCollectionIdNil() {
...
func (o *InlineObject1143) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1143) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1143 struct {
	value *InlineObject1143
	isSet bool
}

func (v NullableInlineObject1143) Get() *InlineObject1143 {
	return v.value
}

func (v *NullableInlineObject1143) Set(val *InlineObject1143) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1143) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1143) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1143(val *InlineObject1143) *NullableInlineObject1143 {
	return &NullableInlineObject1143{value: val, isSet: true}
}

func (v NullableInlineObject1143) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1143) UnmarshalJSON(src []byte) error {
	v.isSet = true
