...
func (o *InlineObject670) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject670) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject670) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject670) SetSiteCollectionIdNil() {
...
func (o *InlineObject670) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject670) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject670 struct {
	value *InlineObject670
	isSet bool
}

func (v NullableInlineObject670) Get() *InlineObject670 {
	return v.value
}

func (v *NullableInlineObject670) Set(val *InlineObject670) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject670) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject670) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject670(val *InlineObject670) *NullableInlineObject670 {
	return &NullableInlineObject670{value: val, isSet: true}
}

func (v NullableInlineObject670) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject670) UnmarshalJSON(src []byte) error {
	v.isSet = true
