...
func (o *InlineObject384) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o InlineObject384) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject384 struct {
	value *InlineObject384
	isSet bool
}

func (v NullableInlineObject384) Get() *InlineObject384 {
	return v.value
}

func (v *NullableInlineObject384) Set(val *InlineObject384) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject384) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject384) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject384(val *InlineObject384) *NullableInlineObject384 {
	return &NullableInlineObject384{value: val, isSet: true}
}

func (v NullableInlineObject384) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject384) UnmarshalJSON(src []byte) error {
	v.isSet = true
