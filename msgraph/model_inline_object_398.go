...
func (o *InlineObject398) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject398) SetSendResponseNil() {
...
type NullableInlineObject398 struct {
	value *InlineObject398
	isSet bool
}

func (v NullableInlineObject398) Get() *InlineObject398 {
	return v.value
}

func (v *NullableInlineObject398) Set(val *InlineObject398) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject398) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject398) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject398(val *InlineObject398) *NullableInlineObject398 {
	return &NullableInlineObject398{value: val, isSet: true}
}

func (v NullableInlineObject398) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject398) UnmarshalJSON(src []byte) error {
	v.isSet = true
