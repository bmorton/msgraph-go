...
// InlineObject456 struct for InlineObject456
type InlineObject456 struct {
...
func (o *InlineObject456) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o InlineObject456) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject456 struct {
	value *InlineObject456
	isSet bool
}

func (v NullableInlineObject456) Get() *InlineObject456 {
	return v.value
}

func (v *NullableInlineObject456) Set(val *InlineObject456) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject456) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject456) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject456(val *InlineObject456) *NullableInlineObject456 {
	return &NullableInlineObject456{value: val, isSet: true}
}

func (v NullableInlineObject456) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject456) UnmarshalJSON(src []byte) error {
	v.isSet = true
