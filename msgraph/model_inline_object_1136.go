...
func (o *InlineObject1136) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1136) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1136) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1136) SetSiteCollectionIdNil() {
...
func (o *InlineObject1136) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject1136 struct {
	value *InlineObject1136
	isSet bool
}

func (v NullableInlineObject1136) Get() *InlineObject1136 {
	return v.value
}

func (v *NullableInlineObject1136) Set(val *InlineObject1136) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1136) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1136) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1136(val *InlineObject1136) *NullableInlineObject1136 {
	return &NullableInlineObject1136{value: val, isSet: true}
}

func (v NullableInlineObject1136) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1136) UnmarshalJSON(src []byte) error {
	v.isSet = true
