...
// InlineObject668 struct for InlineObject668
type InlineObject668 struct {
...
func (o *InlineObject668) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject668) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject668) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject668) SetSiteCollectionIdNil() {
...
func (o *InlineObject668) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject668) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject668 struct {
	value *InlineObject668
	isSet bool
}

func (v NullableInlineObject668) Get() *InlineObject668 {
	return v.value
}

func (v *NullableInlineObject668) Set(val *InlineObject668) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject668) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject668) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject668(val *InlineObject668) *NullableInlineObject668 {
	return &NullableInlineObject668{value: val, isSet: true}
}

func (v NullableInlineObject668) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject668) UnmarshalJSON(src []byte) error {
	v.isSet = true
