...
func (o *InlineObject1153) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1153) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1153) SetNotebookFolderNil() {
...
func (o *InlineObject1153) SetSiteCollectionIdNil() {
...
func (o *InlineObject1153) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1153) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1153 struct {
	value *InlineObject1153
	isSet bool
}

func (v NullableInlineObject1153) Get() *InlineObject1153 {
	return v.value
}

func (v *NullableInlineObject1153) Set(val *InlineObject1153) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1153) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1153) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1153(val *InlineObject1153) *NullableInlineObject1153 {
	return &NullableInlineObject1153{value: val, isSet: true}
}

func (v NullableInlineObject1153) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1153) UnmarshalJSON(src []byte) error {
	v.isSet = true
