...
func (o *InlineObject941) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject941) SetSendResponseNil() {
...
type NullableInlineObject941 struct {
	value *InlineObject941
	isSet bool
}

func (v NullableInlineObject941) Get() *InlineObject941 {
	return v.value
}

func (v *NullableInlineObject941) Set(val *InlineObject941) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject941) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject941) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject941(val *InlineObject941) *NullableInlineObject941 {
	return &NullableInlineObject941{value: val, isSet: true}
}

func (v NullableInlineObject941) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject941) UnmarshalJSON(src []byte) error {
	v.isSet = true
