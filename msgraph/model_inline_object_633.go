...
func (o *InlineObject633) HasGroupId() bool {
...
func (o *InlineObject633) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject633) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject633) GetNotebookFolderOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject633) SetNotebookFolderNil() {
...
func (o *InlineObject633) SetSiteCollectionIdNil() {
...
func (o *InlineObject633) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject633) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject633 struct {
	value *InlineObject633
	isSet bool
}

func (v NullableInlineObject633) Get() *InlineObject633 {
	return v.value
}

func (v *NullableInlineObject633) Set(val *InlineObject633) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject633) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject633) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject633(val *InlineObject633) *NullableInlineObject633 {
	return &NullableInlineObject633{value: val, isSet: true}
}

func (v NullableInlineObject633) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject633) UnmarshalJSON(src []byte) error {
	v.isSet = true
