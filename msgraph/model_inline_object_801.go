...
func (o *InlineObject801) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject801) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject801) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject801) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject801) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject801) SetSiteCollectionIdNil() {
...
func (o *InlineObject801) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject801) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject801 struct {
	value *InlineObject801
	isSet bool
}

func (v NullableInlineObject801) Get() *InlineObject801 {
	return v.value
}

func (v *NullableInlineObject801) Set(val *InlineObject801) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject801) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject801) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject801(val *InlineObject801) *NullableInlineObject801 {
	return &NullableInlineObject801{value: val, isSet: true}
}

func (v NullableInlineObject801) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject801) UnmarshalJSON(src []byte) error {
	v.isSet = true
