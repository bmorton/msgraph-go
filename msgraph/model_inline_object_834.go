...
func (o *InlineObject834) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject834) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject834) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject834) SetSiteCollectionIdNil() {
...
func (o *InlineObject834) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject834 struct {
	value *InlineObject834
	isSet bool
}

func (v NullableInlineObject834) Get() *InlineObject834 {
	return v.value
}

func (v *NullableInlineObject834) Set(val *InlineObject834) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject834) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject834) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject834(val *InlineObject834) *NullableInlineObject834 {
	return &NullableInlineObject834{value: val, isSet: true}
}

func (v NullableInlineObject834) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject834) UnmarshalJSON(src []byte) error {
	v.isSet = true
