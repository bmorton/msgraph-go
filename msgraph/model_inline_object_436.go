...
// InlineObject436 struct for InlineObject436
type InlineObject436 struct {
...
func (o *InlineObject436) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o InlineObject436) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject436 struct {
	value *InlineObject436
	isSet bool
}

func (v NullableInlineObject436) Get() *InlineObject436 {
	return v.value
}

func (v *NullableInlineObject436) Set(val *InlineObject436) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject436) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject436) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject436(val *InlineObject436) *NullableInlineObject436 {
	return &NullableInlineObject436{value: val, isSet: true}
}

func (v NullableInlineObject436) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject436) UnmarshalJSON(src []byte) error {
	v.isSet = true
