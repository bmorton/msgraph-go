...
// InlineObject1129 struct for InlineObject1129
type InlineObject1129 struct {
...
func (o *InlineObject1129) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1129) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1129) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1129) SetSiteCollectionIdNil() {
...
func (o *InlineObject1129) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1129) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1129 struct {
	value *InlineObject1129
	isSet bool
}

func (v NullableInlineObject1129) Get() *InlineObject1129 {
	return v.value
}

func (v *NullableInlineObject1129) Set(val *InlineObject1129) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1129) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1129) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1129(val *InlineObject1129) *NullableInlineObject1129 {
	return &NullableInlineObject1129{value: val, isSet: true}
}

func (v NullableInlineObject1129) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1129) UnmarshalJSON(src []byte) error {
	v.isSet = true
