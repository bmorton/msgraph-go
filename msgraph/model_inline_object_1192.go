...
func (o *InlineObject1192) SetActivityTypeNil() {
...
func (o *InlineObject1192) SetChainIdNil() {
	o.ChainId.Set(nil)
}
...
func (o InlineObject1192) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1192 struct {
	value *InlineObject1192
	isSet bool
}

func (v NullableInlineObject1192) Get() *InlineObject1192 {
	return v.value
}

func (v *NullableInlineObject1192) Set(val *InlineObject1192) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1192) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1192) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1192(val *InlineObject1192) *NullableInlineObject1192 {
	return &NullableInlineObject1192{value: val, isSet: true}
}

func (v NullableInlineObject1192) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1192) UnmarshalJSON(src []byte) error {
	v.isSet = true
