...
func NewDeviceCompliancePolicyState() *DeviceCompliancePolicyState {
	this := DeviceCompliancePolicyState{}
	return &this
}
...
func (o *DeviceCompliancePolicyState) SetDisplayNameNil() {
...
func (o DeviceCompliancePolicyState) MarshalJSON() ([]byte, error) {
...
type NullableDeviceCompliancePolicyState struct {
	value *DeviceCompliancePolicyState
	isSet bool
}

func (v NullableDeviceCompliancePolicyState) Get() *DeviceCompliancePolicyState {
	return v.value
}

func (v *NullableDeviceCompliancePolicyState) Set(val *DeviceCompliancePolicyState) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceCompliancePolicyState) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceCompliancePolicyState) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceCompliancePolicyState(val *DeviceCompliancePolicyState) *NullableDeviceCompliancePolicyState {
	return &NullableDeviceCompliancePolicyState{value: val, isSet: true}
}

func (v NullableDeviceCompliancePolicyState) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceCompliancePolicyState) UnmarshalJSON(src []byte) error {
	v.isSet = true
