...
func (o *InlineObject1122) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1122) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1122) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1122) SetSiteCollectionIdNil() {
...
func (o *InlineObject1122) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject1122 struct {
	value *InlineObject1122
	isSet bool
}

func (v NullableInlineObject1122) Get() *InlineObject1122 {
	return v.value
}

func (v *NullableInlineObject1122) Set(val *InlineObject1122) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1122) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1122) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1122(val *InlineObject1122) *NullableInlineObject1122 {
	return &NullableInlineObject1122{value: val, isSet: true}
}

func (v NullableInlineObject1122) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1122) UnmarshalJSON(src []byte) error {
	v.isSet = true
