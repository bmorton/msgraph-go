...
func (o *InlineObject1123) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1123) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1123) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1123) SetSiteCollectionIdNil() {
...
func (o *InlineObject1123) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1123) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1123 struct {
	value *InlineObject1123
	isSet bool
}

func (v NullableInlineObject1123) Get() *InlineObject1123 {
	return v.value
}

func (v *NullableInlineObject1123) Set(val *InlineObject1123) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1123) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1123) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1123(val *InlineObject1123) *NullableInlineObject1123 {
	return &NullableInlineObject1123{value: val, isSet: true}
}

func (v NullableInlineObject1123) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1123) UnmarshalJSON(src []byte) error {
	v.isSet = true
