...
func (o *InlineObject606) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject606) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject606) SetNotebookFolderNil() {
...
func (o *InlineObject606) SetSiteCollectionIdNil() {
...
func (o *InlineObject606) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject606) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject606 struct {
	value *InlineObject606
	isSet bool
}

func (v NullableInlineObject606) Get() *InlineObject606 {
	return v.value
}

func (v *NullableInlineObject606) Set(val *InlineObject606) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject606) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject606) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject606(val *InlineObject606) *NullableInlineObject606 {
	return &NullableInlineObject606{value: val, isSet: true}
}

func (v NullableInlineObject606) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject606) UnmarshalJSON(src []byte) error {
	v.isSet = true
