...
type NullableInlineObject937 struct {
	value *InlineObject937
	isSet bool
}

func (v NullableInlineObject937) Get() *InlineObject937 {
	return v.value
}

func (v *NullableInlineObject937) Set(val *InlineObject937) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject937) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject937) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject937(val *InlineObject937) *NullableInlineObject937 {
	return &NullableInlineObject937{value: val, isSet: true}
}

func (v NullableInlineObject937) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject937) UnmarshalJSON(src []byte) error {
	v.isSet = true
