...
func (o *InlineObject857) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject857) SetSendResponseNil() {
...
type NullableInlineObject857 struct {
	value *InlineObject857
	isSet bool
}

func (v NullableInlineObject857) Get() *InlineObject857 {
	return v.value
}

func (v *NullableInlineObject857) Set(val *InlineObject857) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject857) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject857) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject857(val *InlineObject857) *NullableInlineObject857 {
	return &NullableInlineObject857{value: val, isSet: true}
}

func (v NullableInlineObject857) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject857) UnmarshalJSON(src []byte) error {
	v.isSet = true
