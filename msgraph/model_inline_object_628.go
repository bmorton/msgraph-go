...
func (o *InlineObject628) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject628) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject628) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject628) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject628) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject628) SetSiteCollectionIdNil() {
...
func (o *InlineObject628) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject628 struct {
	value *InlineObject628
	isSet bool
}

func (v NullableInlineObject628) Get() *InlineObject628 {
	return v.value
}

func (v *NullableInlineObject628) Set(val *InlineObject628) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject628) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject628) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject628(val *InlineObject628) *NullableInlineObject628 {
	return &NullableInlineObject628{value: val, isSet: true}
}

func (v NullableInlineObject628) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject628) UnmarshalJSON(src []byte) error {
	v.isSet = true
