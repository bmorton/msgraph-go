...
// InlineObject433 struct for InlineObject433
type InlineObject433 struct {
...
func (o *InlineObject433) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject433) SetSendResponseNil() {
...
func (o InlineObject433) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject433 struct {
	value *InlineObject433
	isSet bool
}

func (v NullableInlineObject433) Get() *InlineObject433 {
	return v.value
}

func (v *NullableInlineObject433) Set(val *InlineObject433) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject433) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject433) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject433(val *InlineObject433) *NullableInlineObject433 {
	return &NullableInlineObject433{value: val, isSet: true}
}

func (v NullableInlineObject433) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject433) UnmarshalJSON(src []byte) error {
	v.isSet = true
