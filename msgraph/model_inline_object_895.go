...
func (o *InlineObject895) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject895) SetSendResponseNil() {
...
type NullableInlineObject895 struct {
	value *InlineObject895
	isSet bool
}

func (v NullableInlineObject895) Get() *InlineObject895 {
	return v.value
}

func (v *NullableInlineObject895) Set(val *InlineObject895) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject895) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject895) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject895(val *InlineObject895) *NullableInlineObject895 {
	return &NullableInlineObject895{value: val, isSet: true}
}

func (v NullableInlineObject895) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject895) UnmarshalJSON(src []byte) error {
	v.isSet = true
