...
// InlineObject750 struct for InlineObject750
type InlineObject750 struct {
...
func (o InlineObject750) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject750 struct {
	value *InlineObject750
	isSet bool
}

func (v NullableInlineObject750) Get() *InlineObject750 {
	return v.value
}

func (v *NullableInlineObject750) Set(val *InlineObject750) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject750) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject750) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject750(val *InlineObject750) *NullableInlineObject750 {
	return &NullableInlineObject750{value: val, isSet: true}
}

func (v NullableInlineObject750) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject750) UnmarshalJSON(src []byte) error {
	v.isSet = true
