...
type NullableInlineObject1104 struct {
	value *InlineObject1104
	isSet bool
}

func (v NullableInlineObject1104) Get() *InlineObject1104 {
	return v.value
}

func (v *NullableInlineObject1104) Set(val *InlineObject1104) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1104) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1104) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1104(val *InlineObject1104) *NullableInlineObject1104 {
	return &NullableInlineObject1104{value: val, isSet: true}
}

func (v NullableInlineObject1104) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1104) UnmarshalJSON(src []byte) error {
	v.isSet = true
