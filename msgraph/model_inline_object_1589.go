...
// InlineObject1589 struct for InlineObject1589
type InlineObject1589 struct {
...
func (o *InlineObject1589) SetIndexNil() {
	o.Index.Set(nil)
}
...
func (o *InlineObject1589) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o InlineObject1589) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1589 struct {
	value *InlineObject1589
	isSet bool
}

func (v NullableInlineObject1589) Get() *InlineObject1589 {
	return v.value
}

func (v *NullableInlineObject1589) Set(val *InlineObject1589) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1589) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1589) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1589(val *InlineObject1589) *NullableInlineObject1589 {
	return &NullableInlineObject1589{value: val, isSet: true}
}

func (v NullableInlineObject1589) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1589) UnmarshalJSON(src []byte) error {
	v.isSet = true
