...
// InlineObject973 struct for InlineObject973
type InlineObject973 struct {
...
func (o *InlineObject973) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject973) SetSendResponseNil() {
...
func (o InlineObject973) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject973 struct {
	value *InlineObject973
	isSet bool
}

func (v NullableInlineObject973) Get() *InlineObject973 {
	return v.value
}

func (v *NullableInlineObject973) Set(val *InlineObject973) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject973) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject973) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject973(val *InlineObject973) *NullableInlineObject973 {
	return &NullableInlineObject973{value: val, isSet: true}
}

func (v NullableInlineObject973) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject973) UnmarshalJSON(src []byte) error {
	v.isSet = true
