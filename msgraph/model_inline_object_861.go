...
// InlineObject861 struct for InlineObject861
type InlineObject861 struct {
...
func (o *InlineObject861) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject861) SetSendResponseNil() {
...
func (o InlineObject861) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject861 struct {
	value *InlineObject861
	isSet bool
}

func (v NullableInlineObject861) Get() *InlineObject861 {
	return v.value
}

func (v *NullableInlineObject861) Set(val *InlineObject861) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject861) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject861) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject861(val *InlineObject861) *NullableInlineObject861 {
	return &NullableInlineObject861{value: val, isSet: true}
}

func (v NullableInlineObject861) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject861) UnmarshalJSON(src []byte) error {
	v.isSet = true
