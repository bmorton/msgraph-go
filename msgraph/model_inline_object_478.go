...
// InlineObject478 struct for InlineObject478
type InlineObject478 struct {
...
func (o *InlineObject478) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject478) SetSendResponseNil() {
...
func (o InlineObject478) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject478 struct {
	value *InlineObject478
	isSet bool
}

func (v NullableInlineObject478) Get() *InlineObject478 {
	return v.value
}

func (v *NullableInlineObject478) Set(val *InlineObject478) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject478) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject478) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject478(val *InlineObject478) *NullableInlineObject478 {
	return &NullableInlineObject478{value: val, isSet: true}
}

func (v NullableInlineObject478) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject478) UnmarshalJSON(src []byte) error {
	v.isSet = true
