...
func (o *InlineObject883) SetAvailabilityViewIntervalNil() {
...
type NullableInlineObject883 struct {
	value *InlineObject883
	isSet bool
}

func (v NullableInlineObject883) Get() *InlineObject883 {
	return v.value
}

func (v *NullableInlineObject883) Set(val *InlineObject883) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject883) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject883) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject883(val *InlineObject883) *NullableInlineObject883 {
	return &NullableInlineObject883{value: val, isSet: true}
}

func (v NullableInlineObject883) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject883) UnmarshalJSON(src []byte) error {
	v.isSet = true
