...
func (o *InlineObject1102) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1102) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1102) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1102) SetSiteCollectionIdNil() {
...
func (o *InlineObject1102) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject1102 struct {
	value *InlineObject1102
	isSet bool
}

func (v NullableInlineObject1102) Get() *InlineObject1102 {
	return v.value
}

func (v *NullableInlineObject1102) Set(val *InlineObject1102) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1102) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1102) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1102(val *InlineObject1102) *NullableInlineObject1102 {
	return &NullableInlineObject1102{value: val, isSet: true}
}

func (v NullableInlineObject1102) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1102) UnmarshalJSON(src []byte) error {
	v.isSet = true
