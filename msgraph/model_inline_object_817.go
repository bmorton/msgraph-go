...
// InlineObject817 struct for InlineObject817
type InlineObject817 struct {
...
func (o *InlineObject817) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject817) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject817) SetNotebookFolderNil() {
...
func (o *InlineObject817) SetSiteCollectionIdNil() {
...
func (o *InlineObject817) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject817) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject817 struct {
	value *InlineObject817
	isSet bool
}

func (v NullableInlineObject817) Get() *InlineObject817 {
	return v.value
}

func (v *NullableInlineObject817) Set(val *InlineObject817) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject817) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject817) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject817(val *InlineObject817) *NullableInlineObject817 {
	return &NullableInlineObject817{value: val, isSet: true}
}

func (v NullableInlineObject817) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject817) UnmarshalJSON(src []byte) error {
	v.isSet = true
