...
func (o *InlineObject798) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject798) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject798) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject798) SetSiteCollectionIdNil() {
...
func (o *InlineObject798) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject798) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject798 struct {
	value *InlineObject798
	isSet bool
}

func (v NullableInlineObject798) Get() *InlineObject798 {
	return v.value
}

func (v *NullableInlineObject798) Set(val *InlineObject798) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject798) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject798) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject798(val *InlineObject798) *NullableInlineObject798 {
	return &NullableInlineObject798{value: val, isSet: true}
}

func (v NullableInlineObject798) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject798) UnmarshalJSON(src []byte) error {
	v.isSet = true
