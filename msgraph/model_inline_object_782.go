...
func (o *InlineObject782) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject782) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject782) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject782) SetSiteCollectionIdNil() {
...
func (o *InlineObject782) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject782 struct {
	value *InlineObject782
	isSet bool
}

func (v NullableInlineObject782) Get() *InlineObject782 {
	return v.value
}

func (v *NullableInlineObject782) Set(val *InlineObject782) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject782) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject782) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject782(val *InlineObject782) *NullableInlineObject782 {
	return &NullableInlineObject782{value: val, isSet: true}
}

func (v NullableInlineObject782) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject782) UnmarshalJSON(src []byte) error {
	v.isSet = true
