...
func (o *InlineObject329) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject329) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject329) SetNotebookFolderNil() {
...
func (o *InlineObject329) SetSiteCollectionIdNil() {
...
func (o *InlineObject329) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject329 struct {
	value *InlineObject329
	isSet bool
}

func (v NullableInlineObject329) Get() *InlineObject329 {
	return v.value
}

func (v *NullableInlineObject329) Set(val *InlineObject329) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject329) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject329) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject329(val *InlineObject329) *NullableInlineObject329 {
	return &NullableInlineObject329{value: val, isSet: true}
}

func (v NullableInlineObject329) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject329) UnmarshalJSON(src []byte) error {
	v.isSet = true
