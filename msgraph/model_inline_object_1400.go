...
// InlineObject1400 struct for InlineObject1400
type InlineObject1400 struct {
...
func (o InlineObject1400) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1400 struct {
	value *InlineObject1400
	isSet bool
}

func (v NullableInlineObject1400) Get() *InlineObject1400 {
	return v.value
}

func (v *NullableInlineObject1400) Set(val *InlineObject1400) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1400) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1400) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1400(val *InlineObject1400) *NullableInlineObject1400 {
	return &NullableInlineObject1400{value: val, isSet: true}
}

func (v NullableInlineObject1400) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1400) UnmarshalJSON(src []byte) error {
	v.isSet = true
