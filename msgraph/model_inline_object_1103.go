...
func (o *InlineObject1103) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1103) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1103) SetSiteCollectionIdNil() {
...
func (o *InlineObject1103) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject1103 struct {
	value *InlineObject1103
	isSet bool
}

func (v NullableInlineObject1103) Get() *InlineObject1103 {
	return v.value
}

func (v *NullableInlineObject1103) Set(val *InlineObject1103) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1103) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1103) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1103(val *InlineObject1103) *NullableInlineObject1103 {
	return &NullableInlineObject1103{value: val, isSet: true}
}

func (v NullableInlineObject1103) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1103) UnmarshalJSON(src []byte) error {
	v.isSet = true
