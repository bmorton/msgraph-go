...
func (o *InlineObject374) SetAvailabilityViewIntervalNil() {
...
func (o InlineObject374) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject374 struct {
	value *InlineObject374
	isSet bool
}

func (v NullableInlineObject374) Get() *InlineObject374 {
	return v.value
}

func (v *NullableInlineObject374) Set(val *InlineObject374) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject374) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject374) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject374(val *InlineObject374) *NullableInlineObject374 {
	return &NullableInlineObject374{value: val, isSet: true}
}

func (v NullableInlineObject374) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject374) UnmarshalJSON(src []byte) error {
	v.isSet = true
