...
func (o *InlineObject907) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o InlineObject907) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject907 struct {
	value *InlineObject907
	isSet bool
}

func (v NullableInlineObject907) Get() *InlineObject907 {
	return v.value
}

func (v *NullableInlineObject907) Set(val *InlineObject907) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject907) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject907) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject907(val *InlineObject907) *NullableInlineObject907 {
	return &NullableInlineObject907{value: val, isSet: true}
}

func (v NullableInlineObject907) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject907) UnmarshalJSON(src []byte) error {
	v.isSet = true
