...
// InlineObject337 struct for InlineObject337
type InlineObject337 struct {
...
func (o *InlineObject337) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject337) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject337) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject337) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject337) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject337) SetSiteCollectionIdNil() {
...
func (o *InlineObject337) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject337) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject337 struct {
	value *InlineObject337
	isSet bool
}

func (v NullableInlineObject337) Get() *InlineObject337 {
	return v.value
}

func (v *NullableInlineObject337) Set(val *InlineObject337) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject337) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject337) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject337(val *InlineObject337) *NullableInlineObject337 {
	return &NullableInlineObject337{value: val, isSet: true}
}

func (v NullableInlineObject337) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject337) UnmarshalJSON(src []byte) error {
	v.isSet = true
