...
func (o *InlineObject912) SetAvailabilityViewIntervalNil() {
...
func (o InlineObject912) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject912 struct {
	value *InlineObject912
	isSet bool
}

func (v NullableInlineObject912) Get() *InlineObject912 {
	return v.value
}

func (v *NullableInlineObject912) Set(val *InlineObject912) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject912) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject912) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject912(val *InlineObject912) *NullableInlineObject912 {
	return &NullableInlineObject912{value: val, isSet: true}
}

func (v NullableInlineObject912) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject912) UnmarshalJSON(src []byte) error {
	v.isSet = true
