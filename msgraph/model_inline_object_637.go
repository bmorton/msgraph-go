...
func (o *InlineObject637) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject637) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject637) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject637) SetSiteCollectionIdNil() {
...
func (o *InlineObject637) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject637 struct {
	value *InlineObject637
	isSet bool
}

func (v NullableInlineObject637) Get() *InlineObject637 {
	return v.value
}

func (v *NullableInlineObject637) Set(val *InlineObject637) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject637) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject637) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject637(val *InlineObject637) *NullableInlineObject637 {
	return &NullableInlineObject637{value: val, isSet: true}
}

func (v NullableInlineObject637) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject637) UnmarshalJSON(src []byte) error {
	v.isSet = true
