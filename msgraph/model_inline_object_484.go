...
// InlineObject484 struct for InlineObject484
type InlineObject484 struct {
...
func (o *InlineObject484) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject484) SetSendResponseNil() {
...
func (o InlineObject484) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject484 struct {
	value *InlineObject484
	isSet bool
}

func (v NullableInlineObject484) Get() *InlineObject484 {
	return v.value
}

func (v *NullableInlineObject484) Set(val *InlineObject484) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject484) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject484) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject484(val *InlineObject484) *NullableInlineObject484 {
	return &NullableInlineObject484{value: val, isSet: true}
}

func (v NullableInlineObject484) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject484) UnmarshalJSON(src []byte) error {
	v.isSet = true
