...
// InlineObject476 struct for InlineObject476
type InlineObject476 struct {
...
func (o *InlineObject476) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o InlineObject476) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject476 struct {
	value *InlineObject476
	isSet bool
}

func (v NullableInlineObject476) Get() *InlineObject476 {
	return v.value
}

func (v *NullableInlineObject476) Set(val *InlineObject476) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject476) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject476) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject476(val *InlineObject476) *NullableInlineObject476 {
	return &NullableInlineObject476{value: val, isSet: true}
}

func (v NullableInlineObject476) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject476) UnmarshalJSON(src []byte) error {
	v.isSet = true
