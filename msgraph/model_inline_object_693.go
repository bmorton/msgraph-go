...
// InlineObject693 struct for InlineObject693
type InlineObject693 struct {
...
func (o *InlineObject693) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject693) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject693) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject693) SetSiteCollectionIdNil() {
...
func (o *InlineObject693) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject693) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject693 struct {
	value *InlineObject693
	isSet bool
}

func (v NullableInlineObject693) Get() *InlineObject693 {
	return v.value
}

func (v *NullableInlineObject693) Set(val *InlineObject693) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject693) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject693) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject693(val *InlineObject693) *NullableInlineObject693 {
	return &NullableInlineObject693{value: val, isSet: true}
}

func (v NullableInlineObject693) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject693) UnmarshalJSON(src []byte) error {
	v.isSet = true
