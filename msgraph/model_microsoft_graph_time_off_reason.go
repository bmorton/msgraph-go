...
func NewMicrosoftGraphTimeOffReason() *MicrosoftGraphTimeOffReason {
	this := MicrosoftGraphTimeOffReason{}
	return &this
}
...
func (o *MicrosoftGraphTimeOffReason) SetCreatedDateTimeNil() {
...
func (o *MicrosoftGraphTimeOffReason) SetLastModifiedDateTimeNil() {
...
func (o *MicrosoftGraphTimeOffReason) SetDisplayNameNil() {
...
func (o *MicrosoftGraphTimeOffReason) SetIsActiveNil() {
	o.IsActive.Set(nil)
}
...
func (o MicrosoftGraphTimeOffReason) MarshalJSON() ([]byte, error) {
...
type NullableMicrosoftGraphTimeOffReason struct {
	value *MicrosoftGraphTimeOffReason
	isSet bool
}

func (v NullableMicrosoftGraphTimeOffReason) Get() *MicrosoftGraphTimeOffReason {
	return v.value
}

func (v *NullableMicrosoftGraphTimeOffReason) Set(val *MicrosoftGraphTimeOffReason) {
	v.value = val
	v.isSet = true
}

func (v NullableMicrosoftGraphTimeOffReason) IsSet() bool {
	return v.isSet
}

func (v *NullableMicrosoftGraphTimeOffReason) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMicrosoftGraphTimeOffReason(val *MicrosoftGraphTimeOffReason) *NullableMicrosoftGraphTimeOffReason {
	return &NullableMicrosoftGraphTimeOffReason{value: val, isSet: true}
}

func (v NullableMicrosoftGraphTimeOffReason) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMicrosoftGraphTimeOffReason) UnmarshalJSON(src []byte) error {
	v.isSet = true
