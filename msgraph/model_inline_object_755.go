...
func (o *InlineObject755) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject755) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject755) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject755) SetSiteCollectionIdNil() {
...
func (o *InlineObject755) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject755) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject755 struct {
	value *InlineObject755
	isSet bool
}

func (v NullableInlineObject755) Get() *InlineObject755 {
	return v.value
}

func (v *NullableInlineObject755) Set(val *InlineObject755) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject755) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject755) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject755(val *InlineObject755) *NullableInlineObject755 {
	return &NullableInlineObject755{value: val, isSet: true}
}

func (v NullableInlineObject755) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject755) UnmarshalJSON(src []byte) error {
	v.isSet = true
