...
func (o *InlineObject243) HasGroupId() bool {
...
func (o *InlineObject243) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject243) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject243) GetNotebookFolderOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject243) SetNotebookFolderNil() {
...
func (o *InlineObject243) SetSiteCollectionIdNil() {
...
func (o *InlineObject243) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
