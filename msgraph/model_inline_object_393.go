...
func (o *InlineObject393) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o InlineObject393) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject393 struct {
	value *InlineObject393
	isSet bool
}

func (v NullableInlineObject393) Get() *InlineObject393 {
	return v.value
}

func (v *NullableInlineObject393) Set(val *InlineObject393) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject393) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject393) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject393(val *InlineObject393) *NullableInlineObject393 {
	return &NullableInlineObject393{value: val, isSet: true}
}

func (v NullableInlineObject393) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject393) UnmarshalJSON(src []byte) error {
	v.isSet = true
