...
// InlineObject452 struct for InlineObject452
type InlineObject452 struct {
...
func (o *InlineObject452) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject452) SetSendResponseNil() {
...
func (o InlineObject452) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject452 struct {
	value *InlineObject452
	isSet bool
}

func (v NullableInlineObject452) Get() *InlineObject452 {
	return v.value
}

func (v *NullableInlineObject452) Set(val *InlineObject452) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject452) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject452) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject452(val *InlineObject452) *NullableInlineObject452 {
	return &NullableInlineObject452{value: val, isSet: true}
}

func (v NullableInlineObject452) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject452) UnmarshalJSON(src []byte) error {
	v.isSet = true
