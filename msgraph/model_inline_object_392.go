...
func (o *InlineObject392) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject392) SetSendResponseNil() {
...
func (o InlineObject392) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject392 struct {
	value *InlineObject392
	isSet bool
}

func (v NullableInlineObject392) Get() *InlineObject392 {
	return v.value
}

func (v *NullableInlineObject392) Set(val *InlineObject392) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject392) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject392) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject392(val *InlineObject392) *NullableInlineObject392 {
	return &NullableInlineObject392{value: val, isSet: true}
}

func (v NullableInlineObject392) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject392) UnmarshalJSON(src []byte) error {
	v.isSet = true
