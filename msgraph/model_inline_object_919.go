...
func (o *InlineObject919) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject919) SetSendResponseNil() {
...
func (o InlineObject919) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject919 struct {
	value *InlineObject919
	isSet bool
}

func (v NullableInlineObject919) Get() *InlineObject919 {
	return v.value
}

func (v *NullableInlineObject919) Set(val *InlineObject919) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject919) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject919) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject919(val *InlineObject919) *NullableInlineObject919 {
	return &NullableInlineObject919{value: val, isSet: true}
}

func (v NullableInlineObject919) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject919) UnmarshalJSON(src []byte) error {
	v.isSet = true
