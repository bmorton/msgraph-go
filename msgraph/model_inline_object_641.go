...
// InlineObject641 struct for InlineObject641
type InlineObject641 struct {
...
func (o *InlineObject641) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject641) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject641) SetNotebookFolderNil() {
...
func (o *InlineObject641) SetSiteCollectionIdNil() {
...
func (o *InlineObject641) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject641) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject641 struct {
	value *InlineObject641
	isSet bool
}

func (v NullableInlineObject641) Get() *InlineObject641 {
	return v.value
}

func (v *NullableInlineObject641) Set(val *InlineObject641) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject641) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject641) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject641(val *InlineObject641) *NullableInlineObject641 {
	return &NullableInlineObject641{value: val, isSet: true}
}

func (v NullableInlineObject641) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject641) UnmarshalJSON(src []byte) error {
	v.isSet = true
