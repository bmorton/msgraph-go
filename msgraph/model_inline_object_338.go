...
// InlineObject338 struct for InlineObject338
type InlineObject338 struct {
...
func (o *InlineObject338) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject338) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject338) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject338) SetSiteCollectionIdNil() {
...
func (o *InlineObject338) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject338) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject338 struct {
	value *InlineObject338
	isSet bool
}

func (v NullableInlineObject338) Get() *InlineObject338 {
	return v.value
}

func (v *NullableInlineObject338) Set(val *InlineObject338) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject338) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject338) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject338(val *InlineObject338) *NullableInlineObject338 {
	return &NullableInlineObject338{value: val, isSet: true}
}

func (v NullableInlineObject338) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject338) UnmarshalJSON(src []byte) error {
	v.isSet = true
