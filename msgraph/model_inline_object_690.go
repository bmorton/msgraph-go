...
// InlineObject690 struct for InlineObject690
type InlineObject690 struct {
...
func (o *InlineObject690) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject690) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject690) SetNotebookFolderNil() {
...
func (o *InlineObject690) SetSiteCollectionIdNil() {
...
func (o *InlineObject690) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject690) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject690 struct {
	value *InlineObject690
	isSet bool
}

func (v NullableInlineObject690) Get() *InlineObject690 {
	return v.value
}

func (v *NullableInlineObject690) Set(val *InlineObject690) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject690) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject690) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject690(val *InlineObject690) *NullableInlineObject690 {
	return &NullableInlineObject690{value: val, isSet: true}
}

func (v NullableInlineObject690) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject690) UnmarshalJSON(src []byte) error {
	v.isSet = true
