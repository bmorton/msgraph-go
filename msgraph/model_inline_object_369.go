...
func (o *InlineObject369) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject369) SetSendResponseNil() {
...
func (o InlineObject369) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject369 struct {
	value *InlineObject369
	isSet bool
}

func (v NullableInlineObject369) Get() *InlineObject369 {
	return v.value
}

func (v *NullableInlineObject369) Set(val *InlineObject369) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject369) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject369) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject369(val *InlineObject369) *NullableInlineObject369 {
	return &NullableInlineObject369{value: val, isSet: true}
}

func (v NullableInlineObject369) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject369) UnmarshalJSON(src []byte) error {
	v.isSet = true
