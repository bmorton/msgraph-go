...
// InlineObject1029 struct for InlineObject1029
type InlineObject1029 struct {
...
func (o InlineObject1029) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1029 struct {
	value *InlineObject1029
	isSet bool
}

func (v NullableInlineObject1029) Get() *InlineObject1029 {
	return v.value
}

func (v *NullableInlineObject1029) Set(val *InlineObject1029) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1029) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1029) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1029(val *InlineObject1029) *NullableInlineObject1029 {
	return &NullableInlineObject1029{value: val, isSet: true}
}

func (v NullableInlineObject1029) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1029) UnmarshalJSON(src []byte) error {
	v.isSet = true
