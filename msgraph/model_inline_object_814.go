...
func (o *InlineObject814) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject814) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject814) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject814) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject814) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject814) SetSiteCollectionIdNil() {
...
func (o *InlineObject814) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject814 struct {
	value *InlineObject814
	isSet bool
}

func (v NullableInlineObject814) Get() *InlineObject814 {
	return v.value
}

func (v *NullableInlineObject814) Set(val *InlineObject814) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject814) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject814) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject814(val *InlineObject814) *NullableInlineObject814 {
	return &NullableInlineObject814{value: val, isSet: true}
}

func (v NullableInlineObject814) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject814) UnmarshalJSON(src []byte) error {
	v.isSet = true
