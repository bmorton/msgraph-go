...
// InlineObject904 struct for InlineObject904
type InlineObject904 struct {
...
func (o *InlineObject904) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject904) SetSendResponseNil() {
...
func (o InlineObject904) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject904 struct {
	value *InlineObject904
	isSet bool
}

func (v NullableInlineObject904) Get() *InlineObject904 {
	return v.value
}

func (v *NullableInlineObject904) Set(val *InlineObject904) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject904) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject904) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject904(val *InlineObject904) *NullableInlineObject904 {
	return &NullableInlineObject904{value: val, isSet: true}
}

func (v NullableInlineObject904) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject904) UnmarshalJSON(src []byte) error {
	v.isSet = true
