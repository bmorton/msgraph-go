...
// InlineObject988 struct for InlineObject988
type InlineObject988 struct {
...
func (o *InlineObject988) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject988) SetSendResponseNil() {
...
func (o InlineObject988) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject988 struct {
	value *InlineObject988
	isSet bool
}

func (v NullableInlineObject988) Get() *InlineObject988 {
	return v.value
}

func (v *NullableInlineObject988) Set(val *InlineObject988) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject988) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject988) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject988(val *InlineObject988) *NullableInlineObject988 {
	return &NullableInlineObject988{value: val, isSet: true}
}

func (v NullableInlineObject988) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject988) UnmarshalJSON(src []byte) error {
	v.isSet = true
