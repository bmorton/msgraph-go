...
// InlineObject522 struct for InlineObject522
type InlineObject522 struct {
...
func (o InlineObject522) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject522 struct {
	value *InlineObject522
	isSet bool
}

func (v NullableInlineObject522) Get() *InlineObject522 {
	return v.value
}

func (v *NullableInlineObject522) Set(val *InlineObject522) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject522) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject522) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject522(val *InlineObject522) *NullableInlineObject522 {
	return &NullableInlineObject522{value: val, isSet: true}
}

func (v NullableInlineObject522) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject522) UnmarshalJSON(src []byte) error {
	v.isSet = true
