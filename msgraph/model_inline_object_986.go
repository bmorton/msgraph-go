...
func (o *InlineObject986) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject986) SetSendResponseNil() {
...
type NullableInlineObject986 struct {
	value *InlineObject986
	isSet bool
}

func (v NullableInlineObject986) Get() *InlineObject986 {
	return v.value
}

func (v *NullableInlineObject986) Set(val *InlineObject986) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject986) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject986) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject986(val *InlineObject986) *NullableInlineObject986 {
	return &NullableInlineObject986{value: val, isSet: true}
}

func (v NullableInlineObject986) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject986) UnmarshalJSON(src []byte) error {
	v.isSet = true
