...
// InlineObject1304 struct for InlineObject1304
type InlineObject1304 struct {
...
func (o *InlineObject1304) HasSettlement() bool {
	if o != nil && o.Settlement != nil {
		return true
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject1304) GetPrOk() (*AnyOfobject, bool) {
	if o == nil || o.Pr == nil {
		return nil, false
	}
	return &o.Pr, true
...
func (o InlineObject1304) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1304 struct {
	value *InlineObject1304
	isSet bool
}

func (v NullableInlineObject1304) Get() *InlineObject1304 {
	return v.value
}

func (v *NullableInlineObject1304) Set(val *InlineObject1304) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1304) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1304) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1304(val *InlineObject1304) *NullableInlineObject1304 {
	return &NullableInlineObject1304{value: val, isSet: true}
}

func (v NullableInlineObject1304) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1304) UnmarshalJSON(src []byte) error {
	v.isSet = true
