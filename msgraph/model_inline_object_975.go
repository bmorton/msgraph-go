...
func (o *InlineObject975) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject975) SetSendResponseNil() {
...
type NullableInlineObject975 struct {
	value *InlineObject975
	isSet bool
}

func (v NullableInlineObject975) Get() *InlineObject975 {
	return v.value
}

func (v *NullableInlineObject975) Set(val *InlineObject975) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject975) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject975) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject975(val *InlineObject975) *NullableInlineObject975 {
	return &NullableInlineObject975{value: val, isSet: true}
}

func (v NullableInlineObject975) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject975) UnmarshalJSON(src []byte) error {
	v.isSet = true
