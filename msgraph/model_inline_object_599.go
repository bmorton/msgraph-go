...
func (o *InlineObject599) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject599) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject599) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject599) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject599) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject599) SetSiteCollectionIdNil() {
...
func (o *InlineObject599) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject599) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject599 struct {
	value *InlineObject599
	isSet bool
}

func (v NullableInlineObject599) Get() *InlineObject599 {
	return v.value
}

func (v *NullableInlineObject599) Set(val *InlineObject599) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject599) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject599) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject599(val *InlineObject599) *NullableInlineObject599 {
	return &NullableInlineObject599{value: val, isSet: true}
}

func (v NullableInlineObject599) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject599) UnmarshalJSON(src []byte) error {
	v.isSet = true
