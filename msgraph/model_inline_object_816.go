...
// InlineObject816 struct for InlineObject816
type InlineObject816 struct {
...
func (o *InlineObject816) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject816) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject816) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject816) SetSiteCollectionIdNil() {
...
func (o *InlineObject816) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject816) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject816 struct {
	value *InlineObject816
	isSet bool
}

func (v NullableInlineObject816) Get() *InlineObject816 {
	return v.value
}

func (v *NullableInlineObject816) Set(val *InlineObject816) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject816) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject816) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject816(val *InlineObject816) *NullableInlineObject816 {
	return &NullableInlineObject816{value: val, isSet: true}
}

func (v NullableInlineObject816) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject816) UnmarshalJSON(src []byte) error {
	v.isSet = true
