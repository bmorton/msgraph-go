...
func (o *InlineObject959) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject959) SetSendResponseNil() {
...
type NullableInlineObject959 struct {
	value *InlineObject959
	isSet bool
}

func (v NullableInlineObject959) Get() *InlineObject959 {
	return v.value
}

func (v *NullableInlineObject959) Set(val *InlineObject959) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject959) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject959) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject959(val *InlineObject959) *NullableInlineObject959 {
	return &NullableInlineObject959{value: val, isSet: true}
}

func (v NullableInlineObject959) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject959) UnmarshalJSON(src []byte) error {
	v.isSet = true
