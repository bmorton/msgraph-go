...
func (o *InlineObject248) HasGroupId() bool {
...
func (o *InlineObject248) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject248) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject248) GetNotebookFolderOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject248) SetNotebookFolderNil() {
...
func (o *InlineObject248) SetSiteCollectionIdNil() {
...
func (o *InlineObject248) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
