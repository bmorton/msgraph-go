...
func (o *InlineObject642) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject642) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject642) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject642) SetSiteCollectionIdNil() {
...
func (o *InlineObject642) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject642) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject642 struct {
	value *InlineObject642
	isSet bool
}

func (v NullableInlineObject642) Get() *InlineObject642 {
	return v.value
}

func (v *NullableInlineObject642) Set(val *InlineObject642) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject642) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject642) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject642(val *InlineObject642) *NullableInlineObject642 {
	return &NullableInlineObject642{value: val, isSet: true}
}

func (v NullableInlineObject642) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject642) UnmarshalJSON(src []byte) error {
	v.isSet = true
