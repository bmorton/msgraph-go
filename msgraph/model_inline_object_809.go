...
// InlineObject809 struct for InlineObject809
type InlineObject809 struct {
...
func (o *InlineObject809) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject809) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject809) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject809) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject809) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject809) SetSiteCollectionIdNil() {
...
func (o *InlineObject809) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject809) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject809 struct {
	value *InlineObject809
	isSet bool
}

func (v NullableInlineObject809) Get() *InlineObject809 {
	return v.value
}

func (v *NullableInlineObject809) Set(val *InlineObject809) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject809) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject809) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject809(val *InlineObject809) *NullableInlineObject809 {
	return &NullableInlineObject809{value: val, isSet: true}
}

func (v NullableInlineObject809) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject809) UnmarshalJSON(src []byte) error {
	v.isSet = true
