...
func (o *InlineObject635) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject635) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject635) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject635) SetSiteCollectionIdNil() {
...
func (o *InlineObject635) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject635 struct {
	value *InlineObject635
	isSet bool
}

func (v NullableInlineObject635) Get() *InlineObject635 {
	return v.value
}

func (v *NullableInlineObject635) Set(val *InlineObject635) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject635) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject635) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject635(val *InlineObject635) *NullableInlineObject635 {
	return &NullableInlineObject635{value: val, isSet: true}
}

func (v NullableInlineObject635) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject635) UnmarshalJSON(src []byte) error {
	v.isSet = true
