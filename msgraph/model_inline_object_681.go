...
// InlineObject681 struct for InlineObject681
type InlineObject681 struct {
...
func (o *InlineObject681) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject681) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject681) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject681) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject681) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject681) SetSiteCollectionIdNil() {
...
func (o *InlineObject681) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject681) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject681 struct {
	value *InlineObject681
	isSet bool
}

func (v NullableInlineObject681) Get() *InlineObject681 {
	return v.value
}

func (v *NullableInlineObject681) Set(val *InlineObject681) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject681) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject681) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject681(val *InlineObject681) *NullableInlineObject681 {
	return &NullableInlineObject681{value: val, isSet: true}
}

func (v NullableInlineObject681) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject681) UnmarshalJSON(src []byte) error {
	v.isSet = true
