...
// InlineObject447 struct for InlineObject447
type InlineObject447 struct {
...
func (o *InlineObject447) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject447) SetSendResponseNil() {
...
func (o InlineObject447) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject447 struct {
	value *InlineObject447
	isSet bool
}

func (v NullableInlineObject447) Get() *InlineObject447 {
	return v.value
}

func (v *NullableInlineObject447) Set(val *InlineObject447) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject447) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject447) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject447(val *InlineObject447) *NullableInlineObject447 {
	return &NullableInlineObject447{value: val, isSet: true}
}

func (v NullableInlineObject447) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject447) UnmarshalJSON(src []byte) error {
	v.isSet = true
