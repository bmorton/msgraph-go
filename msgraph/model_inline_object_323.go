...
func (o *InlineObject323) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject323) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject323) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject323) SetSiteCollectionIdNil() {
...
func (o *InlineObject323) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject323 struct {
	value *InlineObject323
	isSet bool
}

func (v NullableInlineObject323) Get() *InlineObject323 {
	return v.value
}

func (v *NullableInlineObject323) Set(val *InlineObject323) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject323) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject323) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject323(val *InlineObject323) *NullableInlineObject323 {
	return &NullableInlineObject323{value: val, isSet: true}
}

func (v NullableInlineObject323) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject323) UnmarshalJSON(src []byte) error {
	v.isSet = true
