...
func (o *InlineObject653) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject653) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject653) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject653) SetSiteCollectionIdNil() {
...
func (o *InlineObject653) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject653 struct {
	value *InlineObject653
	isSet bool
}

func (v NullableInlineObject653) Get() *InlineObject653 {
	return v.value
}

func (v *NullableInlineObject653) Set(val *InlineObject653) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject653) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject653) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject653(val *InlineObject653) *NullableInlineObject653 {
	return &NullableInlineObject653{value: val, isSet: true}
}

func (v NullableInlineObject653) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject653) UnmarshalJSON(src []byte) error {
	v.isSet = true
