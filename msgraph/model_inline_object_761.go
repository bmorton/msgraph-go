...
func (o *InlineObject761) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject761) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject761) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject761) SetSiteCollectionIdNil() {
...
func (o *InlineObject761) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject761 struct {
	value *InlineObject761
	isSet bool
}

func (v NullableInlineObject761) Get() *InlineObject761 {
	return v.value
}

func (v *NullableInlineObject761) Set(val *InlineObject761) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject761) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject761) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject761(val *InlineObject761) *NullableInlineObject761 {
	return &NullableInlineObject761{value: val, isSet: true}
}

func (v NullableInlineObject761) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject761) UnmarshalJSON(src []byte) error {
	v.isSet = true
