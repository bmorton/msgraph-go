...
func (o *InlineObject1145) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1145) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject1145) SetNotebookFolderNil() {
...
func (o *InlineObject1145) SetSiteCollectionIdNil() {
...
func (o *InlineObject1145) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
type NullableInlineObject1145 struct {
	value *InlineObject1145
	isSet bool
}

func (v NullableInlineObject1145) Get() *InlineObject1145 {
	return v.value
}

func (v *NullableInlineObject1145) Set(val *InlineObject1145) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1145) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1145) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1145(val *InlineObject1145) *NullableInlineObject1145 {
	return &NullableInlineObject1145{value: val, isSet: true}
}

func (v NullableInlineObject1145) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1145) UnmarshalJSON(src []byte) error {
	v.isSet = true
