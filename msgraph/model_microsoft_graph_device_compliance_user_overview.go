...
// MicrosoftGraphDeviceComplianceUserOverview struct for MicrosoftGraphDeviceComplianceUserOverview
type MicrosoftGraphDeviceComplianceUserOverview struct {
	// Read-only.
...
func NewMicrosoftGraphDeviceComplianceUserOverview() *MicrosoftGraphDeviceComplianceUserOverview {
	this := MicrosoftGraphDeviceComplianceUserOverview{}
	return &this
}
...
func (o MicrosoftGraphDeviceComplianceUserOverview) MarshalJSON() ([]byte, error) {
...
type NullableMicrosoftGraphDeviceComplianceUserOverview struct {
	value *MicrosoftGraphDeviceComplianceUserOverview
	isSet bool
}

func (v NullableMicrosoftGraphDeviceComplianceUserOverview) Get() *MicrosoftGraphDeviceComplianceUserOverview {
	return v.value
}

func (v *NullableMicrosoftGraphDeviceComplianceUserOverview) Set(val *MicrosoftGraphDeviceComplianceUserOverview) {
	v.value = val
	v.isSet = true
}

func (v NullableMicrosoftGraphDeviceComplianceUserOverview) IsSet() bool {
	return v.isSet
}

func (v *NullableMicrosoftGraphDeviceComplianceUserOverview) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMicrosoftGraphDeviceComplianceUserOverview(val *MicrosoftGraphDeviceComplianceUserOverview) *NullableMicrosoftGraphDeviceComplianceUserOverview {
	return &NullableMicrosoftGraphDeviceComplianceUserOverview{value: val, isSet: true}
}

func (v NullableMicrosoftGraphDeviceComplianceUserOverview) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMicrosoftGraphDeviceComplianceUserOverview) UnmarshalJSON(src []byte) error {
	v.isSet = true
