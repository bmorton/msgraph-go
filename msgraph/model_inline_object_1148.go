...
// InlineObject1148 struct for InlineObject1148
type InlineObject1148 struct {
...
func (o *InlineObject1148) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject1148) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject1148) SetSiteCollectionIdNil() {
...
func (o *InlineObject1148) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject1148) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject1148 struct {
	value *InlineObject1148
	isSet bool
}

func (v NullableInlineObject1148) Get() *InlineObject1148 {
	return v.value
}

func (v *NullableInlineObject1148) Set(val *InlineObject1148) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1148) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1148) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1148(val *InlineObject1148) *NullableInlineObject1148 {
	return &NullableInlineObject1148{value: val, isSet: true}
}

func (v NullableInlineObject1148) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1148) UnmarshalJSON(src []byte) error {
	v.isSet = true
