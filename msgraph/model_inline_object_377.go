...
func (o *InlineObject377) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject377) SetSendResponseNil() {
...
func (o InlineObject377) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject377 struct {
	value *InlineObject377
	isSet bool
}

func (v NullableInlineObject377) Get() *InlineObject377 {
	return v.value
}

func (v *NullableInlineObject377) Set(val *InlineObject377) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject377) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject377) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject377(val *InlineObject377) *NullableInlineObject377 {
	return &NullableInlineObject377{value: val, isSet: true}
}

func (v NullableInlineObject377) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject377) UnmarshalJSON(src []byte) error {
	v.isSet = true
