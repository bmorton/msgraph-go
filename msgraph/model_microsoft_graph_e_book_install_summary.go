...
// MicrosoftGraphEBookInstallSummary struct for MicrosoftGraphEBookInstallSummary
type MicrosoftGraphEBookInstallSummary struct {
	// Read-only.
...
func NewMicrosoftGraphEBookInstallSummary() *MicrosoftGraphEBookInstallSummary {
	this := MicrosoftGraphEBookInstallSummary{}
	return &this
}
...
func (o MicrosoftGraphEBookInstallSummary) MarshalJSON() ([]byte, error) {
...
type NullableMicrosoftGraphEBookInstallSummary struct {
	value *MicrosoftGraphEBookInstallSummary
	isSet bool
}

func (v NullableMicrosoftGraphEBookInstallSummary) Get() *MicrosoftGraphEBookInstallSummary {
	return v.value
}

func (v *NullableMicrosoftGraphEBookInstallSummary) Set(val *MicrosoftGraphEBookInstallSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableMicrosoftGraphEBookInstallSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableMicrosoftGraphEBookInstallSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMicrosoftGraphEBookInstallSummary(val *MicrosoftGraphEBookInstallSummary) *NullableMicrosoftGraphEBookInstallSummary {
	return &NullableMicrosoftGraphEBookInstallSummary{value: val, isSet: true}
}

func (v NullableMicrosoftGraphEBookInstallSummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMicrosoftGraphEBookInstallSummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
