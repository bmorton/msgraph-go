...
func (o *InlineObject643) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject643) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject643) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject643) SetSiteCollectionIdNil() {
...
func (o *InlineObject643) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject643) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject643 struct {
	value *InlineObject643
	isSet bool
}

func (v NullableInlineObject643) Get() *InlineObject643 {
	return v.value
}

func (v *NullableInlineObject643) Set(val *InlineObject643) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject643) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject643) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject643(val *InlineObject643) *NullableInlineObject643 {
	return &NullableInlineObject643{value: val, isSet: true}
}

func (v NullableInlineObject643) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject643) UnmarshalJSON(src []byte) error {
	v.isSet = true
