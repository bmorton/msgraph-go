...
// InlineObject820 struct for InlineObject820
type InlineObject820 struct {
...
func (o *InlineObject820) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject820) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject820) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject820) SetSiteCollectionIdNil() {
...
func (o *InlineObject820) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject820) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject820 struct {
	value *InlineObject820
	isSet bool
}

func (v NullableInlineObject820) Get() *InlineObject820 {
	return v.value
}

func (v *NullableInlineObject820) Set(val *InlineObject820) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject820) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject820) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject820(val *InlineObject820) *NullableInlineObject820 {
	return &NullableInlineObject820{value: val, isSet: true}
}

func (v NullableInlineObject820) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject820) UnmarshalJSON(src []byte) error {
	v.isSet = true
