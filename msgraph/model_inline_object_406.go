...
func (o *InlineObject406) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *InlineObject406) SetSendResponseNil() {
...
func (o InlineObject406) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject406 struct {
	value *InlineObject406
	isSet bool
}

func (v NullableInlineObject406) Get() *InlineObject406 {
	return v.value
}

func (v *NullableInlineObject406) Set(val *InlineObject406) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject406) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject406) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject406(val *InlineObject406) *NullableInlineObject406 {
	return &NullableInlineObject406{value: val, isSet: true}
}

func (v NullableInlineObject406) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject406) UnmarshalJSON(src []byte) error {
	v.isSet = true
