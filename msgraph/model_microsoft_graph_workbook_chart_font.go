...
func NewMicrosoftGraphWorkbookChartFont() *MicrosoftGraphWorkbookChartFont {
	this := MicrosoftGraphWorkbookChartFont{}
	return &this
}
...
func (o *MicrosoftGraphWorkbookChartFont) SetBoldNil() {
	o.Bold.Set(nil)
}
...
func (o *MicrosoftGraphWorkbookChartFont) SetColorNil() {
	o.Color.Set(nil)
}
...
func (o *MicrosoftGraphWorkbookChartFont) SetItalicNil() {
	o.Italic.Set(nil)
}
...
func (o *MicrosoftGraphWorkbookChartFont) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *MicrosoftGraphWorkbookChartFont) SetUnderlineNil() {
	o.Underline.Set(nil)
}
...
type NullableMicrosoftGraphWorkbookChartFont struct {
	value *MicrosoftGraphWorkbookChartFont
	isSet bool
}

func (v NullableMicrosoftGraphWorkbookChartFont) Get() *MicrosoftGraphWorkbookChartFont {
	return v.value
}

func (v *NullableMicrosoftGraphWorkbookChartFont) Set(val *MicrosoftGraphWorkbookChartFont) {
	v.value = val
	v.isSet = true
}

func (v NullableMicrosoftGraphWorkbookChartFont) IsSet() bool {
	return v.isSet
}

func (v *NullableMicrosoftGraphWorkbookChartFont) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMicrosoftGraphWorkbookChartFont(val *MicrosoftGraphWorkbookChartFont) *NullableMicrosoftGraphWorkbookChartFont {
	return &NullableMicrosoftGraphWorkbookChartFont{value: val, isSet: true}
}

func (v NullableMicrosoftGraphWorkbookChartFont) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMicrosoftGraphWorkbookChartFont) UnmarshalJSON(src []byte) error {
	v.isSet = true
