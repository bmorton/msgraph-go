...
func (o *InlineObject760) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject760) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
func (o *InlineObject760) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject760) SetSiteCollectionIdNil() {
...
func (o *InlineObject760) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject760) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject760 struct {
	value *InlineObject760
	isSet bool
}

func (v NullableInlineObject760) Get() *InlineObject760 {
	return v.value
}

func (v *NullableInlineObject760) Set(val *InlineObject760) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject760) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject760) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject760(val *InlineObject760) *NullableInlineObject760 {
	return &NullableInlineObject760{value: val, isSet: true}
}

func (v NullableInlineObject760) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject760) UnmarshalJSON(src []byte) error {
	v.isSet = true
