...
// InlineObject636 struct for InlineObject636
type InlineObject636 struct {
...
func (o *InlineObject636) HasId() bool {
	if o != nil && o.Id.IsSet() {
		return true
	}
...
func (o *InlineObject636) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InlineObject636) SetGroupIdNil() {
	o.GroupId.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InlineObject636) GetRenameAsOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InlineObject636) SetRenameAsNil() {
	o.RenameAs.Set(nil)
}
...
func (o *InlineObject636) SetSiteCollectionIdNil() {
...
func (o *InlineObject636) SetSiteIdNil() {
	o.SiteId.Set(nil)
}
...
func (o InlineObject636) MarshalJSON() ([]byte, error) {
...
type NullableInlineObject636 struct {
	value *InlineObject636
	isSet bool
}

func (v NullableInlineObject636) Get() *InlineObject636 {
	return v.value
}

func (v *NullableInlineObject636) Set(val *InlineObject636) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject636) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject636) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject636(val *InlineObject636) *NullableInlineObject636 {
	return &NullableInlineObject636{value: val, isSet: true}
}

func (v NullableInlineObject636) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject636) UnmarshalJSON(src []byte) error {
	v.isSet = true
